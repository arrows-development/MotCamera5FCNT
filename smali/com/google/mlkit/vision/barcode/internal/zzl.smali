...
.method public final zza(Lcom/google/mlkit/vision/common/InputImage;)Ljava/util/ArrayList;
    ...
    invoke-static {v0}, Landroidx/core/view/ViewKt;->checkNotNull$1(Ljava/lang/Object;)V
    ...
    invoke-static {v6}, Lkotlin/io/CloseableKt;->convertToMVRotation(I)I
    ...
    invoke-static {v3, p1}, Lcom/adobe/xmp/XMPPathFactory;->zza(Landroid/os/Parcel;I)I

    move-result p1

    invoke-static {v3, v2, v1}, Lcom/adobe/xmp/XMPPathFactory;->writeInt(Landroid/os/Parcel;II)V

    const/4 v1, 0x2

    invoke-static {v3, v1, p0}, Lcom/adobe/xmp/XMPPathFactory;->writeInt(Landroid/os/Parcel;II)V

    invoke-static {v3, v11, v5}, Lcom/adobe/xmp/XMPPathFactory;->writeInt(Landroid/os/Parcel;II)V

    const/4 p0, 0x4

    invoke-static {v3, p0, v6}, Lcom/adobe/xmp/XMPPathFactory;->writeInt(Landroid/os/Parcel;II)V

    const/4 p0, 0x5

    invoke-static {v3, p0, v7, v8}, Lcom/adobe/xmp/XMPPathFactory;->writeLong(Landroid/os/Parcel;IJ)V

    invoke-static {v3, p1}, Lcom/adobe/xmp/XMPPathFactory;->zzb(Landroid/os/Parcel;I)V
    ...
    :cond_6
    invoke-static {v3}, Landroidx/core/view/ViewKt;->checkNotNull$1(Ljava/lang/Object;)V
...
.method public final zzc()Z
    ...
    :try_start_0
    sget-object v0, Lcom/google/android/gms/dynamite/DynamiteModule;->PREFER_LOCAL:Landroidx/work/WorkRequest$Companion;
    ...
    sget-object v2, Lokio/Timeout;->zza$1:Lokio/Timeout;
    ...
    invoke-static {v1}, Lkotlin/TuplesKt;->await(Lcom/google/android/gms/tasks/zzw;)Ljava/lang/Object;
    ...
    const-string/jumbo v2, "tflite_dynamite"
...
.method public final zze(Lcom/google/android/gms/dynamite/DynamiteModule$VersionPolicy;Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/gms/internal/mlkit_vision_barcode/zzsw;
    ...
    invoke-static {v1, v2}, Lcom/adobe/xmp/XMPPathFactory;->zza(Landroid/os/Parcel;I)I

    move-result v2

    invoke-static {v1, p1, v0}, Lcom/adobe/xmp/XMPPathFactory;->writeInt(Landroid/os/Parcel;II)V

    const/4 v0, 0x2

    iget-boolean p0, p0, Lcom/google/mlkit/vision/barcode/BarcodeScannerOptions;->zzb:Z

    invoke-static {v1, v0, p0}, Lcom/adobe/xmp/XMPPathFactory;->writeBoolean(Landroid/os/Parcel;IZ)V

    invoke-static {v1, v2}, Lcom/adobe/xmp/XMPPathFactory;->zzb(Landroid/os/Parcel;I)V

    invoke-virtual {p3, v1, p1}, Lcom/google/android/gms/internal/base/zaa;->zzb(Landroid/os/Parcel;I)Landroid/os/Parcel;
