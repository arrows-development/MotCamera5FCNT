...
.field public final mAiCameraConfigsMap:Ljava/util/Map;

.field public final mAnalogGainThreshold:F

.field public final mArcZoomBarSegments:[F
...
.field public final mCoreRawStreamModes:Ljava/util/HashSet;

.field public final mCustomizedHalZslModes:Ljava/util/HashSet;
...
.field public final mFaceBeautyUi:Ljava/util/HashMap;

.field public final mFallBackISOThreshold:[F

.field public final mFallBackModes:Ljava/util/HashSet;

.field public final mFallBackScenes:Ljava/util/HashSet;

.field public final mFallbackMaxDisplayBrightness:F

.field public final mFallbackModePeriod:I

.field public final mFastCaptureUITimeoutMap:Ljava/util/Map;

.field public final mFastFrameScenes:Ljava/util/HashSet;
...
.field public final mGyroDelay:I

.field public final mHighResSnapShotMinInterval:Ljava/util/Map;

.field public final mInSensorCropConfigOverrides:Ljava/util/Map;

.field public final mInSensorCropDefaultConfig:Lcom/motorola/camera/JsonConfig$InSensorCropData;

.field public final mInSensorCropEnableInSession:Z

.field public final mInSensorCropVendorTagsVersion:I

.field public final mLowMemKillSizeMb:[I

.field public final mManualExposureOverrideMap:Ljava/util/Map;

.field public final mMaxConcurrentJobsBySceneAdvanced:Ljava/util/Map;

.field public final mMaxConcurrentJobsBySceneMap:Ljava/util/Map;

.field public final mMaxFallBackBeautyCount:I

.field public final mMaxFallBackCount:I

.field public final mMaxFallBackCountByScene:Ljava/util/HashMap;

.field public final mMaxFallBackFilterCount:I

.field public final mMaxFallBackHighResCount:I
...
.field public final mNonBasicModesMaxZoomRatio:F
...
.field public final mPreviewRateMotionLimit:[I

.field public final mQcfaFastCaptureUITimeout:J

.field public final mQcfaHighResMaxConcurrentJobsBySceneMap:Ljava/util/Map;

.field public final mQcfaHighResSnapShotMinInterval:Ljava/util/Map;
...
.field public final mTriggerFallBackInThermal:Z

.field public final mUhdrCameraModes:Ljava/util/HashSet;
...
.field public final mVideoNvPromptHideEnableLux:I

.field public final mVideoNvPromptShowDisableLux:I

.field public final mVideoNvPromptShowEnableLux:I
...
# direct methods
.method public constructor <init>([I[I[I[I[I[I[I[I[Ljava/lang/String;[I[I[I[I[I[I[ILjava/util/List;IIIZFFFF[JJJ[I[I[I[I[I[F[F[I[I[F[F[FFLjava/util/Map;Ljava/util/Map;Z[ZLjava/lang/String;FZ[FLjava/lang/String;F[ZLjava/lang/String;ZLjava/util/Map;Ljava/util/Map;[Z[Z[Z[F[Lcom/motorola/camera/settings/CameraType;[Lcom/motorola/camera/settings/CameraType;[Lcom/motorola/camera/JsonConfig$CameraMapping;Ljava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;[DFFIDLorg/json/JSONArray;I[F[I[ZLjava/util/Map;Ljava/util/Map;Ljava/util/Map;[Z[IZJZILjava/lang/String;Ljava/lang/String;[FZ[Lcom/motorola/camera/settings/CameraType;[F[ILjava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;[FLjava/lang/String;ZLcom/motorola/camera/JsonConfig$InSensorCropData;Ljava/util/Map;IILjava/util/Map;IIIILjava/util/HashMap;Ljava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;[FLjava/util/HashSet;ZIFIIILjava/util/Map;Ljava/util/HashMap;ILjava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
    .locals 3
    ...
    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mPreviewRateMotionLimit:[I
    ...
    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mArcZoomBarSegments:[F

    move/from16 v1, p43

    iput v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mNonBasicModesMaxZoomRatio:F
    ...
    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mCustomizedHalZslModes:Ljava/util/HashSet;

    move-object/from16 v1, p69

    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mCoreRawStreamModes:Ljava/util/HashSet;
    ...
    iput-boolean v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mInSensorCropEnableInSession:Z

    move-object/from16 v1, p108

    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mInSensorCropDefaultConfig:Lcom/motorola/camera/JsonConfig$InSensorCropData;

    move-object/from16 v1, p109

    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mInSensorCropConfigOverrides:Ljava/util/Map;

    move/from16 v1, p110

    iput v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mInSensorCropVendorTagsVersion:I
    ...
    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mManualExposureOverrideMap:Ljava/util/Map;
    ...
    iput v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mMaxFallBackHighResCount:I

    move/from16 v1, p115

    iput v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mMaxFallBackFilterCount:I

    move/from16 v1, p116

    iput v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mMaxFallBackBeautyCount:I

    move-object/from16 v1, p117

    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mMaxFallBackCountByScene:Ljava/util/HashMap;
    ...
    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mUhdrCameraModes:Ljava/util/HashSet;

    move-object/from16 v1, p120

    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mFastFrameScenes:Ljava/util/HashSet;
    ...
    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mFallBackModes:Ljava/util/HashSet;

    move/from16 v1, p123

    iput-boolean v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mTriggerFallBackInThermal:Z

    move/from16 v1, p124

    iput v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mFallbackModePeriod:I

    move/from16 v1, p125

    iput v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mFallbackMaxDisplayBrightness:F

    move/from16 v1, p126

    iput v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mVideoNvPromptShowEnableLux:I

    move/from16 v1, p127

    iput v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mVideoNvPromptHideEnableLux:I

    move/from16 v1, p128

    iput v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mVideoNvPromptShowDisableLux:I

    move-object/from16 v1, p129

    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mAiCameraConfigsMap:Ljava/util/Map;

    move-object/from16 v1, p130

    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mFaceBeautyUi:Ljava/util/HashMap;

    move/from16 v1, p131

    iput v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mGyroDelay:I

    move-object/from16 v1, p132

    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mQcfaHighResMaxConcurrentJobsBySceneMap:Ljava/util/Map;

    move-object/from16 v1, p133

    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mQcfaHighResSnapShotMinInterval:Ljava/util/Map;

    move-object/from16 v1, p134

    iput-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mMaxConcurrentJobsBySceneAdvanced:Ljava/util/Map;
...
.method public final toString()Ljava/lang/String;
    ...
    invoke-static {v1, v0, v2}, Lcom/adobe/xmp/impl/QName$$ExternalSynthetic$IA0;->m([ILjava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    const-string v2, ", mPreviewRateMotionLimit"

    invoke-static {v1, v0, v2}, Lcom/adobe/xmp/impl/QName$$ExternalSynthetic$IA0;->m([ILjava/lang/StringBuilder;Ljava/lang/String;)V

    iget-object v1, p0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mPreviewRateMotionLimit:[I
    ...
    const-string v1, ", mArcZoomBarSegments"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mArcZoomBarSegments:[F
    ...
    const-string v1, ", mNonBasicModesZoomRatio"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mNonBasicModesMaxZoomRatio:F
    ...
    const-string v1, ", mCustomizedHalZslModes="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mCustomizedHalZslModes:Ljava/util/HashSet;
    ...
    const-string v1, ", mCoreRawStreamModes="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mCoreRawStreamModes:Ljava/util/HashSet;
    ...
    iget p0, p0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mThumbnailJpegQuality:I
