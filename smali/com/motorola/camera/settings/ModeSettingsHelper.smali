...
.method public static getDefaultSlider()Ljava/util/ArrayList;
    ...
    sget-object v6, Lcom/motorola/camera/AppFeatures$Feature;->SLIDER_DEFAULT_NIGHT:Lcom/motorola/camera/AppFeatures$Feature;

    invoke-virtual {v1, v6}, Lcom/motorola/camera/AppFeatures;->supports(Lcom/motorola/camera/AppFeatures$Feature;)Z
    ...
    sget-object v3, Lcom/motorola/camera/AppFeatures$Feature;->DEPTH_ENABLED:Lcom/motorola/camera/AppFeatures$Feature;
    ...
    :cond_2
    sget-object v6, Lcom/motorola/camera/AppFeatures$Feature;->SLIDER_DEFAULT_DUAL_VIDEO:Lcom/motorola/camera/AppFeatures$Feature;
    ...
    sget-object v3, Lcom/motorola/camera/AppFeatures$Feature;->SLIDER_DEFAULT_SCAN:Lcom/motorola/camera/AppFeatures$Feature;
    ...
    sget-object v3, Lcom/motorola/camera/AppFeatures$Feature;->SLIDER_ADOBE_SCAN:Lcom/motorola/camera/AppFeatures$Feature;
...
.method public static getModeSupportFacing(IZ)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v2}, Lcom/motorola/camera/settings/Setting;->getSupportedValues(Lcom/motorola/camera/settings/CameraType;)Ljava/util/List;
    ...
    invoke-virtual {v5, p1}, Lcom/motorola/camera/settings/Setting;->getAllowedSupportedValues(Lcom/motorola/camera/settings/CameraType;)Ljava/util/ArrayList;
...
.method public static getPreviewRatio(IIFZZ)F
    ...
    :cond_6
    invoke-static {p0}, Lkotlin/io/CloseableKt;->getAspectRatio(Landroid/util/Size;)F
    ...
    invoke-static {p2}, Lkotlin/io/CloseableKt;->getAspectRatio(Landroid/util/Size;)F
    ...
    invoke-static {p0, p2}, Lkotlin/io/CloseableKt;->isSameAspectRatio(FF)Z
...
.method public static getScissorRect(FILcom/motorola/camera/PreviewSize;Lcom/motorola/camera/ui/layoutmanager/ILayoutManager;)Landroid/graphics/RectF;
    ...
    invoke-interface {p3, p2, v0}, Lcom/motorola/camera/ui/layoutmanager/ILayoutManager;->getPreviewFitTransform(Lcom/motorola/camera/PreviewSize;Lcom/motorola/camera/PreviewSize;)Landroidx/core/provider/CallbackWithHandler;
    ...
    invoke-static {p3}, Lkotlin/LazyKt__LazyKt;->isSplitMode(Lcom/motorola/camera/ui/layoutmanager/ILayoutManager;)Z
