...
.method public onCreatePreferences(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iput-object v0, p2, Landroidx/preference/PreferenceManager;->mSharedPreferencesName:Ljava/lang/String;

    const/4 v0, 0x0

    iput v0, p2, Landroidx/preference/PreferenceManager;->mSharedPreferencesMode:I

    const/4 v1, 0x0

    iput-object v1, p2, Landroidx/preference/PreferenceManager;->mSharedPreferences:Landroid/content/SharedPreferences;
    ...
    iput-boolean v2, p2, Landroidx/preference/PreferenceManager;->mNoCommit:Z

    new-instance v3, Landroidx/preference/PreferenceInflater;

    invoke-direct {v3, v1, p2}, Landroidx/preference/PreferenceInflater;-><init>(Landroid/content/Context;Landroidx/preference/PreferenceManager;)V
    ...
    invoke-virtual {v3, p2}, Landroidx/preference/Preference;->onAttachedToHierarchy(Landroidx/preference/PreferenceManager;)V

    iget-object v1, p2, Landroidx/preference/PreferenceManager;->mEditor:Landroid/content/SharedPreferences$Editor;
    ...
    instance-of p2, v3, Landroidx/preference/PreferenceScreen;
    ...
    invoke-static {p2, p1, v0}, L_COROUTINE/_BOUNDARY$$ExternalSyntheticThrowCCEIfNotNull0;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
