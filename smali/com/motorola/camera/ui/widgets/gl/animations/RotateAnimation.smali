...
.method public final animationUpdate([F)Z
    ...
    invoke-static {v11}, Landroidx/compose/animation/core/AnimationEndReason$EnumUnboxingLocalUtility;->ordinal(I)I
    ...
    invoke-interface {p0, v8}, Landroid/animation/TimeInterpolator;->getInterpolation(F)F
    ...
    invoke-virtual {p1, v1, v3, v3, v13}, Lcom/motorola/camera/ui/widgets/gl/textures/Texture;->setPreRotation(FFFF)V
    ...
    invoke-virtual {v0, v1, v3, v3, v8}, Lcom/motorola/camera/ui/widgets/gl/textures/Texture;->setPreRotation(FFFF)V
    ...
    invoke-virtual {p1, v1, v3, v3, v8}, Lcom/motorola/camera/ui/widgets/gl/textures/Texture;->setPreRotation(FFFF)V
