...
.method public final hideSystemUi()V
    ...
    invoke-direct {v2, v1, p0}, Lcom/motorola/camera/Camera$$ExternalSyntheticLambda3;-><init>(ILandroid/app/Activity;)V
...
.method public final declared-synchronized loadBitmap(Landroid/net/Uri;)V
    ...
    invoke-direct {v1, v0, p1, p0}, Lcom/motorola/camera/editor/load/LoadDocJpegTask;-><init>(Landroid/net/Uri;Landroid/net/Uri;Lcom/motorola/camera/editor/load/LoadDocJpegListener;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-direct {v2, v3, p1}, Lcom/airbnb/lottie/LottieDrawable$$ExternalSyntheticLambda0;-><init>(ILjava/lang/Object;)V
    ...
    iget-object p1, p1, Lcom/motorola/camera/analytics/AnalyticsHelper;->mDocEditValues:Landroidx/core/provider/CallbackWithHandler;
    ...
    invoke-virtual {p1, v3, v1}, Landroidx/core/provider/CallbackWithHandler;->putBoolean(Ljava/lang/String;Z)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    new-instance v3, Lcom/motorola/camera/utility/AppExtensionsKt$$ExternalSyntheticLambda1;

    invoke-direct {v3}, Lcom/motorola/camera/utility/AppExtensionsKt$$ExternalSyntheticLambda1;-><init>()V
    ...
    invoke-direct {v3, v4, v1}, Lcom/google/gson/FieldAttributes;-><init>(ILjava/lang/Object;)V
...
.method public final updateAdjustBitmap([F)V
    ...
    invoke-static {v4, v6, p1}, Lcom/motorola/camera/editor/DocEditorActivity;->createBitmap(II[B)Landroid/graphics/Bitmap;

    move-result-object v4

    iput-object v4, v2, Lcom/motorola/camera/editor/DocJpegHolder;->mAdjustedBitmap:Landroid/graphics/Bitmap;

    iget-object v2, p0, Lcom/motorola/camera/editor/DocEditorActivity;->mJpegHolder:Lcom/motorola/camera/editor/DocJpegHolder;

    iget v2, v2, Lcom/motorola/camera/editor/DocJpegHolder;->mFilterMode:I

    sget-object v4, Lcom/motorola/camera/editor/ui/FilterButtonView$Mode;->mLookUp:Ljava/util/HashMap;
    ...
    check-cast v2, Lcom/motorola/camera/editor/ui/FilterButtonView$Mode;
    ...
    invoke-static {p1, v2, v4, v0, v8}, Lcom/motorola/camera/mcf/DocUtil;->enhanceRGB([BII[IZ)[B
    ...
    invoke-static {v3, v0, p1}, Lcom/motorola/camera/editor/DocEditorActivity;->createBitmap(II[B)Landroid/graphics/Bitmap;

    move-result-object p1

    iput-object p1, v2, Lcom/motorola/camera/editor/DocJpegHolder;->mEnhancedBitmap:Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v2, v4, v0, v8}, Lcom/motorola/camera/mcf/DocUtil;->monoRGB([BII[IZ)[B

    move-result-object p1

    iget-object v2, p0, Lcom/motorola/camera/editor/DocEditorActivity;->mJpegHolder:Lcom/motorola/camera/editor/DocJpegHolder;

    iget-object v4, v2, Lcom/motorola/camera/editor/DocJpegHolder;->mMonoBitmap:Landroid/graphics/Bitmap;

    invoke-static {v4}, Lcom/motorola/camera/Util;->recycleBitmap(Landroid/graphics/Bitmap;)V

    iput-object v1, v2, Lcom/motorola/camera/editor/DocJpegHolder;->mMonoBitmap:Landroid/graphics/Bitmap;
...
.method public final updateViewForState$enumunboxing$(I)V
    ...
    invoke-direct {v2, p0, v4}, Lcom/motorola/camera/editor/DocEditorActivity$$ExternalSyntheticLambda1;-><init>(Lcom/motorola/camera/editor/DocEditorActivity;I)V
    ...
    iget v4, v0, Lcom/motorola/camera/editor/DocJpegHolder;->mOrientation:F
    ...
    invoke-virtual {v0, v4}, Lcom/motorola/camera/editor/ui/ScaleImageView;->setLastRotate(I)V
