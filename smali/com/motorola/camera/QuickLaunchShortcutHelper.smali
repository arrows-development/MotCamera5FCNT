...
.method public static editQuickLaunchShortcuts(Z)V
    ...
    invoke-direct {v5, v0, v8}, Landroid/content/pm/ShortcutInfo$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v8}, Landroid/content/pm/ShortcutInfo$Builder;->setShortLabel(Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    const-string v9, "motorola.camera.intent.action.SUPER_NIGHT_CAMERA"
    ...
    invoke-virtual {v5, v8}, Landroid/content/pm/ShortcutInfo$Builder;->setIntent(Landroid/content/Intent;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    const-string v8, "motorola.camera.intent.action.ADOBE_SCAN_CAMERA"
