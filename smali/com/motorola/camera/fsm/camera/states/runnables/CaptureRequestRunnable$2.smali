...
.method public final onCaptureCompleted(Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/TotalCaptureResult;)V
    ...
    invoke-virtual {v15, v13, v14}, Landroid/util/Range;->intersect(Ljava/lang/Comparable;Ljava/lang/Comparable;)Landroid/util/Range;
    ...
    :try_start_0
    iget-object v15, v14, Lcom/motorola/camera/panorama/morpho/MorphoEngine;->mMorphoPanoramaGP3:Lcom/morphoinc/app/panoramagp3/MorphoPanoramaGP3;
    :try_end_0
    ...
    iget v9, v8, Lcom/motorola/camera/fsm/camera/states/runnables/PanoPreviewRequestRunnable;->mEVBufIndex:I

    add-int/lit8 v10, v9, 0x1

    iput v10, v8, Lcom/motorola/camera/fsm/camera/states/runnables/PanoPreviewRequestRunnable;->mEVBufIndex:I

    and-int/lit8 v9, v9, 0x7

    iget-object v10, v8, Lcom/motorola/camera/fsm/camera/states/runnables/PanoPreviewRequestRunnable;->mEVBuf:[D
    ...
    iget v5, v8, Lcom/motorola/camera/fsm/camera/states/runnables/PanoPreviewRequestRunnable;->mEVBufIndex:I
    ...
    invoke-direct {v4, v6}, Landroidx/media3/exoplayer/upstream/Loader$LoadErrorAction;-><init>(I)V

    sget-object v5, Lcom/motorola/camera/panorama/PanoHelper;->sSurfaceSize:Landroid/util/Size;

    sget-object v5, Lcom/motorola/camera/settings/SettingsManager;->PANO_ANTI_FLICKER_MODE:Lcom/motorola/camera/settings/SettingsManager$Key;
    ...
    const-wide v9, 0x4157d78400000000L    # 6250000.0
    ...
    const-wide v9, 0x40fe848000000000L    # 125000.0
    ...
    iput-wide v9, v4, Landroidx/media3/exoplayer/upstream/Loader$LoadErrorAction;->retryDelayMillis:J
    ...
    :cond_6
    const-wide v9, 0x4177d78400000000L    # 2.5E7
    ...
    :cond_8
    const-wide v18, 0x41b7d78400000000L    # 4.0E8
    ...
    :cond_9
    const-wide v18, 0x41edcd6500000000L    # 4.0E9
    ...
    :cond_a
    const-wide v18, 0x41f65a0bc0000000L    # 6.0E9
    ...
    :cond_b
    const-wide v18, 0x41fbf08eb0000000L    # 7.5E9
    ...
    :cond_c
    const-wide v18, 0x4222a05f20000000L    # 4.0E10
    ...
    :cond_d
    const-wide v18, 0x4238d5d42aaaaaabL    # 1.0666666666666667E11
    ...
    :goto_5
    invoke-virtual {v13, v5}, Landroid/util/Range;->clamp(Ljava/lang/Comparable;)Ljava/lang/Comparable;
    ...
    iput v5, v4, Landroidx/media3/exoplayer/upstream/Loader$LoadErrorAction;->type:I
    ...
    const-wide v9, 0x415fca0555555555L    # 8333333.333333333
    ...
    invoke-virtual {v13, v3}, Landroid/util/Range;->clamp(Ljava/lang/Comparable;)Ljava/lang/Comparable;
    ...
    invoke-virtual {v3, v6}, Lcom/motorola/camera/device/CameraStateManager;->getCameraSession(Ljava/lang/String;)Lcom/motorola/camera/device/CameraStateManager$Status;

    move-result-object v3

    sget-object v6, Lcom/motorola/camera/device/CameraStateManager$Status;->CLOSING:Lcom/motorola/camera/device/CameraStateManager$Status;
    ...
    const-string v6, "PANO_SENSOR_EXPOSURE_TIME"

    iget-wide v9, v4, Landroidx/media3/exoplayer/upstream/Loader$LoadErrorAction;->retryDelayMillis:J

    invoke-virtual {v3, v6, v9, v10}, Landroid/os/BaseBundle;->putLong(Ljava/lang/String;J)V

    const-string v6, "PANO_SENSOR_SENSITIVITY"

    iget v7, v4, Landroidx/media3/exoplayer/upstream/Loader$LoadErrorAction;->type:I
    ...
    iget-object v6, v8, Lcom/motorola/camera/fsm/camera/CameraRunnable;->mFsmContext:Lcom/motorola/camera/fsm/camera/FsmContext;
    ...
    iget-object v7, v8, Lcom/motorola/camera/fsm/camera/states/runnables/PanoPreviewRequestRunnable;->mSetRepeatingRequestListener:Lcom/motorola/camera/fsm/camera/states/runnables/CaptureRequestRunnable$2;

    iget-object v9, v8, Lcom/motorola/camera/fsm/camera/CameraRunnable;->mFsmContext:Lcom/motorola/camera/fsm/camera/FsmContext;

    iget-object v9, v9, Lcom/motorola/camera/fsm/camera/FsmContext;->mHandler:Landroid/os/Handler;

    invoke-static {v4, v6, v8, v7, v9}, Lcom/motorola/camera/fsm/ChangeEvent;->setRepeatingRequest(Ljava/lang/String;Landroid/hardware/camera2/CaptureRequest;Lcom/motorola/camera/device/callables/CameraListener;Lcom/motorola/camera/device/callables/SetRepeatingRequestListener;Landroid/os/Handler;)V
    ...
    iget-object v8, v3, Lcom/motorola/camera/fsm/camera/modes/PanoramaMode;->mGainDetectImageReader:Landroid/media/ImageReader;
    ...
    invoke-static {v2}, Lkotlin/io/ExceptionsKt;->isStarTrailCapture(Lcom/motorola/camera/fsm/camera/FsmContext;)Z
    ...
    invoke-virtual {v2, v1}, Lcom/motorola/camera/fsm/camera/modes/AbstractMode;->onCaptureCompleted(Landroid/hardware/camera2/CaptureResult;)V
    ...
    invoke-virtual {v2, v1, v3}, Lcom/motorola/camera/settings/CustomKeyHelper$CaptureResultKey;->getValue(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)Ljava/lang/Object;
    ...
    iput-boolean v2, v0, Lcom/motorola/camera/fsm/camera/states/runnables/CaptureRequestRunnable;->mFirstFrame:Z

    invoke-virtual/range {p2 .. p2}, Landroid/hardware/camera2/CaptureResult;->getFrameNumber()J
    ...
    invoke-virtual {v2, v1, v0}, Lcom/motorola/camera/fsm/camera/subfsms/EnvInfoStateMachine;->onCaptureCompleted(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)V
    ...
    invoke-direct {v3, v4, v6, v5}, Lcom/motorola/camera/fsm/camera/Trigger;-><init>(Lcom/motorola/camera/fsm/camera/Trigger$Event;Ljava/lang/Object;Z)V
...
.method public final onCaptureFailed(Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CaptureFailure;)V
    ...
    invoke-static {p1, p2, p2, p0}, Lcom/motorola/camera/fsm/ChangeEvent;->stopRepeatingRequest(Ljava/lang/String;Lcom/motorola/camera/device/callables/StopRepeatingListener;Lcom/motorola/camera/device/callables/CameraListener;Landroid/os/Handler;)V
    ...
    iput-boolean v0, v1, Lcom/motorola/camera/ui/uicomponents/ToastUIComponent$ToastFeatureBuilder;->mAutoHide:Z

    const/16 v0, 0x1770

    invoke-virtual {v1, v0}, Lcom/motorola/camera/ui/uicomponents/ToastUIComponent$ToastFeatureBuilder;->duration(I)V
