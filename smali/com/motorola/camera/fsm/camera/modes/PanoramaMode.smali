...
.method public constructor <init>()V
    ...
    invoke-direct {v0, v1}, Lkotlin/jvm/internal/SpreadBuilder;-><init>(Ljava/lang/Object;)V
...
.method public static setupAeFps(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/lang/String;Z)V
    .locals 5
    ...
    invoke-static {p1, p2}, Lcom/motorola/camera/settings/SettingsManager;->getCameraCharacteristic(Ljava/lang/String;Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public final onSetupCaptureRequest(Lcom/motorola/camera/fsm/camera/FsmContext;Lcom/motorola/camera/fsm/RequestWrapper;Lcom/motorola/camera/ShotType;)V
    ...
    :cond_4
    sget-object v1, Lcom/motorola/camera/fsm/camera/modes/RequestBuilderHelper;->TRUE_BYTE:Ljava/lang/Byte;
    ...
    invoke-static {p3, v0, v2}, Lcom/motorola/camera/fsm/camera/modes/PanoramaMode;->setupAeFps(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/lang/String;Z)V
    ...
    invoke-static {p3, v0}, Lcom/motorola/camera/fsm/camera/modes/RequestBuilderHelper;->setDualCaptureMode(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p3, p1}, Lcom/motorola/camera/fsm/camera/modes/RequestBuilderHelper;->setCurrentMode(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/lang/String;)V

    iget-object p1, p2, Lcom/motorola/camera/fsm/RequestWrapper;->mCameraId:Ljava/lang/String;

    invoke-static {p3, p1}, Lcom/motorola/camera/fsm/camera/modes/RequestBuilderHelper;->setIsProMode(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/lang/String;)V

    iget-object p1, p2, Lcom/motorola/camera/fsm/RequestWrapper;->mCameraId:Ljava/lang/String;

    invoke-static {p3, p1}, Lcom/motorola/camera/fsm/camera/modes/RequestBuilderHelper;->setMTKZslMode(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p3, p1}, Lcom/motorola/camera/fsm/camera/modes/RequestBuilderHelper;->setMTKHfpsMode(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, p3, v0, v2}, Lcom/motorola/camera/fsm/camera/modes/RequestBuilderHelper;->setMtkHintForCustomTuning(Ljava/lang/String;Landroid/hardware/camera2/CaptureRequest$Builder;IZ)V

    iget-object p1, p2, Lcom/motorola/camera/fsm/RequestWrapper;->mCameraId:Ljava/lang/String;

    invoke-static {p3, p1}, Lcom/motorola/camera/fsm/camera/modes/RequestBuilderHelper;->setAFSalinet(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/lang/String;)V
...
.method public final onSetupStreamingRequests(Lcom/motorola/camera/fsm/camera/FsmContext;Lcom/motorola/camera/fsm/RequestWrapper;)V
    ...
    :cond_1
    sget-object v5, Lcom/motorola/camera/fsm/camera/modes/RequestBuilderHelper;->TRUE_BYTE:Ljava/lang/Byte;
    ...
    invoke-static {v0, p0, v3}, Lcom/motorola/camera/fsm/camera/modes/PanoramaMode;->setupAeFps(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/lang/String;Z)V
...
.method public final setupGainDetectImageReader(Lcom/motorola/camera/fsm/camera/FsmContext;)V
    ...
    invoke-static {v2, v4, v3, v1, v8}, Lkotlin/ULong$Companion;->newImageReader(Landroid/util/Size;IILcom/motorola/camera/settings/CameraType;Lcom/motorola/camera/fsm/camera/SurfaceManager$SurfaceType;)Landroid/media/ImageReader;
...
.method public final setupStillImageReader(Lcom/motorola/camera/fsm/camera/FsmContext;)V
    ...
    invoke-static {v5, v1, v4, v0, v3}, Lkotlin/ULong$Companion;->newImageReader(Landroid/util/Size;IILcom/motorola/camera/settings/CameraType;Lcom/motorola/camera/fsm/camera/SurfaceManager$SurfaceType;)Landroid/media/ImageReader;
