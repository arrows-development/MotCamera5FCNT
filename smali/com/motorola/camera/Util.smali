...
.method public static constructor <clinit>()V
    ...
    const-string v4, "paros_4GB"

    invoke-virtual {v2, v4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    const-string v4, "bogota_4GB"
...
.method public static createMicroKindThumbnail(Landroid/content/Context;Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v3, v1, v4, v5, v12}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    ...
    :cond_b
    :goto_6
    invoke-static {v2, v3, v12, v8}, Lokio/SegmentPool;->sizeAtStep(IIII)I

    move-result v14

    invoke-static {v7, v4, v13, v9}, Lokio/SegmentPool;->sizeAtStep(IIII)I
    ...
    :goto_9
    invoke-static {v2, v3, v10, v8}, Lokio/SegmentPool;->sizeAtStep(IIII)I
    ...
    :goto_a
    invoke-static {v7, v4, v14, v9}, Lokio/SegmentPool;->sizeAtStep(IIII)I
...
.method public static getAudioDeviceInfo(I)[Landroid/media/AudioDeviceInfo;
    .locals 2
...
.method public static getMediaDataFromUri(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v0, v0}, Lcom/motorola/camera/storage/MediaStoreClient;->queryOrNull(Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
...
.method public static getUriForFile(Landroid/content/Intent;Ljava/io/File;)Landroid/net/Uri;
    ...
    const-string v0, "com.motorola.camera5.FileProvider"
...
.method public static isBrandFcnt()Z
    .locals 2
...
.method public static isSampleApk(Landroid/content/Context;)Z
    ...
    .line 5
    invoke-static {p0}, Lcom/google/android/play/core/splitinstall/zzu;->create(Landroid/content/Context;)Lcom/google/android/play/core/splitinstall/SplitInstallManager;
...
.method public static rotateImage(Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, v0, v0}, Lcom/motorola/camera/Util;->rotateImage(Landroid/graphics/Bitmap;FZZ)Landroid/graphics/Bitmap;
