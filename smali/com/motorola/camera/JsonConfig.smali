...
.method public static getArcZoomBarSegments(Lorg/json/JSONObject;)[F
    ...
    :try_start_0
    const-string v2, "arc-zoom-bar-segments"
...
.method public static getBufferCounts(Lorg/json/JSONObject;II)[I
    ...
    invoke-static {p1}, Lcom/motorola/camera/CameraKpi$$ExternalSynthetic$IA1;->stringValueOf$4(I)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/motorola/camera/CameraKpi$$ExternalSynthetic$IA1;->stringValueOf$5(I)Ljava/lang/String;
...
.method public static getInSensorCropConfigByCameraType(Lcom/motorola/camera/settings/CameraType;)Lcom/motorola/camera/JsonConfig$InSensorCropData;
    ...
    iget-object v1, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mInSensorCropConfigOverrides:Ljava/util/Map;
...
.method public static getInSensorCropZoomThreshold(Lcom/motorola/camera/settings/CameraType;)D
    .locals 3
    ...
    iget-object p0, p0, Lcom/motorola/camera/JsonConfig$InSensorCropData;->zoomThreshold:Ljava/lang/Double;

    invoke-static {p0}, Ljava/util/Optional;->ofNullable(Ljava/lang/Object;)Ljava/util/Optional;

    move-result-object p0

    iget-object v0, v0, Lcom/motorola/camera/JsonConfig$InSensorCropData;->zoomThreshold:Ljava/lang/Double;
...
.method public static getMaxConcurrentJobsBySceneAdvanced(Lorg/json/JSONObject;)Ljava/util/HashMap;
    ...
    new-instance v7, Lcom/motorola/camera/JsonConfig$ConcurrentJobsBySceneAdvanced;

    invoke-direct {v7, v6}, Lcom/motorola/camera/JsonConfig$ConcurrentJobsBySceneAdvanced;-><init>(Lorg/json/JSONObject;)V
...
.method public static getPreviewFps(ILcom/motorola/camera/settings/CameraType;)I
    ...
    invoke-static {p0}, Lcom/motorola/camera/CameraKpi$$ExternalSynthetic$IA1;->stringValueOf$6(I)Ljava/lang/String;
...
.method public static getPreviewFps(Lorg/json/JSONObject;IZ)[I
    ...
    invoke-static {p1}, Lcom/motorola/camera/CameraKpi$$ExternalSynthetic$IA1;->stringValueOf$6(I)Ljava/lang/String;
...
.method public static getSlideScanConfigs(Lorg/json/JSONObject;)[F
    ...
    const-string/jumbo v1, "slide-scan-configs"
...
.method public static getThumbnailJpegQuality()I
    ...
    iget v0, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mThumbnailJpegQuality:I
...
.method public static inSensorCropHasLuxIdxThresholdRequirement()Z
    ...
    iget-object v0, v0, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;->mInSensorCropConfigOverrides:Ljava/util/Map;
    ...
    check-cast v5, Lcom/motorola/camera/JsonConfig$InSensorCropData;

    iget-object v6, v5, Lcom/motorola/camera/JsonConfig$InSensorCropData;->luxIdxLowerThreshold:Ljava/lang/Double;

    invoke-static {v6}, Lcom/motorola/camera/JsonConfig$InSensorCropData;->getLuxIdxThreshold(Ljava/lang/Double;)D

    move-result-wide v6

    iget-object v5, v5, Lcom/motorola/camera/JsonConfig$InSensorCropData;->luxIdxUpperThreshold:Ljava/lang/Double;
...
.method public static isFastFrameScene(Lcom/motorola/camera/mcf/Mcf$SceneMode;)Z
    .locals 1
...
.method public static readDeviceConfig(Landroid/content/Context;)Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;
    ...
    const-string v2, "Error: get JSON object "

    new-instance v3, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;

    invoke-direct {v3}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;-><init>()V

    invoke-static {}, Lcom/motorola/camera/Util;->getDevice()Ljava/lang/String;

    move-result-object v4

    invoke-static {v4}, Lcom/motorola/camera/Util;->stripVariant(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-static {v4}, Lcom/motorola/camera/Util;->combineDeviceWithRAM(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    sget-object v6, Lcom/motorola/camera/Util;->LOW_DEVICES:Ljava/util/ArrayList;
    ...
    const-string v6, "config_device_"
    ...
    invoke-static {p0, v5}, Lcom/motorola/camera/JsonConfig;->getAssetConfig(Landroid/content/Context;Ljava/lang/String;)Lorg/json/JSONObject;

    move-result-object v5

    const-string v6, "JsonConfig"
    ...
    invoke-static {v5, v2}, Lcom/motorola/camera/JsonConfig;->getJobCount(Lorg/json/JSONObject;I)[I

    move-result-object v7

    invoke-static {v3, v7}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetSingleMaxJobCnt(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    const/4 v7, 0x2

    invoke-static {v5, v7}, Lcom/motorola/camera/JsonConfig;->getJobCount(Lorg/json/JSONObject;I)[I

    move-result-object v8

    invoke-static {v3, v8}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetSingleNormalOverrideMaxJobCnt(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    const/4 v8, 0x3

    invoke-static {v5, v8}, Lcom/motorola/camera/JsonConfig;->getJobCount(Lorg/json/JSONObject;I)[I

    move-result-object v9

    invoke-static {v3, v9}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetSingleSpecialOverrideMaxJobCnt(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    const/4 v9, 0x4

    invoke-static {v5, v9}, Lcom/motorola/camera/JsonConfig;->getJobCount(Lorg/json/JSONObject;I)[I

    move-result-object v10

    invoke-static {v3, v10}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetSingleSlipMaxJobCnt(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    const/4 v10, 0x5

    invoke-static {v5, v10}, Lcom/motorola/camera/JsonConfig;->getJobCount(Lorg/json/JSONObject;I)[I

    move-result-object v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetDualMaxJobCnt(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    const/4 v11, 0x6

    invoke-static {v5, v11}, Lcom/motorola/camera/JsonConfig;->getJobCount(Lorg/json/JSONObject;I)[I

    move-result-object v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetDualDepthMaxJobCnt(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getZoomOverrideJobCount(Lorg/json/JSONObject;)Ljava/util/ArrayList;

    move-result-object v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetZoomOverride(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/ArrayList;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMaxConcurrentJobsByMode(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v11

    invoke-virtual {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setMaxJobCountMap(Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMaxConcurrentJobsByScene(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v11

    invoke-virtual {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setMaxConcurrentJobsMap(Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getQcfaHighResMaxConcurrentJobsByScene(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v11

    invoke-virtual {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setQcfaHighResMaxConcurrentJobsMap(Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMaxConcurrentJobsBySceneAdvanced(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v11

    invoke-virtual {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setMaxJobsBySceneAdvancedMap(Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMaxSlipMap(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v11

    invoke-virtual {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setMaxJobSlipMap(Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getSnapshotMinInterval(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetSnapshotMinInterval(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getHighResSnapShotMinInterval(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetHighResSnapshotMinInterval(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getQcfaHighResSnapShotMinInterval(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetQcfaHighResSnapshotMinInterval(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getUseAppShutterControl(Lorg/json/JSONObject;)Z

    move-result v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetUseAppShutterControl(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getEngineMfnrEstimate(Lorg/json/JSONObject;)J

    move-result-wide v11

    invoke-static {v3, v11, v12}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetEngineMfnrEstimate(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;J)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getPhysicalCameraCount(Lorg/json/JSONObject;)I

    move-result v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetPhysicalCameraCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->get3ATimeoutFrames(Lorg/json/JSONObject;)I

    move-result v11

    invoke-virtual {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->set3ATimeoutFrames(I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getFocusTimeoutDurationFlash(Lorg/json/JSONObject;)I

    move-result v11

    invoke-virtual {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setFocusTimeoutDurationFlash(I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getSetRepeatingSendErrorDelay(Lorg/json/JSONObject;)I

    move-result v11

    invoke-virtual {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setSetRepeatingSendErrorDelay(I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getGainOnlyQcfaDecision(Lorg/json/JSONObject;)Z

    move-result v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetGainOnlyQcfaDecision(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getAnalogGainThreshold(Lorg/json/JSONObject;)F

    move-result v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetAnalogGainThreshold(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getToHighResRgThreshold(Lorg/json/JSONObject;)F

    move-result v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetToHighResRgThreshold(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getToNormalResRgThreshold(Lorg/json/JSONObject;)F

    move-result v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetToNormalResRgThreshold(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getUltraResReminderRgThreshold(Lorg/json/JSONObject;)F

    move-result v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetUltraResReminderRgThreshold(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getSingleSessionRemosaicEstimate(Lorg/json/JSONObject;)[J

    move-result-object v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetSingleSessionRemosaicEstimate(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[J)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getNonSingleSessionRemosaicEstimate(Lorg/json/JSONObject;)J

    move-result-wide v11

    invoke-static {v3, v11, v12}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetNonSingleSessionRemosaicEstimate(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;J)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getQcfaFastCaptureUITimeout(Lorg/json/JSONObject;)J

    move-result-wide v11

    invoke-static {v3, v11, v12}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetQcfaFastCaptureUITimeout(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;J)V

    invoke-static {v5, v7, v2}, Lcom/motorola/camera/JsonConfig;->getBufferCounts(Lorg/json/JSONObject;II)[I

    move-result-object v11

    invoke-static {v3, v7, v2, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetBufferCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;II[I)V

    invoke-static {v5, v7, v7}, Lcom/motorola/camera/JsonConfig;->getBufferCounts(Lorg/json/JSONObject;II)[I

    move-result-object v11

    invoke-static {v3, v7, v7, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetBufferCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;II[I)V

    invoke-static {v5, v8, v2}, Lcom/motorola/camera/JsonConfig;->getBufferCounts(Lorg/json/JSONObject;II)[I

    move-result-object v11

    invoke-static {v3, v8, v2, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetBufferCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;II[I)V

    invoke-static {v5, v8, v7}, Lcom/motorola/camera/JsonConfig;->getBufferCounts(Lorg/json/JSONObject;II)[I

    move-result-object v11

    invoke-static {v3, v8, v7, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetBufferCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;II[I)V

    invoke-static {v5, v9, v2}, Lcom/motorola/camera/JsonConfig;->getBufferCounts(Lorg/json/JSONObject;II)[I

    move-result-object v11

    invoke-static {v3, v9, v2, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetBufferCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;II[I)V

    invoke-static {v5, v9, v7}, Lcom/motorola/camera/JsonConfig;->getBufferCounts(Lorg/json/JSONObject;II)[I

    move-result-object v11

    invoke-static {v3, v9, v7, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetBufferCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;II[I)V

    invoke-static {v5, v2, v2}, Lcom/motorola/camera/JsonConfig;->getBufferCounts(Lorg/json/JSONObject;II)[I

    move-result-object v11

    invoke-static {v3, v2, v2, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetBufferCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;II[I)V

    invoke-static {v5, v2, v7}, Lcom/motorola/camera/JsonConfig;->getBufferCounts(Lorg/json/JSONObject;II)[I

    move-result-object v11

    invoke-static {v3, v2, v7, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetBufferCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;II[I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getGrallocUsageFlags(Lorg/json/JSONObject;)[Ljava/lang/String;

    move-result-object v11

    invoke-static {v3, v11}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetGrallocUsageFlags(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[Ljava/lang/String;)V

    const/4 v11, 0x0

    invoke-static {v5, v2, v11}, Lcom/motorola/camera/JsonConfig;->getPreviewFps(Lorg/json/JSONObject;IZ)[I

    move-result-object v12

    invoke-static {v3, v12}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetPreviewRateLimitDefault(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    invoke-static {v5, v7, v2}, Lcom/motorola/camera/JsonConfig;->getPreviewFps(Lorg/json/JSONObject;IZ)[I

    move-result-object v7

    invoke-static {v3, v7}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetPreviewRateLimitLvl1(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    invoke-static {v5, v8, v2}, Lcom/motorola/camera/JsonConfig;->getPreviewFps(Lorg/json/JSONObject;IZ)[I

    move-result-object v7

    invoke-static {v3, v7}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetPreviewRateLimitLvl2(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    invoke-static {v5, v9, v2}, Lcom/motorola/camera/JsonConfig;->getPreviewFps(Lorg/json/JSONObject;IZ)[I

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetPreviewRateDepthLimit(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    invoke-static {v5, v10, v11}, Lcom/motorola/camera/JsonConfig;->getPreviewFps(Lorg/json/JSONObject;IZ)[I

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetPreviewRateMotionLimit(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getFullFrameConfig(Lorg/json/JSONObject;)[I

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetSkipPattern(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMaxMultishotRates(Lorg/json/JSONObject;)[F

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetMaxMultishotRates(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMaxMultishotRatesLvl1(Lorg/json/JSONObject;)[F

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetMaxMultishotRatesLvl1(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getLowMemKillSizeVals(Lorg/json/JSONObject;)[I

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetLowMemKillSizeMbVals(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getExtraFreeMemSizeVals(Lorg/json/JSONObject;)[I

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetExtraFreeMemSizeMbVals(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getZoomBlendingSegments(Lorg/json/JSONObject;)[F

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetZoomBlendingSegments(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getZoomBlendingManualX(Lorg/json/JSONObject;)[F

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetZoomBlendingManualX(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getArcZoomBarSegments(Lorg/json/JSONObject;)[F

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetArcZoomBarSegments(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getNonBasicModesMaxZoomRatio(Lorg/json/JSONObject;)F

    move-result v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetNonBasicModesZoomRatio(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getUseHighResolutionOutput(Lorg/json/JSONObject;)[Z

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetUseHighResolutionOutput(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getUseHQPreview(Lorg/json/JSONObject;)[Z

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetUseHQPreview(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getSceneDetectionPlatform(Lorg/json/JSONObject;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetSceneDetectionPlatform(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/lang/String;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getSkinToneDetectionEnabled(Lorg/json/JSONObject;)Z

    move-result v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetSkinToneDetectionEnabled(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Z)V

    const-string v2, "country-mapping"

    invoke-static {v2, v5}, Lcom/motorola/camera/JsonConfig;->getSkinToneDetectionMapping(Ljava/lang/String;Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetSkinToneCountryMapping(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/HashMap;)V

    const-string/jumbo v2, "sku-mapping"

    invoke-static {v2, v5}, Lcom/motorola/camera/JsonConfig;->getSkinToneDetectionMapping(Ljava/lang/String;Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetSkinToneSkuMapping(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMotoFlashTuningEnable(Lorg/json/JSONObject;)[Z

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetMotoFlashTuningEnable(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getUseCustomNoiseReduction(Lorg/json/JSONObject;)[Z

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetUseCustomNoiseReduction(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getSuperRemosaicSettings(Lorg/json/JSONObject;)[F

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetSuperRemosaicSettings(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getOfflineReprocEnabled(Lorg/json/JSONObject;)[Z

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetOfflineReprocEnabled(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getDepthSysteMCalibrationDevices(Lorg/json/JSONObject;)[Lcom/motorola/camera/settings/CameraType;

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetDepthSystemCalibration(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[Lcom/motorola/camera/settings/CameraType;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getCameraTypes(Lorg/json/JSONObject;)[Lcom/motorola/camera/settings/CameraType;

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setCameraTypes([Lcom/motorola/camera/settings/CameraType;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getCameraMappings(Lorg/json/JSONObject;)[Lcom/motorola/camera/JsonConfig$CameraMapping;

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setCameraMappings([Lcom/motorola/camera/JsonConfig$CameraMapping;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMcfSlowCaptureModes(Lorg/json/JSONObject;)Ljava/util/HashSet;

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setMcfSlowCaptureModes(Ljava/util/HashSet;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getDisableAppZSLScenes(Lorg/json/JSONObject;)Ljava/util/HashSet;

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setDisableAppZslScenes(Ljava/util/HashSet;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getDisableHalZSLModes(Lorg/json/JSONObject;)Ljava/util/HashSet;

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setDisableHalZslModes(Ljava/util/HashSet;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getCustomizedHalZSLModes(Lorg/json/JSONObject;)Ljava/util/HashSet;

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setCustomizedHalZslModes(Ljava/util/HashSet;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getCoreRawStreamModes(Lorg/json/JSONObject;)Ljava/util/HashSet;

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setCoreRawStreamModes(Ljava/util/HashSet;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getExtraRawStreamModes(Lorg/json/JSONObject;)Ljava/util/HashSet;

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setExtraRawStreamModes(Ljava/util/HashSet;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getEarlyReprocScenes(Lorg/json/JSONObject;)Ljava/util/HashSet;

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setEarlyReprocScenes(Ljava/util/HashSet;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getThumbnailJpegQuality(Lorg/json/JSONObject;)I

    move-result v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setThumbnailJpegQuality(I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getDisplayCutoutsCoordinates(Lorg/json/JSONObject;)Lorg/json/JSONArray;

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setDisplayCutoutsCoordinates(Lorg/json/JSONArray;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getDisplayCutoutConfigs(Lorg/json/JSONObject;)[F

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setDisplayCutoutConfigs([F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getQuickCaptureVibrationConfigs(Lorg/json/JSONObject;)[I

    move-result-object v2

    invoke-virtual {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setQuickCaptureVibrationConfigs([I)V

    const-string/jumbo v2, "torch-control-enable"
    ...
    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getTorchControlEnable(Lorg/json/JSONObject;)[Z

    move-result-object v2

    invoke-static {v3, v2}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetTorchControlEnable(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[Z)V
    ...
    :cond_2
    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getBarcodeDetectionEnabled(Lorg/json/JSONObject;)[Z

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setBarcodeDetectionEnabled([Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getBarcodeTimeBetweenScans(Lorg/json/JSONObject;)[I

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setBarcodeTimeBetweenScans([I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getBarcodeDetectionBackoff(Lorg/json/JSONObject;)Z

    move-result v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setBarcodeDetectionBackoff(Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getGestureRemoveDelay(Lorg/json/JSONObject;)Z

    move-result v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetGestureRemoveDelay(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getSuperSlowMotionLowLightThreshold(Lorg/json/JSONObject;)I

    move-result v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setSuperSlowMotionLowLightThreshold(I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getSuperSlowMotionLib(Lorg/json/JSONObject;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setSuperSlowMotionLib(Ljava/lang/String;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getStarTrailsLib(Lorg/json/JSONObject;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setStarTrailsLib(Ljava/lang/String;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getSlideScanConfigs(Lorg/json/JSONObject;)[F

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setSlideScanConfigs([F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getPortraitLens(Lorg/json/JSONObject;)Z

    move-result v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setPortraitLens(Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getPortraitLensCameraType(Lorg/json/JSONObject;)[Lcom/motorola/camera/settings/CameraType;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setPortraitLensCameraType([Lcom/motorola/camera/settings/CameraType;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getPortraitLensZoomValue(Lorg/json/JSONObject;)[F

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setPortraitLensZoomValue([F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getPortraitLensBlurLevel(Lorg/json/JSONObject;)[I

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setPortraitLensBlurLevel([I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getFastCaptureUITimeoutMap(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setFastCaptureUITimeoutMap(Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getVideoPortraitConifgs(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setVideoPortraitConfigs(Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMeiSheVideoFxConifgs(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setMeiSheVideoFxConfigs(Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMeiSheAnimatedStickerConifgs(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setMeiSheAnimatedStickerConfigs(Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getDualCalibrationDataVendor(Lorg/json/JSONObject;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetDualCalibrationDataVendor(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/lang/String;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getInSensorCropEnableInSession(Lorg/json/JSONObject;)Z

    move-result v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetInSensorCropEnableInSession(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getInSensorCropConfigDefaults(Lorg/json/JSONObject;)Lcom/motorola/camera/JsonConfig$InSensorCropData;

    move-result-object v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetInSensorCropDefaultConfig(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Lcom/motorola/camera/JsonConfig$InSensorCropData;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getInSensorCropConfigOverrides(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetInSensorCropConfigOverrides(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getInSensorCropVendorTagsVersion(Lorg/json/JSONObject;)I

    move-result v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetInSensorCropVendorTagsVersion(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getManualExposureOverrides(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetManualExposureOverrideMap(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMaxFallBackCount(Lorg/json/JSONObject;)I

    move-result v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetMaxFallBackCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMaxFallBackHighResCount(Lorg/json/JSONObject;)I

    move-result v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetMaxFallBackHighResCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMaxFallBackFilterCount(Lorg/json/JSONObject;)I

    move-result v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetMaxFallBackFilterCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMaxFallBackBeautyCount(Lorg/json/JSONObject;)I

    move-result v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetMaxFallBackBeautyCount(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getMaxFallBackCountByScene(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetMaxFallBackCountByScene(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getFallBackScenes(Lorg/json/JSONObject;)Ljava/util/HashSet;

    move-result-object v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetFallBackScenes(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/HashSet;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getUhdrCameraModes(Lorg/json/JSONObject;)Ljava/util/HashSet;

    move-result-object v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetUhdrCameraMode(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/HashSet;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getFastFrameScenes(Lorg/json/JSONObject;)Ljava/util/HashSet;

    move-result-object v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetFastFrameScenes(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/HashSet;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getFallBackModes(Lorg/json/JSONObject;)Ljava/util/HashSet;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setFallBackModes(Ljava/util/HashSet;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getFallBackISOThreshold(Lorg/json/JSONObject;)[F

    move-result-object v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetFallBackISOThreshold(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;[F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getTriggerFallBackInThermal(Lorg/json/JSONObject;)Z

    move-result v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setTriggerFallBackInThermal(Z)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getFallbackModePeriod(Lorg/json/JSONObject;)I

    move-result v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setFallBackModePeriod(I)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getFallbackMaxDisplayBrightness(Lorg/json/JSONObject;)F

    move-result v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setFallbackMaxDisplayBrightness(F)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getAiCameraConfigsMap(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setAiCameraConfigsMap(Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getFaceBeautyUI(Lorg/json/JSONObject;)Ljava/util/HashMap;

    move-result-object v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetFaceBeautyUi(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;Ljava/util/HashMap;)V

    invoke-static {v5}, Lcom/motorola/camera/JsonConfig;->getGyroDelay(Lorg/json/JSONObject;)I

    move-result v0

    invoke-static {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetGyroDelay(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;I)V
    ...
    const-string v0, "Parse json file(config_device) for %s failed"
    ...
    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setFlashColor(Ljava/lang/String;)V

    invoke-static {p0}, Lcom/motorola/camera/JsonConfig;->getFlashAlpha(Lorg/json/JSONObject;)F

    move-result v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setFlashAlpha(F)V

    invoke-static {p0}, Lcom/motorola/camera/JsonConfig;->getFlashTorchEnable(Lorg/json/JSONObject;)Z

    move-result v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setFlashTorchEnable(Z)V

    invoke-static {p0}, Lcom/motorola/camera/JsonConfig;->getFlashLuxRange(Lorg/json/JSONObject;)[F

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setFlashLuxRange([F)V

    invoke-static {p0}, Lcom/motorola/camera/JsonConfig;->getPanoDistortions(Lorg/json/JSONObject;)[D

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setPanoDistortions([D)V

    invoke-static {p0}, Lcom/motorola/camera/JsonConfig;->getPanoExpAdjustment(Lorg/json/JSONObject;)F

    move-result v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setPanoExpAdjustment(F)V

    invoke-static {p0}, Lcom/motorola/camera/JsonConfig;->getPanoMaxGain(Lorg/json/JSONObject;)F

    move-result v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setPanoMaxGain(F)V

    invoke-static {p0}, Lcom/motorola/camera/JsonConfig;->getPanoNoiseReductionLevel(Lorg/json/JSONObject;)I

    move-result v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setPanoNoiseReductionLevel(I)V

    invoke-static {p0}, Lcom/motorola/camera/JsonConfig;->getPanoRotationRatio(Lorg/json/JSONObject;)D

    move-result-wide v7

    invoke-virtual {v3, v7, v8}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setPanoRotationRatio(D)V
    ...
    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setFlashCctTableString(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setFlashAwbSpeed(F)V

    invoke-static {p0}, Lcom/motorola/camera/JsonConfig;->getZoomModeSwitchGains(Lorg/json/JSONObject;)[F

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->setZoomModeSwitchGains([F)V
    ...
    :goto_2
    :try_start_5
    invoke-static {v3, v0, p0, p0}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$msetVideoNvPromptLux(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;III)V
    :try_end_5
    ...
    :cond_6
    :goto_3
    invoke-static {v3}, Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;->-$$Nest$mbuild(Lcom/motorola/camera/JsonConfig$DeviceConfigHolder$Builder;)Lcom/motorola/camera/JsonConfig$DeviceConfigHolder;
