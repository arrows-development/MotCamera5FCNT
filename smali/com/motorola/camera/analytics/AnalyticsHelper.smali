...
# instance fields
.field public final mActivePhotoDataManager:Landroidx/lifecycle/MethodCallsLogger;

.field public final mAdobeDiscardValues:Landroidx/core/provider/CallbackWithHandler;
...
.field public final mDocEditValues:Landroidx/core/provider/CallbackWithHandler;
...
.field public final mPhotoSolidDataManager:Lcom/google/android/material/color/utilities/QuantizerResult;
...
.field public final mSessionValues:Landroidx/core/provider/CallbackWithHandler;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Landroidx/core/provider/CallbackWithHandler;

    new-instance v0, Landroidx/core/provider/CallbackWithHandler;

    invoke-direct {v0, v1}, Landroidx/core/provider/CallbackWithHandler;-><init>(I)V

    iput-object v0, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mDocEditValues:Landroidx/core/provider/CallbackWithHandler;

    new-instance v0, Landroidx/core/provider/CallbackWithHandler;

    invoke-direct {v0, v1}, Landroidx/core/provider/CallbackWithHandler;-><init>(I)V

    iput-object v0, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mAdobeDiscardValues:Landroidx/core/provider/CallbackWithHandler;
    ...
    iput-object v0, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mActivePhotoDataManager:Landroidx/lifecycle/MethodCallsLogger;

    new-instance v0, Lcom/google/android/material/color/utilities/QuantizerResult;

    invoke-direct {v0}, Lcom/google/android/material/color/utilities/QuantizerResult;-><init>()V

    iput-object v0, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mPhotoSolidDataManager:Lcom/google/android/material/color/utilities/QuantizerResult;
...
.method public final getStatesToListenFor()Ljava/util/Collection;
    ...
    sget-object v13, Lcom/motorola/camera/fsm/camera/states/SingleShotStates;->SS_REVIEW_RESULT_KEY:Lcom/motorola/camera/fsm/camera/StateKey;
    ...
    sget-object v15, Lcom/motorola/camera/fsm/camera/states/modes/VideoStates;->CODEC_VIDEO_STOP_KEY:Lcom/motorola/camera/fsm/camera/StateKey;

    sget-object v16, Lcom/motorola/camera/fsm/camera/states/modes/VideoStates;->VIDEO_START_CAPTURE_KEY:Lcom/motorola/camera/fsm/camera/StateKey;

    sget-object v17, Lcom/motorola/camera/fsm/camera/states/modes/VideoStates;->VIDEO_STOP_CAPTURE_KEY:Lcom/motorola/camera/fsm/camera/StateKey;

    sget-object v18, Lcom/motorola/camera/fsm/camera/states/Zoom;->ZOOM_SET_KEY:Lcom/motorola/camera/fsm/camera/StateKey;
...
.method public final handleClose(Lcom/motorola/camera/fsm/ChangeEvent;)V
    ...
    iget-object v1, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Landroidx/core/provider/CallbackWithHandler;

    invoke-virtual {v1, v0}, Landroidx/core/provider/CallbackWithHandler;->containsKey(Ljava/lang/String;)Z
    ...
    sget-object v0, Lcom/motorola/camera/analytics/UserExitAppEvent$ExitType;->POWER:Lcom/motorola/camera/analytics/UserExitAppEvent$ExitType;

    const-string v2, "EXITTYP"

    invoke-virtual {v1, v2, v0}, Landroidx/core/provider/CallbackWithHandler;->putSerializable(Ljava/lang/String;Ljava/io/Serializable;)V
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/core/provider/CallbackWithHandler;->putInt(ILjava/lang/String;)V
    ...
    const-string v0, "ANALYTICS_VIDEO_DV_TUTORIAL_ALIGNMENT"
    ...
    invoke-virtual {v1, v0, v2}, Landroidx/core/provider/CallbackWithHandler;->putBoolean(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v1, v0, p1}, Landroidx/core/provider/CallbackWithHandler;->putBoolean(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v1, v0, v2}, Landroidx/core/provider/CallbackWithHandler;->putInt(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v2, v3}, Landroidx/core/provider/CallbackWithHandler;->putInt(ILjava/lang/String;)V
    ...
    iget-object v5, v1, Landroidx/core/provider/CallbackWithHandler;->mCallback:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v8, v1, Landroidx/core/provider/CallbackWithHandler;->mCallbackHandler:Ljava/lang/Object;
    ...
    const-string v0, "MODEREMOVE"

    iget-object v3, v1, Landroidx/core/provider/CallbackWithHandler;->mCallback:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v4, v1, Landroidx/core/provider/CallbackWithHandler;->mCallbackHandler:Ljava/lang/Object;
    ...
    invoke-virtual {p1, v0, v1, v2}, Lcom/motorola/camera/analytics/LogEvent;->logEvent(Lcom/motorola/camera/analytics/AnalyticsService;Landroidx/core/provider/CallbackWithHandler;Ljava/lang/Object;)V
...
.method public final handleDocEditorEdit(ILjava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mDocEditValues:Landroidx/core/provider/CallbackWithHandler;
...
.method public final handleIdle(Lcom/motorola/camera/fsm/ChangeEvent;)V
    ...
    iget-object v0, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Landroidx/core/provider/CallbackWithHandler;

    const-string v1, "STARTUP"

    invoke-virtual {v0, v1}, Landroidx/core/provider/CallbackWithHandler;->containsKey(Ljava/lang/String;)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {v0, v1}, Landroidx/core/provider/CallbackWithHandler;->getLong(Ljava/lang/String;)J
    ...
    :cond_0
    sget-object v1, Lcom/motorola/camera/analytics/CameraSwitchEvent;->SWITCHTIME:Lcom/motorola/camera/analytics/Attributes/LongAttribute;
    ...
    invoke-virtual {v1, p0, v0, p1}, Lcom/motorola/camera/analytics/LogEvent;->logEvent(Lcom/motorola/camera/analytics/AnalyticsService;Landroidx/core/provider/CallbackWithHandler;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/core/provider/CallbackWithHandler;->containsKey(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1}, Landroidx/core/provider/CallbackWithHandler;->remove(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p0, p1}, Landroidx/core/provider/CallbackWithHandler;->putBoolean(Ljava/lang/String;Z)V
...
.method public final handleMultiShot(Lcom/motorola/camera/fsm/ChangeEvent;)V
    ...
    iget-object p1, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Landroidx/core/provider/CallbackWithHandler;
    ...
    invoke-virtual {v1, p0, p1, v0}, Lcom/motorola/camera/analytics/LogEvent;->logEvent(Lcom/motorola/camera/analytics/AnalyticsService;Landroidx/core/provider/CallbackWithHandler;Ljava/lang/Object;)V
...
.method public final handleOpenCamera(Z)V
    ...
    iget-object v2, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Landroidx/core/provider/CallbackWithHandler;

    invoke-virtual {v2, v1}, Landroidx/core/provider/CallbackWithHandler;->getBoolean(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v1}, Landroidx/core/provider/CallbackWithHandler;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v1}, Landroidx/core/provider/CallbackWithHandler;->getInt(Ljava/lang/String;)I
    ...
    invoke-virtual {v2, v1}, Landroidx/core/provider/CallbackWithHandler;->containsKey(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-virtual {v2}, Landroidx/core/provider/CallbackWithHandler;->clear()V

    invoke-virtual {v2, v0}, Landroidx/core/provider/CallbackWithHandler;->putAll(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v2, v0, v1, v3}, Landroidx/core/provider/CallbackWithHandler;->putLong(JLjava/lang/String;)V
    ...
    invoke-virtual {v2, v0, p1}, Landroidx/core/provider/CallbackWithHandler;->putBoolean(Ljava/lang/String;Z)V
...
.method public final handleVideoCaptured(Lcom/motorola/camera/fsm/ChangeEvent;)V
    ...
    iput-boolean v1, v4, Lcom/motorola/camera/capturedmediadata/CapturedMediaData;->mCaptureLogged:Z
    ...
    invoke-virtual {p0, v1, v0}, Landroidx/core/provider/CallbackWithHandler;->getInt(ILjava/lang/String;)I
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/core/provider/CallbackWithHandler;->putInt(ILjava/lang/String;)V
...
.method public final declared-synchronized initializeSessionValues()V
    ...
    invoke-static {v1}, Lcom/motorola/camera/analytics/CameraReadyEvent;->setupSessionValues(Landroidx/core/provider/CallbackWithHandler;)V
...
.method public final logPostCapture(Lcom/motorola/camera/capturedmediadata/CapturedMediaData;)V
    ...
    invoke-virtual {v0, v1, p0, p1}, Lcom/motorola/camera/analytics/LogEvent;->logEvent(Lcom/motorola/camera/analytics/AnalyticsService;Landroidx/core/provider/CallbackWithHandler;Ljava/lang/Object;)V
...
.method public final logPostDocEdit(Z)V
    ...
    iget-object v0, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mDocEditValues:Landroidx/core/provider/CallbackWithHandler;
    ...
    iget-object v1, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mPostDocEditEvent:Lcom/motorola/camera/analytics/PostDocEditEvent;
    ...
    invoke-virtual {v1, v2, v0, p1}, Lcom/motorola/camera/analytics/LogEvent;->logEvent(Lcom/motorola/camera/analytics/AnalyticsService;Landroidx/core/provider/CallbackWithHandler;Ljava/lang/Object;)V

    :cond_0
    iget-object p0, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mAdobeDiscardValues:Landroidx/core/provider/CallbackWithHandler;

    invoke-virtual {p0}, Landroidx/core/provider/CallbackWithHandler;->clear()V

    invoke-virtual {v0}, Landroidx/core/provider/CallbackWithHandler;->clear()V
...
.method public final logTidbitAction(Lcom/motorola/camera/detector/results/tidbit/Tidbit;Lcom/motorola/camera/detector/results/tidbit/actions/TidbitAction;)V
    ...
    :cond_b
    iget-object p1, p1, Lcom/motorola/camera/detector/results/tidbit/Tidbit;->mData:Landroidx/work/WorkManager;

    if-eqz p1, :cond_c

    invoke-virtual {p1}, Landroidx/work/WorkManager;->getFieldsCount()I
    ...
    invoke-virtual {p2, p0, p1, v0}, Lcom/motorola/camera/analytics/LogEvent;->logEvent(Lcom/motorola/camera/analytics/AnalyticsService;Landroidx/core/provider/CallbackWithHandler;Ljava/lang/Object;)V
...
.method public final onKpiUpdate(Lcom/motorola/camera/CameraKpi$KPI;JI)V
    ...
    invoke-virtual {v0, p2, p3, p1}, Landroidx/core/provider/CallbackWithHandler;->putLong(JLjava/lang/String;)V

    const/4 p1, 0x0

    iget-object p2, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mCameraReadyEvent:Lcom/motorola/camera/analytics/CameraReadyEvent;

    iget-object p0, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mAnalyticsService:Lcom/motorola/camera/analytics/AnalyticsService;

    invoke-virtual {p2, p0, v0, p1}, Lcom/motorola/camera/analytics/LogEvent;->logEvent(Lcom/motorola/camera/analytics/AnalyticsService;Landroidx/core/provider/CallbackWithHandler;Ljava/lang/Object;)V
...
.method public final setShotToShotMode(JLjava/lang/String;)V
    ...
    invoke-virtual {v0, p2, p0, p1}, Lcom/motorola/camera/analytics/LogEvent;->logEvent(Lcom/motorola/camera/analytics/AnalyticsService;Landroidx/core/provider/CallbackWithHandler;Ljava/lang/Object;)V
...
.method public final startShotToShotLogging(Lcom/motorola/camera/ShotType;JI)V
    ...
    invoke-virtual {v1, p2, p3, v0}, Landroidx/core/provider/CallbackWithHandler;->putLong(JLjava/lang/String;)V

    const-string v0, "SEQID"

    invoke-virtual {v1, v0}, Landroidx/core/provider/CallbackWithHandler;->getLong(Ljava/lang/String;)J
...
.method public final declared-synchronized stateChanged(Lcom/motorola/camera/fsm/ChangeEvent;)V
    ...
    iget-object v3, v0, Landroidx/core/text/BidiFormatter$Builder;->mTextDirectionHeuristicCompat:Ljava/lang/Object;

    check-cast v3, Ljava/lang/String;

    iget-object v4, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Landroidx/core/provider/CallbackWithHandler;

    invoke-virtual {v4, v1, v3}, Landroidx/core/provider/CallbackWithHandler;->getInt(ILjava/lang/String;)I
    ...
    invoke-virtual {v4, v3, v0}, Landroidx/core/provider/CallbackWithHandler;->putInt(ILjava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/core/provider/CallbackWithHandler;->putString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object p1, Lcom/motorola/camera/analytics/CameraSwitchEvent;->SWITCHTIME:Lcom/motorola/camera/analytics/Attributes/LongAttribute;
    ...
    invoke-virtual {p1, v2, v3, v0}, Landroidx/core/provider/CallbackWithHandler;->putLong(JLjava/lang/String;)V

    sget-object v0, Lcom/motorola/camera/analytics/CameraSwitchEvent;->SWITCHTIME:Lcom/motorola/camera/analytics/Attributes/LongAttribute;

    const-string v0, "SWITCHTRIGGER"

    invoke-virtual {p1, v1, v0}, Landroidx/core/provider/CallbackWithHandler;->putInt(ILjava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/core/provider/CallbackWithHandler;->containsKey(Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_14

    invoke-virtual {p1, v0}, Landroidx/core/provider/CallbackWithHandler;->getLong(Ljava/lang/String;)J

    move-result-wide v1

    invoke-virtual {p0, v1, v2}, Lcom/motorola/camera/analytics/AnalyticsHelper;->stopShotToShotLogging(J)V

    invoke-virtual {p1, v0}, Landroidx/core/provider/CallbackWithHandler;->remove(Ljava/lang/String;)V
    ...
    sget-object p1, Lcom/motorola/camera/analytics/UserExitAppEvent;->CAPTURED_PICS:Landroidx/core/text/BidiFormatter$Builder;

    iget-object v0, p1, Landroidx/core/text/BidiFormatter$Builder;->mTextDirectionHeuristicCompat:Ljava/lang/Object;

    check-cast v0, Ljava/lang/String;

    iget-object v3, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Landroidx/core/provider/CallbackWithHandler;

    invoke-virtual {v3, v1, v0}, Landroidx/core/provider/CallbackWithHandler;->getInt(ILjava/lang/String;)I
    ...
    invoke-virtual {v3, v0, p1}, Landroidx/core/provider/CallbackWithHandler;->putInt(ILjava/lang/String;)V
    ...
    sget-object v3, Lcom/motorola/camera/analytics/UserExitAppEvent;->SETTINGS_OPENED:Landroidx/core/text/BidiFormatter$Builder;

    iget-object v4, v3, Landroidx/core/text/BidiFormatter$Builder;->mTextDirectionHeuristicCompat:Ljava/lang/Object;

    check-cast v4, Ljava/lang/String;

    invoke-virtual {p1, v1, v4}, Landroidx/core/provider/CallbackWithHandler;->getInt(ILjava/lang/String;)I
    ...
    invoke-virtual {p1, v4, v3}, Landroidx/core/provider/CallbackWithHandler;->putInt(ILjava/lang/String;)V

    invoke-virtual {p1, v0, v1}, Landroidx/core/provider/CallbackWithHandler;->putBoolean(Ljava/lang/String;Z)V
    ...
    sget-object p1, Lcom/motorola/camera/analytics/UserExitAppEvent$ExitType;->TIMEDOUT:Lcom/motorola/camera/analytics/UserExitAppEvent$ExitType;

    iget-object v0, p0, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Landroidx/core/provider/CallbackWithHandler;

    const-string v1, "EXITTYP"

    invoke-virtual {v0, v1, p1}, Landroidx/core/provider/CallbackWithHandler;->putSerializable(Ljava/lang/String;Ljava/io/Serializable;)V
