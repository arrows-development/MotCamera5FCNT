...
.method public static setupSessionValues(Landroidx/core/provider/CallbackWithHandler;)V
    .locals 8
    ...
    invoke-virtual {p0, v3, v4, v2}, Landroidx/core/provider/CallbackWithHandler;->putLong(JLjava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v1}, Landroidx/core/provider/CallbackWithHandler;->putString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v2}, Landroidx/core/provider/CallbackWithHandler;->putBoolean(Ljava/lang/String;Z)V
...
.method public final addData(Landroidx/core/provider/CallbackWithHandler;Landroid/os/Bundle;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/core/provider/CallbackWithHandler;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/core/provider/CallbackWithHandler;->getBoolean(Ljava/lang/String;Z)Z
    ...
    iget-object v6, p1, Landroidx/core/provider/CallbackWithHandler;->mCallback:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v7, p1, Landroidx/core/provider/CallbackWithHandler;->mCallbackHandler:Ljava/lang/Object;
    ...
    invoke-virtual {v5, v6}, Lcom/motorola/camera/settings/Setting;->getSupportedValues(Lcom/motorola/camera/settings/CameraType;)Ljava/util/List;
    ...
    invoke-virtual {p1, v0}, Landroidx/core/provider/CallbackWithHandler;->getInt(Ljava/lang/String;)I
    ...
    invoke-virtual {p1, p0, v2}, Landroidx/core/provider/CallbackWithHandler;->putBoolean(Ljava/lang/String;Z)V

    const-string p0, "STARTUP"

    invoke-virtual {p1, v3, v4, p0}, Landroidx/core/provider/CallbackWithHandler;->putLong(JLjava/lang/String;)V
