...
.method public synthetic constructor <init>(Lcom/motorola/camera/detector/MLKitBarcodeDetector;Lcom/google/mlkit/vision/common/InputImage;IJ)V
    ...
    iput-object p1, p0, Lcom/motorola/camera/detector/MLKitBarcodeDetector$$ExternalSyntheticLambda1;->f$0:Ljava/lang/Object;

    iput-object p2, p0, Lcom/motorola/camera/detector/MLKitBarcodeDetector$$ExternalSyntheticLambda1;->f$1:Ljava/lang/Object;

    iput p3, p0, Lcom/motorola/camera/detector/MLKitBarcodeDetector$$ExternalSyntheticLambda1;->f$2:I

    iput-wide p4, p0, Lcom/motorola/camera/detector/MLKitBarcodeDetector$$ExternalSyntheticLambda1;->f$3:J
...
.method public final run()V
    ...
    check-cast v3, Lcom/google/mlkit/vision/common/InputImage;

    iget v4, p0, Lcom/motorola/camera/detector/MLKitBarcodeDetector$$ExternalSyntheticLambda1;->f$2:I
    ...
    invoke-static {v3, v1}, Landroidx/core/view/ViewKt;->checkNotNull$1(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :cond_0
    iget v1, v3, Lcom/google/mlkit/vision/common/InputImage;->zzd:I

    const/16 v2, 0x20

    if-lt v1, v2, :cond_1

    iget v1, v3, Lcom/google/mlkit/vision/common/InputImage;->zze:I
    ...
    new-instance v5, Lcom/google/mlkit/vision/common/internal/zza;

    invoke-direct {v5, p0, v3}, Lcom/google/mlkit/vision/common/internal/zza;-><init>(Lcom/google/mlkit/vision/barcode/internal/BarcodeScannerImpl;Lcom/google/mlkit/vision/common/InputImage;)V
    ...
    invoke-virtual {v1, v2, v5, v6}, Landroidx/room/SharedSQLiteStatement;->callAfterLoad(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;Lcom/google/android/gms/tasks/zza;)Lcom/google/android/gms/tasks/zzw;
    ...
    invoke-virtual {v2, v1}, Lcom/google/android/gms/tasks/zzw;->zza(Ljava/lang/Exception;)V
    :try_end_0
    ...
    invoke-direct/range {v1 .. v6}, Lcom/motorola/camera/detector/MLKitBarcodeDetector$$ExternalSyntheticLambda2;-><init>(Lcom/motorola/camera/detector/MLKitBarcodeDetector;Lcom/google/mlkit/vision/common/InputImage;IJ)V
    ...
    invoke-virtual {v9, p0}, Lcom/google/android/gms/tasks/zzw;->addOnCompleteListener(Lcom/google/android/gms/tasks/OnCompleteListener;)V
    ...
    sget-object v2, Lcom/motorola/camera/background/service/jms/coprocessor/saveimageService/BgServiceConnection;->Companion:Landroidx/transition/Transition$1;
    ...
    iget-object p0, v0, Lcom/motorola/camera/background/service/jms/coprocessor/saveimageService/BgServiceConnection;->listener:Lkotlin/jvm/internal/SpreadBuilder;
    ...
    invoke-direct {v4, p0, v2, v3, v0}, Lcom/motorola/camera/background/service/jms/coprocessor/saveimageService/SaveImageServiceHandler$TransferJobListener$$ExternalSyntheticLambda0;-><init>(Lkotlin/jvm/internal/SpreadBuilder;JI)V
    ...
    invoke-direct {v1, p0, v2, v3, v4}, Lcom/motorola/camera/background/service/jms/coprocessor/saveimageService/SaveImageServiceHandler$TransferJobListener$$ExternalSyntheticLambda0;-><init>(Lkotlin/jvm/internal/SpreadBuilder;JI)V
