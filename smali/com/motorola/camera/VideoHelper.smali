...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lcom/motorola/camera/VideoHelper;->SUPPORTED_VIDEO_SIZES_DEPTH:Ljava/util/List;

    sget-object v1, Lcom/motorola/camera/VideoFormat;->UHD_4K_21V9:Landroid/util/Size;

    move-object/from16 v16, v1

    sget-object v2, Lcom/motorola/camera/VideoFormat;->FHD_21V9:Landroid/util/Size;

    move-object/from16 v28, v2

    sget-object v3, Lcom/motorola/camera/VideoFormat;->FHD_21V9_2:Landroid/util/Size;
    ...
    sput-object v1, Lcom/motorola/camera/VideoHelper;->ANAMORPHIC_VIDEO_SIZES:Ljava/util/List;
    ...
    sput-object v1, Lcom/motorola/camera/VideoHelper;->TRUE_BYTE:Ljava/lang/Byte;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    sput-object v1, Lcom/motorola/camera/VideoHelper;->ALLOWED_VIDEO_SIZES:Ljava/util/ArrayList;
    ...
    sput-object v1, Lcom/motorola/camera/VideoHelper;->UNSUPPORTED_VIDEO_SIZES_DESKTOP:Ljava/util/ArrayList;

    sget-object v2, Lcom/motorola/camera/VideoFormat;->UHD_8K_SIZES:Ljava/util/List;
    ...
    sget-object v2, Lcom/motorola/camera/AppFeatures$Feature;->VIDEO_UNSUPPORTED_UHD_SIZE_DESKTOP:Lcom/motorola/camera/AppFeatures$Feature;
...
.method public static getCheckedAudioChannels(Landroid/media/AudioDeviceInfo;I)I
    ...
    const-string v0, "getCheckedAudioChannels: "
...
.method public static getCheckedAudioSampleRate(Landroid/media/AudioDeviceInfo;I)I
    ...
    const-string v0, "getCheckedAudioSampleRate: "
...
.method public static getRecorderDataForMode(ILcom/motorola/camera/settings/CameraType;)Lcom/motorola/camera/capturedmediadata/MediaRecorderData;
    ...
    invoke-static {v2}, Lkotlin/io/CloseableKt;->getArea(Landroid/util/Size;)I

    move-result v2

    iget-object v5, v0, Lcom/motorola/camera/VideoFormat;->mVideoSize:Landroid/util/Size;

    invoke-static {v5}, Lkotlin/io/CloseableKt;->getTrueAspectRatio(Landroid/util/Size;)F
    ...
    invoke-static {v7}, Lkotlin/io/CloseableKt;->getTrueAspectRatio(Landroid/util/Size;)F

    move-result v7

    invoke-static {v5, v7}, Lkotlin/io/CloseableKt;->isSameAspectRatio(FF)Z
    ...
    iput v8, v1, Lcom/motorola/camera/capturedmediadata/MediaRecorderData;->mAudioSampleRate:I
    ...
    iget v8, v1, Lcom/motorola/camera/capturedmediadata/MediaRecorderData;->mVideoBitRate:I

    div-int/2addr v8, v3

    iput v8, v1, Lcom/motorola/camera/capturedmediadata/MediaRecorderData;->mVideoBitRate:I
    ...
    invoke-direct {v3, v8, v4}, Landroid/util/Range;-><init>(Ljava/lang/Comparable;Ljava/lang/Comparable;)V
    ...
    invoke-direct {v0, v3, p0}, Landroid/util/Range;-><init>(Ljava/lang/Comparable;Ljava/lang/Comparable;)V

    iput-object v0, v1, Lcom/motorola/camera/capturedmediadata/MediaRecorderData;->mVideoFrameRateRecord:Landroid/util/Range;
    ...
    iput p0, v1, Lcom/motorola/camera/capturedmediadata/MediaRecorderData;->mVideoCodec:I

    iget-object p0, v1, Lcom/motorola/camera/capturedmediadata/MediaRecorderData;->mVideoFrameSize:Landroid/util/Size;

    iget-object p1, v1, Lcom/motorola/camera/capturedmediadata/MediaRecorderData;->mVideoFrameRateRecord:Landroid/util/Range;
    ...
    :cond_19
    :goto_b
    iput v0, v1, Lcom/motorola/camera/capturedmediadata/MediaRecorderData;->mVideoBitRate:I
...
.method public static getSameRatioInAllowedSupported(Lcom/motorola/camera/settings/Setting;)Ljava/util/List;
    ...
    invoke-direct {v1, p0, v2}, Lcom/motorola/camera/VideoHelper$$ExternalSyntheticLambda1;-><init>(Lcom/motorola/camera/settings/Setting;I)V
...
.method public static getSnapshotSize(Landroid/util/Size;Lcom/motorola/camera/settings/CameraType;)Landroid/util/Size;
    ...
    sget-object v5, Lcom/motorola/camera/settings/CustomKeyHelper;->SNAPSHOT_UPSCALE_SIZES_KEY:Lcom/motorola/camera/settings/CustomKeyHelper$CaptureResultKey;

    invoke-virtual {v5, v4, v1}, Lcom/motorola/camera/settings/CustomKeyHelper$CaptureResultKey;->getValue(Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Ljava/lang/Object;
    ...
    new-instance v2, Lcom/motorola/camera/VideoHelper$$ExternalSyntheticLambda2;

    invoke-direct {v2, p0, v3}, Lcom/motorola/camera/VideoHelper$$ExternalSyntheticLambda2;-><init>(Landroid/util/Size;I)V
    ...
    invoke-static {v2}, Lkotlin/io/CloseableKt;->getTrueAspectRatio(Landroid/util/Size;)F

    move-result v5

    invoke-static {v4, v5}, Lkotlin/io/CloseableKt;->isSameAspectRatio(FF)Z
    ...
    invoke-static {v4}, Lkotlin/io/CloseableKt;->getArea(Landroid/util/Size;)I
...
.method public static isDisableExternalDisplayVideoSize(Lcom/motorola/camera/VideoFormat;)Z
    ...
    :cond_0
    sget-boolean v0, Lcom/motorola/camera/FeaturesUtil;->LIMIT_EXTERNAL_DISPLAY_VIDEO_SIZE:Z
    ...
    sget-object v0, Lcom/motorola/camera/VideoFormat;->FHD_MAX:Landroid/util/Size;
...
.method public static isNotificationPermissionRequired()Z
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/mlkit_vision_common/zzas;->isPhotosStabilizationSupported(Z)Z
...
.method public static updateExternalDisplayLimitVideoSize()V
    ...
    iget-object v4, v4, Lcom/motorola/camera/VideoFormat;->mVideoSize:Landroid/util/Size;

    iget-object v5, v3, Lcom/motorola/camera/VideoFormat;->mVideoSize:Landroid/util/Size;

    invoke-static {v5, v4}, Lkotlin/io/CloseableKt;->isSameAspectRatio(Landroid/util/Size;Landroid/util/Size;)Z
