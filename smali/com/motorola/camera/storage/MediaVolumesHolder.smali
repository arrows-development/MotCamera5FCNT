...
.method public static final access$refreshMediaVolumes(Lcom/motorola/camera/storage/MediaVolumesHolder;)V
    ...
    const-string v4, "UUID_DEFAULT.toString()"
    ...
    :cond_2
    new-instance v5, Lcom/motorola/camera/storage/MediaVolume;

    invoke-virtual {v1}, Landroid/os/storage/StorageVolume;->isPrimary()Z

    move-result v1

    invoke-direct {v5, v1, v3, v4}, Lcom/motorola/camera/storage/MediaVolume;-><init>(ZLjava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v4, Lcom/motorola/camera/storage/MediaVolumesHolder$refreshMediaVolumes$$inlined$runOnWorker$2;

    invoke-direct {v4, v1, v2}, Lcom/motorola/camera/storage/MediaVolumesHolder$refreshMediaVolumes$$inlined$runOnWorker$2;-><init>(Lcom/motorola/camera/storage/MediaVolume;I)V
    ...
    new-instance v0, Lcom/motorola/camera/storage/MediaVolumesHolder$registerClient$$inlined$runOnWorker$1;

    const/4 v1, 0x1

    invoke-direct {v0, v1}, Lcom/motorola/camera/storage/MediaVolumesHolder$registerClient$$inlined$runOnWorker$1;-><init>(I)V
...
.method public static registerMediaBroadcastReceiver()V
    ...
    sget-object v3, Lcom/motorola/camera/storage/MediaVolumesHolder;->mediaBroadcastReceiver:Lcom/motorola/camera/SecureCamera$1;
