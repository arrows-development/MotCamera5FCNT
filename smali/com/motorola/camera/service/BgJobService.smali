...
.method public static addMetadataToJpeg(Landroid/os/Bundle;Lcom/motorola/camera/capturedmediadata/CapturedImageMediaData;)V
    ...
    invoke-direct {v1, v2}, Lcom/motorola/camera/photometadata/PhotoMetadata;-><init>(Ljava/io/ByteArrayInputStream;)V
    ...
    invoke-virtual {v1, p0}, Lcom/motorola/camera/photometadata/PhotoMetadata;->setMakernoteByteArray([B)V

    invoke-virtual {v1, v0}, Lcom/motorola/camera/photometadata/PhotoMetadata;->saveAttributesToByteArray(Z)[B
...
.method public static getTaskID(Landroid/os/Bundle;)Lcom/motorola/camera/background/common/TaskId;
    ...
    invoke-static {p0, v1, v0}, Landroidx/core/os/BundleCompat$Api33Impl;->getParcelable(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public static isValidData(Landroid/os/Bundle;)Z
    ...
    invoke-static {p0, v0, v1}, Landroidx/core/os/BundleCompat$Api33Impl;->getParcelable(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public static loadAuxiliaryData(JLjava/util/ArrayList;Lcom/motorola/camera/fsm/camera/record/ImageCaptureRecord;Landroid/content/Context;)Z
    ...
    const-string/jumbo p4, "record.mAuxImages"
...
.method public final cancelSaveImage(Landroid/os/Bundle;)V
    ...
    iget-wide v2, p1, Lcom/motorola/camera/background/common/TaskId;->jobNum:J
    ...
    invoke-direct {v2, v0, v1, v3}, Lcom/motorola/camera/saving/SaveImageService$$ExternalSyntheticLambda1;-><init>(Lcom/motorola/camera/saving/SaveImageService;Lcom/motorola/camera/CameraData;I)V
...
.method public final saveBgProcessImage(Landroid/os/Bundle;Landroid/content/Context;Lcom/motorola/camera/capturedmediadata/CapturedImageMediaData;)V
    ...
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_2c
    ...
    invoke-static {v5}, Landroidx/transition/Transition$1;->parseJobContext(Ljava/lang/String;)Ljava/util/HashMap;
    ...
    move-result-object v4
    :try_end_4
    .catch Ljava/lang/IllegalArgumentException; {:try_start_4 .. :try_end_4} :catch_28
    ...
    :try_end_6
    .catch Ljava/lang/IllegalArgumentException; {:try_start_6 .. :try_end_6} :catch_25
    ...
    invoke-static {v8, v15}, Lkotlin/io/ByteStreamsKt;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v3}, Lcom/motorola/camera/capturedmediadata/CapturedImageMediaData;->setActiveVideoFile(Ljava/io/File;)V
    :try_end_b
    ...
    invoke-static {v6}, Landroidx/transition/Transition$1;->parseAlgContext(Ljava/util/ArrayList;)Lcom/motorola/camera/background/provider/BgJobContext$AlgContext;

    move-result-object v6

    iget-object v8, v6, Lcom/motorola/camera/background/provider/BgJobContext$AlgContext;->jpegFids:Ljava/util/ArrayList;

    move/from16 v25, v12

    move-object v9, v13

    iget-wide v12, v6, Lcom/motorola/camera/background/provider/BgJobContext$AlgContext;->thumbFid:J
    :try_end_10
    ...
    :try_start_11
    iget-wide v9, v6, Lcom/motorola/camera/background/provider/BgJobContext$AlgContext;->exifFid:J

    move-wide/from16 v28, v3

    iget-wide v3, v6, Lcom/motorola/camera/background/provider/BgJobContext$AlgContext;->makerNoteFid:J
    :try_end_11
    .catch Ljava/lang/IllegalArgumentException; {:try_start_11 .. :try_end_11} :catch_1d
    .catch Ljava/io/IOException; {:try_start_11 .. :try_end_11} :catch_1c

    :try_start_12
    iget-wide v0, v6, Lcom/motorola/camera/background/provider/BgJobContext$AlgContext;->app6Fid:J
    :try_end_12
    ...
    :try_start_13
    iget-wide v14, v6, Lcom/motorola/camera/background/provider/BgJobContext$AlgContext;->auxliaryDataFid:J
    ...
    invoke-static {v2, v3, v4}, Lcom/motorola/camera/background/provider/FileDataContract;->retrieveFileInBuffer(Landroid/content/Context;J)[B

    move-result-object v3

    invoke-static {v2, v0, v1}, Lcom/motorola/camera/background/provider/FileDataContract;->retrieveFileInBuffer(Landroid/content/Context;J)[B
    ...
    invoke-direct {v4, v5, v10, v1}, Ljava/io/ByteArrayInputStream;-><init>([BII)V
    ...
    check-cast v5, Lcom/motorola/camera/background/provider/BgJobContext$JpegFileId;
    :try_end_15
    ...
    :try_start_16
    iget-wide v10, v5, Lcom/motorola/camera/background/provider/BgJobContext$JpegFileId;->fid:J

    move-object/from16 v5, v31

    move-wide/from16 v31, v10

    iget-object v10, v5, Lcom/motorola/camera/fsm/camera/record/ImageCaptureRecord;->mSceneMode:Lcom/motorola/camera/mcf/Mcf$SceneMode;
    ...
    iget-object v10, v11, Lcom/motorola/camera/background/provider/BgJobContext$JpegFileId;->category:Ljava/lang/String;
    :try_end_17
    ...
    iget-wide v10, v11, Lcom/motorola/camera/background/provider/BgJobContext$JpegFileId;->fid:J
    :try_end_18
    ...
    invoke-direct {v6, v8}, Lcom/motorola/camera/photometadata/PhotoMetadata;-><init>(Ljava/io/ByteArrayInputStream;)V

    new-instance v1, Lcom/motorola/camera/photometadata/PhotoMetadata;

    invoke-direct {v1, v4}, Lcom/motorola/camera/photometadata/PhotoMetadata;-><init>(Ljava/io/ByteArrayInputStream;)V

    invoke-virtual {v6, v1}, Lcom/motorola/camera/photometadata/PhotoMetadata;->copyPhotoMetadata(Lcom/motorola/camera/photometadata/PhotoMetadata;)V
    :try_end_1a
    ...
    :try_start_1b
    const-string v1, "Exif currently not supported by BgProcessing"
    :try_end_1b
    ...
    :goto_d
    :try_start_1d
    invoke-virtual {v6, v3}, Lcom/motorola/camera/photometadata/PhotoMetadata;->setMakernoteByteArray([B)V

    invoke-virtual {v6, v0}, Lcom/motorola/camera/photometadata/PhotoMetadata;->setApp6ByteArray([B)V
    ...
    :try_start_1e
    invoke-virtual {v6, v0}, Lcom/motorola/camera/photometadata/PhotoMetadata;->setThumbnailBytes([B)V
    :try_end_1e
    ...
    invoke-virtual {v6, v3, v1}, Lcom/motorola/camera/photometadata/PhotoMetadata;->setAttribute(Ljava/lang/String;Ljava/lang/String;)V

    const-string v3, "ImageLength"

    invoke-virtual {v6, v3, v0}, Lcom/motorola/camera/photometadata/PhotoMetadata;->setAttribute(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v1, v0}, Lcom/motorola/camera/photometadata/PhotoMetadata;->setAttribute(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_20
    ...
    :try_start_21
    invoke-virtual {v6, v1}, Lcom/motorola/camera/photometadata/PhotoMetadata;->saveAttributesToByteArray(Z)[B
    ...
    iget-object v0, v5, Lcom/motorola/camera/fsm/camera/record/ImageCaptureRecord;->mSceneMode:Lcom/motorola/camera/mcf/Mcf$SceneMode;
    ...
    invoke-static {v14, v15, v0, v5, v2}, Lcom/motorola/camera/service/BgJobService;->loadAuxiliaryData(JLjava/util/ArrayList;Lcom/motorola/camera/fsm/camera/record/ImageCaptureRecord;Landroid/content/Context;)Z
    ...
    :try_start_22
    invoke-virtual {v1, v14, v0, v3}, Lcom/motorola/camera/service/BgJobService;->saveNormalProcessImage(Landroid/os/Bundle;Landroid/content/Context;Lcom/motorola/camera/capturedmediadata/CapturedImageMediaData;)V
    ...
    :goto_15
    iget-object v3, v3, Lcom/motorola/camera/background/provider/BgJobContext$AlgContext;->algoAuxDataFids:Ljava/util/ArrayList;
    ...
    invoke-direct {v6, v4, v9}, Ljava/lang/String;-><init>([BLjava/nio/charset/Charset;)V

    iget-object v4, v5, Lcom/motorola/camera/fsm/camera/record/ImageCaptureRecord;->mMcfAuxData:Lcom/motorola/camera/mcf/McfAuxiliaryData;

    invoke-virtual {v4, v2, v6}, Lcom/motorola/camera/mcf/McfAuxiliaryData;->parseFromJson(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string/jumbo v6, "saveBgProcessImage dur:"
    ...
    const-string v6, "invalid Jpeg file Id(s): [thumbFid="

    invoke-virtual {v2, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v12, v13}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v6, ", exifFid="

    invoke-virtual {v2, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v9, v10}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v6, ", makerNoteFid="

    invoke-virtual {v2, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v3, v4}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v3, ", app6Fid="
    ...
    invoke-virtual {v0, v2, v1}, Landroidx/core/provider/CallbackWithHandler;->putParcelable(Ljava/lang/String;Landroid/os/Parcelable;)V

    move-object/from16 v3, v24

    invoke-virtual {v0, v3, v1}, Landroidx/core/provider/CallbackWithHandler;->putString(Ljava/lang/String;Ljava/lang/String;)V

    move-object/from16 v4, v23

    const/4 v1, 0x0

    invoke-virtual {v0, v1, v4}, Landroidx/core/provider/CallbackWithHandler;->putInt(ILjava/lang/String;)V

    move-object/from16 v5, v22

    const-wide/16 v1, 0x0

    invoke-virtual {v0, v1, v2, v5}, Landroidx/core/provider/CallbackWithHandler;->putLong(JLjava/lang/String;)V

    invoke-virtual {v0, v14}, Landroidx/core/provider/CallbackWithHandler;->putAll(Landroid/os/Bundle;)V

    move-object/from16 v6, v19

    const/4 v1, 0x1

    invoke-virtual {v0, v1, v6}, Landroidx/core/provider/CallbackWithHandler;->putInt(ILjava/lang/String;)V

    move-object/from16 v7, v17

    invoke-virtual {v0, v7}, Landroidx/core/provider/CallbackWithHandler;->getParcelable(Ljava/lang/String;)Landroid/os/Parcelable;
...
.method public final saveNormalProcessImage(Landroid/os/Bundle;Landroid/content/Context;Lcom/motorola/camera/capturedmediadata/CapturedImageMediaData;)V
    ...
    const-string/jumbo v11, "task_id"
    ...
    invoke-direct {v0, v2}, Landroidx/core/provider/CallbackWithHandler;-><init>(I)V

    const/4 v2, 0x0

    invoke-virtual {v0, v9, v2}, Landroidx/core/provider/CallbackWithHandler;->putParcelable(Ljava/lang/String;Landroid/os/Parcelable;)V

    invoke-virtual {v0, v8, v2}, Landroidx/core/provider/CallbackWithHandler;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v2, 0x0

    invoke-virtual {v0, v2, v7}, Landroidx/core/provider/CallbackWithHandler;->putInt(ILjava/lang/String;)V

    const-wide/16 v2, 0x0

    invoke-virtual {v0, v2, v3, v6}, Landroidx/core/provider/CallbackWithHandler;->putLong(JLjava/lang/String;)V

    invoke-virtual {v0, v1}, Landroidx/core/provider/CallbackWithHandler;->putAll(Landroid/os/Bundle;)V

    invoke-virtual {v0, v12, v5}, Landroidx/core/provider/CallbackWithHandler;->putInt(ILjava/lang/String;)V

    invoke-virtual {v0, v11}, Landroidx/core/provider/CallbackWithHandler;->getParcelable(Ljava/lang/String;)Landroid/os/Parcelable;
