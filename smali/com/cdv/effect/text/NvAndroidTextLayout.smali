...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Landroid/text/TextPaint;FZFIIZIIZZZLjava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    iput-object v1, v0, Lcom/cdv/effect/text/NvAndroidTextLayout;->m_fontFamilyName:Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2}, Lcom/adobe/xmp/impl/QName$$ExternalSynthetic$IA0;->m(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private initLayout(FZFZII)V
    ...
    invoke-static {p0, p1, p2}, Lcom/adobe/xmp/impl/QName$$ExternalSynthetic$IA0;->m(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private internalPrepareGlyphLines()V
    ...
    check-cast v11, Lcom/cdv/effect/text/NvAndroidTextLayout$InternalGlyphInfo;

    iget-boolean v12, v0, Lcom/cdv/effect/text/NvAndroidTextLayout;->m_measureBoundingOnly:Z

    if-nez v12, :cond_12

    iget-object v12, v0, Lcom/cdv/effect/text/NvAndroidTextLayout;->m_layout:Landroid/text/StaticLayout;

    iget v13, v11, Lcom/cdv/effect/text/NvAndroidTextLayout$InternalGlyphInfo;->startCharIdx:I

    invoke-virtual {v12, v13}, Landroid/text/Layout;->getPrimaryHorizontal(I)F

    move-result v12

    iput v12, v11, Lcom/cdv/effect/text/NvAndroidTextLayout$InternalGlyphInfo;->primaryHorizontal:F
    ...
    invoke-virtual {v12, v13}, Landroid/text/Layout;->getSecondaryHorizontal(I)F

    move-result v12

    iput v12, v11, Lcom/cdv/effect/text/NvAndroidTextLayout$InternalGlyphInfo;->secondaryHorizontal:F
    ...
    :cond_13
    new-instance v10, Lcom/cdv/effect/text/NvAndroidTextLayout$LineGlyphPositioner;

    iget-object v11, v0, Lcom/cdv/effect/text/NvAndroidTextLayout;->m_layout:Landroid/text/StaticLayout;

    invoke-virtual {v11, v6}, Landroid/text/StaticLayout;->getParagraphDirection(I)I

    move-result v11

    invoke-direct {v10, v3, v11, v1}, Lcom/cdv/effect/text/NvAndroidTextLayout$LineGlyphPositioner;-><init>(Ljava/util/ArrayList;IZ)V
    ...
    check-cast v12, Lcom/cdv/effect/text/NvAndroidTextLayout$InternalGlyphInfo;

    iget v15, v12, Lcom/cdv/effect/text/NvAndroidTextLayout$InternalGlyphInfo;->startCharIdx:I

    iget v14, v12, Lcom/cdv/effect/text/NvAndroidTextLayout$InternalGlyphInfo;->endCharIdx:I
    ...
    iput v2, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->lineEnd:I

    move-object/from16 v22, v3

    const/4 v3, 0x0

    iput-boolean v3, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->colorGlyph:Z

    iget-object v3, v0, Lcom/cdv/effect/text/NvAndroidTextLayout;->m_plainText:Ljava/lang/String;

    invoke-direct {v0, v3, v15, v14}, Lcom/cdv/effect/text/NvAndroidTextLayout;->mayHaveContextualForm(Ljava/lang/String;II)Z

    move-result v3

    iput-boolean v3, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->mayHaveContextualForm:Z

    iget-boolean v3, v12, Lcom/cdv/effect/text/NvAndroidTextLayout$InternalGlyphInfo;->isRtl:Z

    iput-boolean v3, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->isRtl:Z

    invoke-virtual {v10}, Lcom/cdv/effect/text/NvAndroidTextLayout$LineGlyphPositioner;->nextGlyphPosition()F
    ...
    iget v8, v0, Lcom/cdv/effect/text/NvAndroidTextLayout;->m_yOffset:F

    add-float/2addr v14, v8

    invoke-direct {v10, v3, v14}, Landroid/graphics/PointF;-><init>(FF)V

    iput-object v10, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->pos:Landroid/graphics/PointF;

    new-instance v8, Landroid/graphics/RectF;

    invoke-direct {v8}, Landroid/graphics/RectF;-><init>()V

    iput-object v8, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->bounding:Landroid/graphics/RectF;

    iget-boolean v8, v12, Lcom/cdv/effect/text/NvAndroidTextLayout$InternalGlyphInfo;->underline:Z

    iput-boolean v8, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->underline:Z

    iget-object v8, v12, Lcom/cdv/effect/text/NvAndroidTextLayout$InternalGlyphInfo;->paint:Landroid/graphics/Paint;

    iput-object v8, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->paint:Landroid/graphics/Paint;
    ...
    iput v8, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->fontAscent:F

    iget-object v8, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->paint:Landroid/graphics/Paint;
    ...
    iput v8, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->fontDescent:F

    new-instance v8, Landroid/graphics/Path;

    invoke-direct {v8}, Landroid/graphics/Path;-><init>()V

    iput-object v8, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->glyphPath:Landroid/graphics/Path;

    iget-object v10, v13, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->paint:Landroid/graphics/Paint;

    iget-object v14, v0, Lcom/cdv/effect/text/NvAndroidTextLayout;->m_plainText:Ljava/lang/String;
    ...
    iget-object v4, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->glyphPath:Landroid/graphics/Path;
    ...
    iget-boolean v4, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->mayHaveContextualForm:Z

    if-nez v4, :cond_14

    iget-object v3, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->glyphPath:Landroid/graphics/Path;

    iget-object v4, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->bounding:Landroid/graphics/RectF;

    const/4 v8, 0x0

    invoke-virtual {v3, v4, v8}, Landroid/graphics/Path;->computeBounds(Landroid/graphics/RectF;Z)V

    goto/16 :goto_c

    :cond_14
    iget v4, v12, Lcom/cdv/effect/text/NvAndroidTextLayout$InternalGlyphInfo;->advance:F

    iget-object v8, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->bounding:Landroid/graphics/RectF;
    ...
    iget-object v3, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->paint:Landroid/graphics/Paint;
    ...
    iget-object v3, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->bounding:Landroid/graphics/RectF;
    ...
    invoke-virtual {v3, v4, v9, v2, v1}, Landroid/graphics/Paint;->getTextBounds(Ljava/lang/String;IILandroid/graphics/Rect;)V

    iget-object v5, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->paint:Landroid/graphics/Paint;

    :cond_16
    iget-object v3, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->bounding:Landroid/graphics/RectF;

    iget-object v4, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->pos:Landroid/graphics/PointF;
    ...
    invoke-direct {v0, v3, v4, v10}, Lcom/cdv/effect/text/NvAndroidTextLayout;->isSuspectableColorGlyph(Ljava/lang/String;II)Z
    ...
    iput-boolean v3, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->colorGlyph:Z
    ...
    iget-object v8, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->paint:Landroid/graphics/Paint;

    iget-object v12, v0, Lcom/cdv/effect/text/NvAndroidTextLayout;->m_plainText:Ljava/lang/String;

    invoke-virtual {v8, v12, v4, v10, v3}, Landroid/graphics/Paint;->getTextBounds(Ljava/lang/String;IILandroid/graphics/Rect;)V
    ...
    iget-boolean v3, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->colorGlyph:Z
    ...
    invoke-static {v4, v8, v10, v4}, L_COROUTINE/_BOUNDARY$$ExternalSyntheticThrowCCEIfNotNull0;->m(FFFF)F
    ...
    iput-boolean v3, v6, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->noShape:Z
...
.method private prepareGlyphLines()V
    ...
    invoke-static {p0, v0, v1}, Lcom/adobe/xmp/impl/QName$$ExternalSynthetic$IA0;->m(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
