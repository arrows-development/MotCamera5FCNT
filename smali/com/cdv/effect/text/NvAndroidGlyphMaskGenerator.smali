...
.method public constructor <init>(I)V
    ...
    invoke-static {p0, p1, v0}, Lcom/adobe/xmp/impl/QName$$ExternalSynthetic$IA0;->m(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private waitHardwareRenderingFinished()Z
    ...
    invoke-static {p0, v2, v0}, Lcom/adobe/xmp/impl/QName$$ExternalSynthetic$IA0;->m(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public doDrawDoubleSidedGlyphOutline(Lcom/cdv/effect/text/NvAndroidTextLayout;IILandroid/graphics/Path;FLandroid/graphics/Canvas;ZZ)Z
    ...
    invoke-direct {p0, v4, v5, v3}, Lcom/cdv/effect/text/NvAndroidGlyphMaskGenerator;->selectPaint(Lcom/cdv/effect/text/NvAndroidTextLayout;ZLcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;)Landroid/graphics/Paint;
    ...
    invoke-virtual {v13, v5}, Landroid/graphics/Paint;->setStrokeJoin(Landroid/graphics/Paint$Join;)V
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/cdv/effect/text/NvAndroidTextLayout;->FontFamilyName()Ljava/lang/String;

    move-result-object v5

    invoke-direct {p0, v3, v5}, Lcom/cdv/effect/text/NvAndroidGlyphMaskGenerator;->shouldDrawGlyphWithPath(Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;Ljava/lang/String;)Z
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/cdv/effect/text/NvAndroidTextLayout;->getText()Landroid/text/SpannableString;

    move-result-object v5

    iget v6, v3, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->startCharIdx:I

    iget v7, v3, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->endCharIdx:I

    iget v8, v3, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->lineStart:I

    iget v9, v3, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->lineEnd:I

    iget-object v1, v3, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->pos:Landroid/graphics/PointF;

    iget v10, v1, Landroid/graphics/PointF;->x:F

    iget v11, v1, Landroid/graphics/PointF;->y:F

    iget-boolean v12, v3, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->isRtl:Z

    move-object/from16 v4, p6

    invoke-virtual/range {v4 .. v13}, Landroid/graphics/Canvas;->drawTextRun(Ljava/lang/CharSequence;IIIIFFZLandroid/graphics/Paint;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v0, v1, v3}, Lcom/adobe/xmp/impl/QName$$ExternalSynthetic$IA0;->m(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public drawColorGlyph(Lcom/cdv/effect/text/NvAndroidTextLayout;IILandroid/graphics/Bitmap;FFFFZ)Z
    ...
    iget p3, p2, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->startCharIdx:I

    iget p5, p2, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->endCharIdx:I

    iget-object p0, p2, Lcom/cdv/effect/text/NvAndroidTextLayout$GlyphInfo;->pos:Landroid/graphics/PointF;

    iget p8, p0, Landroid/graphics/PointF;->x:F

    iget p9, p0, Landroid/graphics/PointF;->y:F
...
.method public drawDoubleSidedGlyphOutline(Lcom/cdv/effect/text/NvAndroidTextLayout;IILandroid/graphics/Path;FLandroid/graphics/Bitmap;FFFFZZ)Z
    ...
    :try_start_0
    invoke-static/range {p6 .. p10}, Lcom/cdv/effect/text/NvAndroidGlyphMaskGenerator;->prepareCanvasForBitmap(Landroid/graphics/Bitmap;FFFF)Landroid/graphics/Canvas;
    ...
    invoke-virtual/range {v2 .. v10}, Lcom/cdv/effect/text/NvAndroidGlyphMaskGenerator;->doDrawDoubleSidedGlyphOutline(Lcom/cdv/effect/text/NvAndroidTextLayout;IILandroid/graphics/Path;FLandroid/graphics/Canvas;ZZ)Z
    ...
    invoke-static {v0, v2, v3}, Lcom/adobe/xmp/impl/QName$$ExternalSynthetic$IA0;->m(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public drawDoubleSidedGlyphOutlineHardware(Lcom/cdv/effect/text/NvAndroidTextLayout;IILandroid/graphics/Path;FZFFFFII)Z
    ...
    invoke-virtual/range {v3 .. v11}, Lcom/cdv/effect/text/NvAndroidGlyphMaskGenerator;->doDrawDoubleSidedGlyphOutline(Lcom/cdv/effect/text/NvAndroidTextLayout;IILandroid/graphics/Path;FLandroid/graphics/Canvas;ZZ)Z
...
.method public drawGlyphBody(Lcom/cdv/effect/text/NvAndroidTextLayout;IILandroid/graphics/Path;Landroid/graphics/Bitmap;FFFFZZ)Z
    ...
    :try_start_0
    invoke-static/range {p5 .. p9}, Lcom/cdv/effect/text/NvAndroidGlyphMaskGenerator;->prepareCanvasForBitmap(Landroid/graphics/Bitmap;FFFF)Landroid/graphics/Canvas;
    ...
    invoke-virtual/range {v2 .. v9}, Lcom/cdv/effect/text/NvAndroidGlyphMaskGenerator;->doDrawGlyphBody(Lcom/cdv/effect/text/NvAndroidTextLayout;IILandroid/graphics/Path;Landroid/graphics/Canvas;ZZ)Z
