...
.method public static constructor <clinit>()V
    ...
    invoke-static {v1, v0}, Lokio/Timeout;->inJavaUtil(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v3}, Lokio/Timeout;->inJavaLang(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v3}, Lokio/Timeout;->inJavaUtil(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    const-string/jumbo v33, "regionMatches(ILjava/lang/String;II)Z"

    const-string/jumbo v34, "regionMatches(ZILjava/lang/String;II)Z"

    const-string/jumbo v35, "replaceAll(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;"

    const-string/jumbo v36, "replace(CC)Ljava/lang/String;"

    const-string/jumbo v37, "replaceFirst(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;"

    const-string/jumbo v38, "replace(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;"

    const-string/jumbo v39, "split(Ljava/lang/String;I)[Ljava/lang/String;"

    const-string/jumbo v40, "split(Ljava/lang/String;)[Ljava/lang/String;"

    const-string/jumbo v41, "startsWith(Ljava/lang/String;I)Z"

    const-string/jumbo v42, "startsWith(Ljava/lang/String;)Z"
    ...
    const-string/jumbo v53, "repeat(I)Ljava/lang/String;"
    ...
    invoke-static {v6, v3}, Lokio/Timeout;->inJavaLang(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v8}, Lokio/Timeout;->inJavaLang(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v7, v3}, Lokio/Timeout;->inJavaLang(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v3}, Lokio/Timeout;->inJavaLang(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v2}, Lokio/Timeout;->inJavaLang(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v3}, Lokio/Timeout;->inJavaUtil(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    const-string/jumbo v8, "spliterator()Ljava/util/Spliterator;"
    ...
    invoke-static {v9, v3}, Lokio/Timeout;->inJavaLang(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    const-string/jumbo v9, "setStackTrace([Ljava/lang/StackTraceElement;)V"

    const-string v10, "fillInStackTrace()Ljava/lang/Throwable;"

    const-string v11, "getLocalizedMessage()Ljava/lang/String;"

    const-string/jumbo v12, "printStackTrace()V"

    const-string/jumbo v13, "printStackTrace(Ljava/io/PrintStream;)V"

    const-string/jumbo v14, "printStackTrace(Ljava/io/PrintWriter;)V"
    ...
    const-string/jumbo v11, "removeIf(Ljava/util/function/Predicate;)Z"

    filled-new-array {v8, v3, v10, v11}, [Ljava/lang/String;

    move-result-object v3

    invoke-static {v1, v3}, Lokio/Timeout;->inJavaUtil(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v8}, Lokio/Timeout;->inJavaUtil(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    const-string/jumbo v14, "replaceAll(Ljava/util/function/BiFunction;)V"
    ...
    const-string/jumbo v17, "putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"

    const-string/jumbo v18, "replace(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Z"
    ...
    invoke-static {v10, v8}, Lokio/Timeout;->inJavaUtil(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v1, v2}, Lokio/Timeout;->inJavaUtil(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v0}, Lokio/Timeout;->inJavaUtil(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v10, v1}, Lokio/Timeout;->inJavaUtil(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v3}, Lokio/Timeout;->constructors([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lokio/Timeout;->inJavaLang(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v0}, Lokio/Timeout;->constructors([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v7, v0}, Lokio/Timeout;->inJavaLang(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v1}, Lokio/Timeout;->constructors([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v6, v1}, Lokio/Timeout;->inJavaLang(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v0}, Lokio/Timeout;->inJavaLang(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
