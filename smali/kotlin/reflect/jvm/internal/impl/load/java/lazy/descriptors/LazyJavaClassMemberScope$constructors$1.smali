...
.method public final invoke()Ljava/lang/Object;
    ...
    invoke-static {v12, v4}, Lkotlin/io/ByteStreamsKt;->resolveAnnotations(Lcom/airbnb/lottie/parser/DropShadowEffect;Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaAnnotationOwner;)Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaAnnotations;
    ...
    invoke-virtual {v6, v4}, Lkotlin/ULong$Companion;->source(Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaElement;)Lkotlin/reflect/jvm/internal/impl/descriptors/runtime/components/RuntimeSourceElementFactory$RuntimeSourceElement;
    ...
    :goto_2
    invoke-static {v6, v5, v7}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaScope;->resolveValueParameters(Lcom/airbnb/lottie/parser/DropShadowEffect;Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;Ljava/util/List;)Lcom/motorola/camera/ui/DownUpDetector;
    ...
    invoke-static {v9, v12}, Lkotlin/math/MathKt;->collectionSizeOrDefault(Ljava/lang/Iterable;I)I
    ...
    iget-object v9, v7, Lcom/motorola/camera/ui/DownUpDetector;->mListener:Ljava/lang/Object;
    ...
    invoke-static {v4}, Lkotlinx/coroutines/JobKt__JobKt;->toDescriptorVisibility(Lkotlin/reflect/jvm/internal/impl/descriptors/Visibility;)Lkotlin/reflect/jvm/internal/impl/descriptors/DelegatedDescriptorVisibility;
    ...
    iget-boolean v4, v7, Lcom/motorola/camera/ui/DownUpDetector;->mStillDown:Z
    ...
    check-cast v5, Lkotlin/ULong$Companion;

    invoke-virtual {v5, v1}, Lkotlin/ULong$Companion;->source(Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaElement;)Lkotlin/reflect/jvm/internal/impl/descriptors/runtime/components/RuntimeSourceElementFactory$RuntimeSourceElement;
    ...
    invoke-static {v15, v10, v10, v14, v7}, Lkotlin/io/ExceptionsKt;->toAttributes$default(IZZLkotlin/reflect/jvm/internal/impl/descriptors/impl/AbstractTypeParameterDescriptor;I)Lkotlin/reflect/jvm/internal/impl/load/java/lazy/types/JavaTypeAttributes;
    ...
    check-cast v15, Landroidx/work/WorkQuery$Builder;
    ...
    invoke-virtual {v15, v7, v0}, Landroidx/work/WorkQuery$Builder;->transformJavaType(Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaType;Lkotlin/reflect/jvm/internal/impl/load/java/lazy/types/JavaTypeAttributes;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    check-cast v15, Lkotlin/ULong$Companion;

    invoke-virtual {v15, v14}, Lkotlin/ULong$Companion;->source(Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaElement;)Lkotlin/reflect/jvm/internal/impl/descriptors/runtime/components/RuntimeSourceElementFactory$RuntimeSourceElement;
    ...
    invoke-static {v5, v0}, Lkotlinx/coroutines/JobKt__JobKt;->computeJvmDescriptor$default(Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;I)Ljava/lang/String;
    ...
    invoke-static {v14, v0}, Lkotlinx/coroutines/JobKt__JobKt;->computeJvmDescriptor$default(Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;I)Ljava/lang/String;

    move-result-object v14

    invoke-static {v14, v7}, Lkotlin/io/ByteStreamsKt;->areEqual(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v11, v5, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/JavaResolverComponents;->signatureEnhancement:Lcom/google/gson/FieldAttributes;
    ...
    check-cast v4, Lkotlin/ULong$Companion;

    invoke-virtual {v4, v1}, Lkotlin/ULong$Companion;->source(Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaElement;)Lkotlin/reflect/jvm/internal/impl/descriptors/runtime/components/RuntimeSourceElementFactory$RuntimeSourceElement;
    ...
    invoke-static {v0, v5, v10, v4, v3}, Lkotlin/io/ExceptionsKt;->toAttributes$default(IZZLkotlin/reflect/jvm/internal/impl/descriptors/impl/AbstractTypeParameterDescriptor;I)Lkotlin/reflect/jvm/internal/impl/load/java/lazy/types/JavaTypeAttributes;
    ...
    check-cast v5, Landroidx/work/WorkQuery$Builder;

    check-cast v3, Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaArrayType;

    const/4 v6, 0x1

    invoke-virtual {v5, v3, v0, v6}, Landroidx/work/WorkQuery$Builder;->transformArrayType(Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaArrayType;Lkotlin/reflect/jvm/internal/impl/load/java/lazy/types/JavaTypeAttributes;Z)Lkotlin/reflect/jvm/internal/impl/types/UnwrappedType;

    move-result-object v5

    iget-object v6, v12, Lcom/airbnb/lottie/parser/DropShadowEffect;->radius:Ljava/lang/Object;

    check-cast v6, Landroidx/work/WorkQuery$Builder;
    ...
    invoke-virtual {v6, v3, v0}, Landroidx/work/WorkQuery$Builder;->transformJavaType(Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaType;Lkotlin/reflect/jvm/internal/impl/load/java/lazy/types/JavaTypeAttributes;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    check-cast v4, Landroidx/work/WorkQuery$Builder;
    ...
    invoke-virtual {v4, v5, v0}, Landroidx/work/WorkQuery$Builder;->transformJavaType(Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaType;Lkotlin/reflect/jvm/internal/impl/load/java/lazy/types/JavaTypeAttributes;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    :goto_e
    invoke-static {v14}, Lkotlin/io/ExceptionsKt;->listOfNotNull(Ljava/lang/Object;)Ljava/util/List;
    ...
    :cond_18
    invoke-virtual {v11, v2, v3}, Lcom/google/gson/FieldAttributes;->enhanceSignatures(Lcom/airbnb/lottie/parser/DropShadowEffect;Ljava/util/Collection;)Ljava/util/ArrayList;
