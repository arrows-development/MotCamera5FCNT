...
.method public final invoke()Ljava/lang/Object;
    ...
    :cond_3
    invoke-static {v2}, Lkotlin/io/FilesKt__UtilsKt;->toMap(Ljava/util/ArrayList;)Ljava/util/Map;
    ...
    :cond_4
    sget-object v3, Lkotlin/ULong$Companion;->INSTANCE:Lkotlin/ULong$Companion;
    ...
    invoke-static {v3, v1, v4}, Lkotlin/ULong$Companion;->mapJavaToKotlin$default(Lkotlin/ULong$Companion;Lkotlin/reflect/jvm/internal/impl/name/FqName;Lkotlin/reflect/jvm/internal/impl/builtins/KotlinBuiltIns;)Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
    ...
    invoke-static {v2}, Lkotlin/ResultKt;->getAnnotationClass(Ljava/lang/annotation/Annotation;)Lkotlin/reflect/KClass;

    move-result-object v2

    invoke-static {v2}, Lkotlin/ResultKt;->getJavaClass(Lkotlin/reflect/KClass;)Ljava/lang/Class;
    ...
    iget-object v2, v2, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/SingleModuleClassResolver;->resolver:Lcom/adobe/xmp/impl/QName;

    if-eqz v2, :cond_5

    invoke-virtual {v2, v3}, Lcom/adobe/xmp/impl/QName;->resolveClass(Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaClass;)Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
    ...
    iget-object p0, p0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationComponents;->notFoundClasses:Landroidx/work/WorkQuery$Builder;

    invoke-static {v0, v1, p0}, Lkotlin/LazyKt__LazyKt;->findNonGenericClassAcrossDependencies(Lkotlin/reflect/jvm/internal/impl/descriptors/ModuleDescriptor;Lkotlin/reflect/jvm/internal/impl/name/ClassId;Landroidx/work/WorkQuery$Builder;)Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
    ...
    invoke-static {p0}, Lkotlin/ResultKt;->getAnnotationClass(Ljava/lang/annotation/Annotation;)Lkotlin/reflect/KClass;

    move-result-object p0

    invoke-static {p0}, Lkotlin/ResultKt;->getJavaClass(Lkotlin/reflect/KClass;)Ljava/lang/Class;
