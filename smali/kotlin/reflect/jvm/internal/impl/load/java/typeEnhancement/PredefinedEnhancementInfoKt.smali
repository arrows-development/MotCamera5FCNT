...
.method public static constructor <clinit>()V
    ...
    sget-object v0, Lokio/Timeout;->INSTANCE$8:Lokio/Timeout;
    ...
    const-string/jumbo v13, "stream/Stream"
    ...
    new-instance v15, Landroidx/lifecycle/MethodCallsLogger;

    invoke-direct {v15, v3}, Landroidx/lifecycle/MethodCallsLogger;-><init>(I)V
    ...
    invoke-direct {v2, v15, v3}, Landroidx/core/provider/CallbackWithHandler;-><init>(Landroidx/lifecycle/MethodCallsLogger;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v5, v3}, Landroidx/core/provider/CallbackWithHandler;->function(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-direct {v3, v15, v2}, Landroidx/core/provider/CallbackWithHandler;-><init>(Landroidx/lifecycle/MethodCallsLogger;Ljava/lang/String;)V

    new-instance v2, Lkotlin/text/MatcherMatchResult$groups$1$iterator$1;

    const/4 v5, 0x7

    invoke-direct {v2, v5, v0}, Lkotlin/text/MatcherMatchResult$groups$1$iterator$1;-><init>(ILjava/lang/Object;)V

    const-string/jumbo v0, "spliterator"

    invoke-virtual {v3, v0, v2}, Landroidx/core/provider/CallbackWithHandler;->function(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-direct {v2, v15, v0}, Landroidx/core/provider/CallbackWithHandler;-><init>(Landroidx/lifecycle/MethodCallsLogger;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v0}, Landroidx/core/provider/CallbackWithHandler;->function(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-virtual {v2, v11, v0}, Landroidx/core/provider/CallbackWithHandler;->function(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V
    ...
    const-string/jumbo v11, "putIfAbsent"
    ...
    invoke-direct {v0, v15, v14}, Landroidx/core/provider/CallbackWithHandler;-><init>(Landroidx/lifecycle/MethodCallsLogger;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3, v2}, Landroidx/core/provider/CallbackWithHandler;->function(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-direct {v2, v8, v11}, Lkotlin/text/StringsKt__IndentKt$getIndentFunction$2;-><init>(Ljava/lang/String;I)V

    const-string v11, "ifPresent"

    invoke-virtual {v0, v11, v2}, Landroidx/core/provider/CallbackWithHandler;->function(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-direct {v1, v15, v0}, Landroidx/core/provider/CallbackWithHandler;-><init>(Landroidx/lifecycle/MethodCallsLogger;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v3, v0}, Landroidx/core/provider/CallbackWithHandler;->function(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V

    new-instance v0, Landroidx/core/provider/CallbackWithHandler;

    invoke-direct {v0, v15, v6}, Landroidx/core/provider/CallbackWithHandler;-><init>(Landroidx/lifecycle/MethodCallsLogger;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2, v1}, Landroidx/core/provider/CallbackWithHandler;->function(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V
    ...
    new-instance v6, Landroidx/core/provider/CallbackWithHandler;

    invoke-direct {v6, v15, v0}, Landroidx/core/provider/CallbackWithHandler;-><init>(Landroidx/lifecycle/MethodCallsLogger;Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v2, v0}, Landroidx/core/provider/CallbackWithHandler;->function(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V

    new-instance v0, Landroidx/core/provider/CallbackWithHandler;

    invoke-direct {v0, v15, v8}, Landroidx/core/provider/CallbackWithHandler;-><init>(Landroidx/lifecycle/MethodCallsLogger;Ljava/lang/String;)V

    new-instance v2, Lkotlin/text/StringsKt__IndentKt$getIndentFunction$2;

    const/4 v6, 0x6

    invoke-direct {v2, v4, v6}, Lkotlin/text/StringsKt__IndentKt$getIndentFunction$2;-><init>(Ljava/lang/String;I)V

    const-string v6, "accept"

    invoke-virtual {v0, v6, v2}, Landroidx/core/provider/CallbackWithHandler;->function(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V

    new-instance v0, Landroidx/core/provider/CallbackWithHandler;

    invoke-direct {v0, v15, v10}, Landroidx/core/provider/CallbackWithHandler;-><init>(Landroidx/lifecycle/MethodCallsLogger;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v15, v7}, Landroidx/core/provider/CallbackWithHandler;-><init>(Landroidx/lifecycle/MethodCallsLogger;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5, v2}, Landroidx/core/provider/CallbackWithHandler;->function(Ljava/lang/String;Lkotlin/jvm/functions/Function1;)V

    new-instance v0, Landroidx/core/provider/CallbackWithHandler;

    invoke-direct {v0, v15, v9}, Landroidx/core/provider/CallbackWithHandler;-><init>(Landroidx/lifecycle/MethodCallsLogger;Ljava/lang/String;)V
    ...
    iget-object v0, v15, Landroidx/lifecycle/MethodCallsLogger;->calledMethods:Ljava/util/AbstractMap;
