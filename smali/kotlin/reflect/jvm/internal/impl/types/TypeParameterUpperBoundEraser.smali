...
.field public final options:Lkotlin/ULong$Companion;

.field public final projectionComputer:Lkotlin/ULong$Companion;
...
.method public constructor <init>(Lkotlin/ULong$Companion;)V
    ...
    const-string/jumbo v1, "projectionComputer"

    invoke-static {p1, v1}, Lkotlin/io/ByteStreamsKt;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lkotlin/reflect/jvm/internal/impl/types/TypeParameterUpperBoundEraser;->projectionComputer:Lkotlin/ULong$Companion;

    iput-object v0, p0, Lkotlin/reflect/jvm/internal/impl/types/TypeParameterUpperBoundEraser;->options:Lkotlin/ULong$Companion;
    ...
    iput-object v0, p0, Lkotlin/reflect/jvm/internal/impl/types/TypeParameterUpperBoundEraser;->erroneousErasedBound$delegate:Lkotlin/SynchronizedLazyImpl;

    new-instance v0, Lkotlin/text/MatcherMatchResult$groups$1$iterator$1;

    const/16 v1, 0x11

    invoke-direct {v0, v1, p0}, Lkotlin/text/MatcherMatchResult$groups$1$iterator$1;-><init>(ILjava/lang/Object;)V
...
.method public final substituteErasedUpperBounds(Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/ErasureTypeAttributes;)Lkotlin/collections/builders/SetBuilder;
    ...
    iget-object v9, v0, Lkotlin/reflect/jvm/internal/impl/types/TypeParameterUpperBoundEraser;->options:Lkotlin/ULong$Companion;
    ...
    invoke-static {v15, v11}, Lkotlin/math/MathKt;->collectionSizeOrDefault(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v11, v6}, Lkotlin/collections/CollectionsKt___CollectionsKt;->getOrNull(Ljava/util/List;I)Ljava/lang/Object;
    ...
    invoke-static {v14, v7, v6, v10}, Lkotlin/text/CharsKt__CharKt;->replace$default(Lkotlin/reflect/jvm/internal/impl/types/SimpleType;Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;I)Lkotlin/reflect/jvm/internal/impl/types/SimpleType;
    ...
    invoke-static {v6, v13}, Lkotlin/io/ByteStreamsKt;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v10, v11}, Lkotlin/collections/CollectionsKt___CollectionsKt;->getOrNull(Ljava/util/List;I)Ljava/lang/Object;
    ...
    invoke-static {v13, v12}, Lkotlin/io/ByteStreamsKt;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v5, v7, v8, v10}, Lkotlin/text/CharsKt__CharKt;->replace$default(Lkotlin/reflect/jvm/internal/impl/types/SimpleType;Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/TypeAttributes;I)Lkotlin/reflect/jvm/internal/impl/types/SimpleType;

    move-result-object v5

    :cond_b
    :goto_5
    invoke-static {v14, v5}, Lkotlin/ULong$Companion;->flexibleType(Lkotlin/reflect/jvm/internal/impl/types/SimpleType;Lkotlin/reflect/jvm/internal/impl/types/SimpleType;)Lkotlin/reflect/jvm/internal/impl/types/UnwrappedType;
    ...
    :goto_9
    invoke-static {v0, v2}, Lkotlinx/coroutines/JobKt__JobKt;->inheritEnhancement(Lkotlin/reflect/jvm/internal/impl/types/UnwrappedType;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)Lkotlin/reflect/jvm/internal/impl/types/UnwrappedType;
    ...
    invoke-static {v1}, Lkotlinx/coroutines/TimeoutKt;->replaceArgumentsWithStarProjections(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)Lkotlin/reflect/jvm/internal/impl/types/UnwrappedType;
