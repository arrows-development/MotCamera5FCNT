...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v3, v4, p0}, Landroidx/core/view/PointerIconCompat;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v4, v5, v3}, Landroidx/core/view/DifferentialMotionFlingController;-><init>(Landroid/content/Context;Landroidx/core/view/PointerIconCompat;)V
...
.method public final onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v1, v5, v3, v6}, Landroidx/core/widget/NestedScrollView;->scrollBy(IIIZ)I
    ...
    iget v6, p0, Landroidx/core/view/DifferentialMotionFlingController;->mLastProcessedSource:I

    iget-object v7, p0, Landroidx/core/view/DifferentialMotionFlingController;->mFlingVelocityThresholds:[I

    if-ne v6, v1, :cond_6

    iget v6, p0, Landroidx/core/view/DifferentialMotionFlingController;->mLastProcessedDeviceId:I

    if-ne v6, v5, :cond_6

    iget v6, p0, Landroidx/core/view/DifferentialMotionFlingController;->mLastProcessedAxis:I
    ...
    :cond_6
    :goto_4
    iget-object v6, p0, Landroidx/core/view/DifferentialMotionFlingController;->mVelocityThresholdCalculator:Landroidx/media3/common/Format$$ExternalSyntheticLambda0;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v6, p0, Landroidx/core/view/DifferentialMotionFlingController;->mContext:Landroid/content/Context;
    ...
    invoke-static {v6, v8, v0, v9}, Landroidx/core/view/ViewConfigurationCompat$Api34Impl;->getScaledMinimumFlingVelocity(Landroid/view/ViewConfiguration;III)I
    ...
    invoke-static {v6, v8, v0, v9}, Landroidx/core/view/ViewConfigurationCompat$Api34Impl;->getScaledMaximumFlingVelocity(Landroid/view/ViewConfiguration;III)I

    move-result v6

    aput v6, v7, v3

    iput v1, p0, Landroidx/core/view/DifferentialMotionFlingController;->mLastProcessedSource:I

    iput v5, p0, Landroidx/core/view/DifferentialMotionFlingController;->mLastProcessedDeviceId:I
    ...
    :cond_7
    iget-object v5, p0, Landroidx/core/view/DifferentialMotionFlingController;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iput-object v5, p0, Landroidx/core/view/DifferentialMotionFlingController;->mVelocityTracker:Landroid/view/VelocityTracker;

    :cond_8
    iget-object v5, p0, Landroidx/core/view/DifferentialMotionFlingController;->mVelocityTracker:Landroid/view/VelocityTracker;

    iget-object v6, p0, Landroidx/core/view/DifferentialMotionFlingController;->mVelocityProvider:Landroidx/media3/common/Format$$ExternalSyntheticLambda0;
    ...
    invoke-virtual {v5, v6, p1}, Landroid/view/VelocityTracker;->computeCurrentVelocity(IF)V
    ...
    invoke-static {v5, v0}, Landroidx/core/view/VelocityTrackerCompat$Api34Impl;->getAxisVelocity(Landroid/view/VelocityTracker;I)F

    move-result p1

    iget-object v0, p0, Landroidx/core/view/DifferentialMotionFlingController;->mTarget:Landroidx/core/view/PointerIconCompat;

    iget-object v5, v0, Landroidx/core/view/PointerIconCompat;->mPointerIcon:Ljava/lang/Object;
    ...
    iget v1, p0, Landroidx/core/view/DifferentialMotionFlingController;->mLastFlingVelocity:F
    ...
    :cond_9
    iget-object v1, v0, Landroidx/core/view/PointerIconCompat;->mPointerIcon:Ljava/lang/Object;

    check-cast v1, Landroidx/core/widget/NestedScrollView;

    iget-object v1, v1, Landroidx/core/widget/NestedScrollView;->mScroller:Landroid/widget/OverScroller;
