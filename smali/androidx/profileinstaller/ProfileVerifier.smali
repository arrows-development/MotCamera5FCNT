...
.field public static sCompilationStatus:Landroidx/window/core/AndroidLogger;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/profileinstaller/ProfileVerifier;->sCompilationStatus:Landroidx/window/core/AndroidLogger;

    return-void
.end method

.method public static setCompilationStatus(IZZ)Landroidx/window/core/AndroidLogger;
    .locals 1

    new-instance p0, Landroidx/window/core/AndroidLogger;

    invoke-direct {p0}, Landroidx/window/core/AndroidLogger;-><init>()V

    sput-object p0, Landroidx/profileinstaller/ProfileVerifier;->sCompilationStatus:Landroidx/window/core/AndroidLogger;
    ...
    sget-object p2, Landroidx/concurrent/futures/AbstractResolvableFuture;->ATOMIC_HELPER:Lcom/google/android/material/sidesheet/SheetDelegate;

    const/4 v0, 0x0

    invoke-virtual {p2, p1, v0, p0}, Lcom/google/android/material/sidesheet/SheetDelegate;->casValue(Landroidx/concurrent/futures/AbstractResolvableFuture;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_0
    sget-object p0, Landroidx/profileinstaller/ProfileVerifier;->sCompilationStatus:Landroidx/window/core/AndroidLogger;
...
.method public static writeProfileVerification(Landroid/content/Context;)V
    ...
    sget-object v0, Landroidx/profileinstaller/ProfileVerifier;->sCompilationStatus:Landroidx/window/core/AndroidLogger;
    ...
    invoke-static {v5, v8}, Landroidx/profileinstaller/ProfileVerifier$Api33Impl;->getPackageInfo(Landroid/content/pm/PackageManager;Landroid/content/Context;)Landroid/content/pm/PackageInfo;
    ...
    :try_start_4
    invoke-static {v2, v0, v4}, Landroidx/profileinstaller/ProfileVerifier;->setCompilationStatus(IZZ)Landroidx/window/core/AndroidLogger;
    ...
    :goto_5
    :try_start_6
    invoke-static {v6, v0, v4}, Landroidx/profileinstaller/ProfileVerifier;->setCompilationStatus(IZZ)Landroidx/window/core/AndroidLogger;
