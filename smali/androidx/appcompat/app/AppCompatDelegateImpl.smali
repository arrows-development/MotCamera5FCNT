...
.field public mActionMenuPresenterCallback:Landroidx/collection/internal/LruHashMap;
...
.field public mPanelMenuPresenterCallback:Landroidx/core/view/PointerIconCompat;
...
.method public final applyApplicationSpecificConfig(ZZ)Z
    ...
    invoke-virtual {p0, p2, v1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->mapNightMode(Landroid/content/Context;I)I

    move-result v2

    const/4 v3, 0x0

    invoke-static {p2, v2, v3, v0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->createOverrideAppConfiguration(Landroid/content/Context;ILandroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
    ...
    iget v4, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mActivityHandlesConfigFlags:I
    ...
    invoke-static {v7}, Landroidx/appcompat/app/AppCompatDelegateImpl$Api24Impl;->getLocales(Landroid/content/res/Configuration;)Landroidx/core/os/LocaleListCompat;
    ...
    invoke-direct {v4, v8}, Landroid/content/res/Configuration;-><init>(Landroid/content/res/Configuration;)V
...
.method public final ensureSubDecor()V
    ...
    new-instance v3, Lcom/motorola/camera/settings/PersistBehavior;

    invoke-direct {v3, v5, p0}, Lcom/motorola/camera/settings/PersistBehavior;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v4, p0, v5}, Lcom/google/common/base/Splitter$1;-><init>(Ljava/lang/Object;I)V
...
.method public final openPanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    :cond_f
    iget-object v2, v0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mPanelMenuPresenterCallback:Landroidx/core/view/PointerIconCompat;

    if-nez v2, :cond_10

    new-instance v2, Landroidx/core/view/PointerIconCompat;

    invoke-direct {v2, v4, v0}, Landroidx/core/view/PointerIconCompat;-><init>(ILjava/lang/Object;)V

    iput-object v2, v0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mPanelMenuPresenterCallback:Landroidx/core/view/PointerIconCompat;
...
.method public final preparePanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    iget-object v6, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mActionMenuPresenterCallback:Landroidx/collection/internal/LruHashMap;
    ...
    invoke-direct {v6, v8, p0}, Landroidx/collection/internal/LruHashMap;-><init>(ILjava/lang/Object;)V

    iput-object v6, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mActionMenuPresenterCallback:Landroidx/collection/internal/LruHashMap;

    :cond_11
    iget-object v6, p1, Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;->menu:Landroidx/appcompat/view/menu/MenuBuilder;

    iget-object v8, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mActionMenuPresenterCallback:Landroidx/collection/internal/LruHashMap;

    check-cast v4, Landroidx/appcompat/widget/ActionBarOverlayLayout;

    invoke-virtual {v4, v6, v8}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->setMenu(Landroidx/appcompat/view/menu/MenuBuilder;Landroidx/collection/internal/LruHashMap;)V
    ...
    iget-object p0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mActionMenuPresenterCallback:Landroidx/collection/internal/LruHashMap;

    check-cast p1, Landroidx/appcompat/widget/ActionBarOverlayLayout;

    invoke-virtual {p1, v7, p0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->setMenu(Landroidx/appcompat/view/menu/MenuBuilder;Landroidx/collection/internal/LruHashMap;)V
    ...
    invoke-virtual {p2, v7, p0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->setMenu(Landroidx/appcompat/view/menu/MenuBuilder;Landroidx/collection/internal/LruHashMap;)V
...
.method public final updateStatusGuard(Landroid/graphics/Rect;Landroidx/core/view/WindowInsetsCompat;)I
    ...
    invoke-static {p1, v4, v6}, Landroidx/appcompat/widget/ViewUtils$Api29Impl;->computeFitSystemWindows(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
