...
.method public final loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/TintTypedArray;->getString(I)Ljava/lang/String;
    ...
    :cond_12
    sget-object v13, Landroidx/appcompat/R$styleable;->AppCompatTextView:[I
    ...
    iget-object v4, v5, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->mContext:Landroid/content/Context;

    invoke-virtual {v4, v8, v13, v9, v7}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v3

    iget-object v0, v5, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->mTextView:Landroid/widget/TextView;
    ...
    iput-object v3, v14, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->mAutoSizeTextSizesInPx:[I
    ...
    :cond_1c
    invoke-virtual {v14, v4, v2, v1}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->validateAndSetAutoSizeTextTypeUniformConfiguration(FFF)V
    ...
    invoke-static {v10, v0, v1, v2, v4}, Landroidx/appcompat/widget/AppCompatTextHelper$Api26Impl;->setAutoSizeTextTypeUniformWithConfiguration(Landroid/widget/TextView;IIII)V
    ...
    invoke-static {v10, v0, v4}, Landroidx/appcompat/widget/AppCompatTextHelper$Api26Impl;->setAutoSizeTextTypeUniformWithPresetSizes(Landroid/widget/TextView;[II)V
    ...
    invoke-virtual {v12, v11, v2}, Landroidx/appcompat/widget/AppCompatDrawableManager;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v12, v11, v5}, Landroidx/appcompat/widget/AppCompatDrawableManager;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v6, v4}, Landroidx/appcompat/widget/TintTypedArray;->getResourceId(II)I

    move-result v6

    if-eq v6, v4, :cond_24

    invoke-virtual {v12, v11, v6}, Landroidx/appcompat/widget/AppCompatDrawableManager;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v13, v4}, Landroidx/appcompat/widget/TintTypedArray;->getResourceId(II)I

    move-result v13

    if-eq v13, v4, :cond_27

    invoke-virtual {v12, v11, v13}, Landroidx/appcompat/widget/AppCompatDrawableManager;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v10, v11, v5, v2, v7}, Landroid/widget/TextView;->setCompoundDrawablesRelativeWithIntrinsicBounds(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v10, v2}, Landroidx/core/widget/TextViewCompat$Api23Impl;->setCompoundDrawableTintList(Landroid/widget/TextView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v2, v5}, Landroidx/appcompat/widget/DrawableUtils;->parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v0, v2, v4}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I
    ...
    invoke-virtual {v0, v4, v1}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I
    ...
    invoke-static {v5}, Landroidx/core/view/ViewKt;->checkArgumentNonnegative(I)V

    invoke-static {v10, v5}, Landroidx/core/widget/TextViewCompat$Api28Impl;->setFirstBaselineToTopHeight(Landroid/widget/TextView;I)V

    :cond_3c
    if-eq v2, v1, :cond_3e

    invoke-static {v2}, Landroidx/core/view/ViewKt;->checkArgumentNonnegative(I)V
    ...
    invoke-virtual {v10, v0, v1, v5, v2}, Landroid/widget/TextView;->setPadding(IIII)V
    ...
    invoke-static {v0}, Landroidx/core/view/ViewKt;->checkArgumentNonnegative(I)V
    ...
    :cond_3f
    invoke-static {v10, v4, v6}, Landroidx/core/widget/TextViewCompat$Api34Impl;->setLineHeight(Landroid/widget/TextView;IF)V
