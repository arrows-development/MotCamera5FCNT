...
.field public final mStartStopTokens:Lcom/adobe/xmp/impl/QName;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/WorkQuery$Builder;Landroidx/work/impl/WorkManagerImpl;)V
    ...
    invoke-direct {v0, v1}, Lcom/adobe/xmp/impl/QName;-><init>(I)V

    iput-object v0, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Lcom/adobe/xmp/impl/QName;
    ...
    iget-object p2, p2, Landroidx/work/Configuration;->mRunnableScheduler:Landroidx/collection/internal/LruHashMap;

    invoke-direct {p1, p0, p2}, Landroidx/work/impl/background/greedy/DelayedWorkTracker;-><init>(Landroidx/work/impl/background/greedy/GreedyScheduler;Landroidx/collection/internal/LruHashMap;)V
...
.method public final cancel(Ljava/lang/String;)V
    ...
    iget-object v0, v0, Landroidx/work/impl/background/greedy/DelayedWorkTracker;->mRunnableScheduler:Landroidx/collection/internal/LruHashMap;

    iget-object v0, v0, Landroidx/collection/internal/LruHashMap;->map:Ljava/lang/Object;
    ...
    :cond_3
    iget-object p0, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Lcom/adobe/xmp/impl/QName;

    invoke-virtual {p0, p1}, Lcom/adobe/xmp/impl/QName;->remove(Ljava/lang/String;)Ljava/util/List;
...
.method public final onAllConstraintsMet(Ljava/util/List;)V
    ...
    iget-object v1, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Lcom/adobe/xmp/impl/QName;

    invoke-virtual {v1, v0}, Lcom/adobe/xmp/impl/QName;->contains(Landroidx/work/impl/model/WorkGenerationalId;)Z
    ...
    invoke-virtual {v1, v0}, Lcom/adobe/xmp/impl/QName;->tokenFor(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;
...
.method public final onAllConstraintsNotMet(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v1, v0}, Lcom/adobe/xmp/impl/QName;->remove(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;
...
.method public final onExecuted(Landroidx/work/impl/model/WorkGenerationalId;Z)V
    ...
    iget-object p2, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Lcom/adobe/xmp/impl/QName;

    invoke-virtual {p2, p1}, Lcom/adobe/xmp/impl/QName;->remove(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;
...
.method public final varargs schedule([Landroidx/work/impl/model/WorkSpec;)V
    ...
    iget-object v7, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Lcom/adobe/xmp/impl/QName;

    invoke-virtual {v7, v6}, Lcom/adobe/xmp/impl/QName;->contains(Landroidx/work/impl/model/WorkGenerationalId;)Z
    ...
    iget-object v9, v6, Landroidx/work/impl/background/greedy/DelayedWorkTracker;->mRunnableScheduler:Landroidx/collection/internal/LruHashMap;

    if-eqz v8, :cond_4

    iget-object v10, v9, Landroidx/collection/internal/LruHashMap;->map:Ljava/lang/Object;
    ...
    iget-object v5, v9, Landroidx/collection/internal/LruHashMap;->map:Ljava/lang/Object;
    ...
    :cond_8
    iget-object v6, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Lcom/adobe/xmp/impl/QName;

    invoke-static {v5}, Landroidx/work/impl/model/WorkSpecKt;->generationalId(Landroidx/work/impl/model/WorkSpec;)Landroidx/work/impl/model/WorkGenerationalId;

    move-result-object v7

    invoke-virtual {v6, v7}, Lcom/adobe/xmp/impl/QName;->contains(Landroidx/work/impl/model/WorkGenerationalId;)Z
    ...
    invoke-virtual {v7, v5}, Lcom/adobe/xmp/impl/QName;->tokenFor(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;
