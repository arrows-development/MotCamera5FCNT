...
.field public final mDependencyDao:Lcom/motorola/camera/CameraKpi;
...
.method public constructor <init>(Landroidx/work/impl/WorkerWrapper$Builder;)V
    ...
    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->dependencyDao()Lcom/motorola/camera/CameraKpi;

    move-result-object v0

    iput-object v0, p0, Landroidx/work/impl/WorkerWrapper;->mDependencyDao:Lcom/motorola/camera/CameraKpi;
...
.method public final handleResult(Landroidx/work/ListenableWorker$Result;)V
    ...
    :cond_0
    iget-object p1, p0, Landroidx/work/impl/WorkerWrapper;->mDependencyDao:Lcom/motorola/camera/CameraKpi;
    ...
    invoke-virtual {p1, v0}, Lcom/motorola/camera/CameraKpi;->getDependentWorkIds(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p1, v7}, Lcom/motorola/camera/CameraKpi;->hasCompletedAllPrerequisites(Ljava/lang/String;)Z
...
.method public final onWorkFinished()V
    ...
    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->workProgressDao()Landroidx/work/WorkQuery$Builder;

    move-result-object v3

    invoke-virtual {v3, v1}, Landroidx/work/WorkQuery$Builder;->delete(Ljava/lang/String;)V
...
.method public final resetPeriodicAndResolve()V
    ...
    iget-object v5, v1, Landroidx/work/impl/model/WorkSpecDao_Impl;->__preparedStmtOfResetWorkSpecRunAttemptCount:Landroidx/work/impl/model/WorkSpecDao_Impl$3;
    ...
    iget-object v5, v1, Landroidx/work/impl/model/WorkSpecDao_Impl;->__preparedStmtOfIncrementPeriodCount:Landroidx/work/impl/model/WorkSpecDao_Impl$3;
...
.method public final run()V
    ...
    invoke-static {v14, v13}, L_COROUTINE/_BOUNDARY$$ExternalSyntheticThrowCCEIfNotNull0;->m(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_6
    iget-object v5, v11, Landroidx/work/impl/model/WorkSpecDao_Impl;->__db:Landroidx/room/RoomDatabase;
    ...
    invoke-static {v2, v9, v3}, L_COROUTINE/_BOUNDARY$$ExternalSyntheticThrowCCEIfNotNull0;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v4, v3, Landroidx/work/impl/model/WorkSpecDao_Impl;->__db:Landroidx/room/RoomDatabase;

    invoke-virtual {v4}, Landroidx/room/RoomDatabase;->assertNotSuspendingTransaction()V

    iget-object v3, v3, Landroidx/work/impl/model/WorkSpecDao_Impl;->__preparedStmtOfIncrementWorkSpecRunAttemptCount:Landroidx/work/impl/model/WorkSpecDao_Impl$3;
    ...
    invoke-interface {v5, v7}, Landroidx/sqlite/db/SupportSQLiteProgram;->bindNull(I)V

    goto :goto_b

    :cond_f
    invoke-interface {v5, v7, v2}, Landroidx/sqlite/db/SupportSQLiteProgram;->bindString(ILjava/lang/String;)V
    ...
    invoke-direct {v0, v3, v1, v2}, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda5;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public final setFailedAndResolve()V
    ...
    :cond_0
    iget-object v5, p0, Landroidx/work/impl/WorkerWrapper;->mDependencyDao:Lcom/motorola/camera/CameraKpi;

    invoke-virtual {v5, v4}, Lcom/motorola/camera/CameraKpi;->getDependentWorkIds(Ljava/lang/String;)Ljava/util/ArrayList;
