...
.field public mPreferenceUtils:Lcom/google/gson/FieldAttributes;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/utils/taskexecutor/WorkManagerTaskExecutor;)V
    ...
    iget-object v2, p3, Landroidx/work/impl/utils/taskexecutor/WorkManagerTaskExecutor;->mBackgroundExecutor:Landroidx/work/impl/utils/SerialExecutorImpl;
    ...
    invoke-direct {v0, v1, v3, v5}, Landroidx/room/RoomDatabase$Builder;-><init>(Landroid/content/Context;Ljava/lang/Class;Ljava/lang/String;)V

    iput-boolean v4, v0, Landroidx/room/RoomDatabase$Builder;->allowMainThreadQueries:Z
    ...
    invoke-static {v1, v3, v0}, Landroidx/room/Room;->databaseBuilder(Landroid/content/Context;Ljava/lang/Class;Ljava/lang/String;)Landroidx/room/RoomDatabase$Builder;

    move-result-object v0

    new-instance v3, Landroidx/work/impl/WorkDatabase$Companion$$ExternalSyntheticLambda0;

    invoke-direct {v3, v1}, Landroidx/work/impl/WorkDatabase$Companion$$ExternalSyntheticLambda0;-><init>(Landroid/content/Context;)V

    iput-object v3, v0, Landroidx/room/RoomDatabase$Builder;->factory:Landroidx/sqlite/db/SupportSQLiteOpenHelper$Factory;

    :goto_0
    iput-object v2, v0, Landroidx/room/RoomDatabase$Builder;->queryExecutor:Ljava/util/concurrent/Executor;

    sget-object v2, Landroidx/work/impl/CleanupCallback;->INSTANCE:Landroidx/work/impl/CleanupCallback;

    iget-object v3, v0, Landroidx/room/RoomDatabase$Builder;->callbacks:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v2}, Landroidx/room/RoomDatabase$Builder;->addMigrations([Landroidx/room/migration/Migration;)V
    ...
    invoke-direct {v2, v1, v3, v5}, Landroidx/work/impl/WorkMigration9To10;-><init>(Landroid/content/Context;II)V
    ...
    invoke-direct {v2, v1}, Landroidx/work/impl/WorkMigration9To10;-><init>(Landroid/content/Context;)V
    ...
    iput-boolean v1, v0, Landroidx/room/RoomDatabase$Builder;->requireMigration:Z

    iput-boolean v4, v0, Landroidx/room/RoomDatabase$Builder;->allowDestructiveMigrationOnDowngrade:Z
    ...
    iget v5, p2, Landroidx/work/Configuration;->mLoggingLevel:I

    invoke-direct {v3, v5}, Landroidx/work/Logger$LogcatLogger;-><init>(I)V
    ...
    :try_start_0
    sput-object v3, Landroidx/work/Logger$LogcatLogger;->sLogger:Landroidx/work/Logger$LogcatLogger;
    ...
    invoke-direct {v3, v2, p3}, Landroidx/work/WorkQuery$Builder;-><init>(Landroid/content/Context;Landroidx/work/impl/utils/taskexecutor/WorkManagerTaskExecutor;)V

    iput-object v3, p0, Landroidx/work/impl/WorkManagerImpl;->mTrackers:Landroidx/work/WorkQuery$Builder;

    sget-object v5, Landroidx/work/impl/Schedulers;->TAG:Ljava/lang/String;

    new-instance v5, Landroidx/work/impl/background/systemjob/SystemJobScheduler;

    invoke-direct {v5, v2, p0}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;-><init>(Landroid/content/Context;Landroidx/work/impl/WorkManagerImpl;)V
    ...
    invoke-virtual {v4, v6, v7}, Landroidx/work/Logger$LogcatLogger;->debug(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v4, Landroidx/work/impl/background/greedy/GreedyScheduler;

    invoke-direct {v4, v2, p2, v3, p0}, Landroidx/work/impl/background/greedy/GreedyScheduler;-><init>(Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/WorkQuery$Builder;Landroidx/work/impl/WorkManagerImpl;)V

    filled-new-array {v5, v4}, [Landroidx/work/impl/Scheduler;
    ...
    invoke-direct/range {v5 .. v10}, Landroidx/work/impl/Processor;-><init>(Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/utils/taskexecutor/WorkManagerTaskExecutor;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V
    ...
    iput-object p3, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkTaskExecutor:Landroidx/work/impl/utils/taskexecutor/WorkManagerTaskExecutor;

    iput-object v0, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkDatabase:Landroidx/work/impl/WorkDatabase;

    iput-object v2, p0, Landroidx/work/impl/WorkManagerImpl;->mSchedulers:Ljava/util/List;
    ...
    invoke-direct {p2, p3, v0}, Lcom/google/gson/FieldAttributes;-><init>(ILjava/lang/Object;)V

    iput-object p2, p0, Landroidx/work/impl/WorkManagerImpl;->mPreferenceUtils:Lcom/google/gson/FieldAttributes;
    ...
    iget-object p2, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkTaskExecutor:Landroidx/work/impl/utils/taskexecutor/WorkManagerTaskExecutor;
...
.method public static getInstance(Landroid/content/Context;)Landroidx/work/impl/WorkManagerImpl;
    ...
    iput-object v1, v2, Lcom/google/common/base/Joiner;->separator:Ljava/lang/String;

    new-instance v1, Landroidx/work/Configuration;

    invoke-direct {v1, v2}, Landroidx/work/Configuration;-><init>(Lcom/google/common/base/Joiner;)V
...
.method public final rescheduleEligibleWork()V
    ...
    iget-object v0, v0, Landroidx/work/impl/model/WorkSpecDao_Impl;->__preparedStmtOfResetScheduledState:Landroidx/work/impl/model/WorkSpecDao_Impl$3;
