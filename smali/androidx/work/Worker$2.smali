...
.method private run$com$motorola$camera$ui$widgets$gl$textures$ModeMenuTexture$CheckStopMovingPress()V
    ...
    invoke-virtual {v0, v2}, Lcom/motorola/camera/ui/widgets/gl/textures/modes/TableRow;->addCell(Lcom/motorola/camera/ui/widgets/gl/textures/modes/BitmapTextCell;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {v4}, Lcom/motorola/camera/ui/widgets/gl/textures/modes/TableCell;->getSortRect()Landroidx/core/view/PointerIconCompat;
    ...
    invoke-virtual {v7, v8, v6}, Landroidx/core/view/PointerIconCompat;->contains(FF)Z
...
.method private run$kotlinx$coroutines$ResumeUndispatchedRunnable()V
    .locals 1
...
.method public final run()V
    ...
    invoke-direct {p0}, Landroidx/work/Worker$2;->run$kotlinx$coroutines$ResumeUndispatchedRunnable()V
    ...
    iget-object v6, p0, Landroidx/work/Worker$2;->this$0:Ljava/lang/Object;

    if-nez v0, :cond_1

    check-cast v6, Lcom/motorola/camera/utility/WifiConnection;

    iget v0, v6, Lcom/motorola/camera/utility/WifiConnection;->mAttempts:I

    add-int/2addr v0, v4

    iput v0, v6, Lcom/motorola/camera/utility/WifiConnection;->mAttempts:I

    const/4 v1, 0x5

    if-ge v0, v1, :cond_6

    iget-object v0, v6, Lcom/motorola/camera/utility/WifiConnection;->mEvent:Lcom/motorola/camera/fsm/ChangeEvent;
    ...
    iget v0, v6, Lcom/motorola/camera/utility/WifiConnection;->mType:I

    if-eq v0, v4, :cond_2

    iget-object v0, v6, Lcom/motorola/camera/utility/WifiConnection;->mPassword:Ljava/lang/String;
    ...
    iget-object v4, v6, Lcom/motorola/camera/utility/WifiConnection;->mSsid:Ljava/lang/String;
    ...
    iget-boolean v4, v6, Lcom/motorola/camera/utility/WifiConnection;->mIsHidden:Z
    ...
    iget v4, v6, Lcom/motorola/camera/utility/WifiConnection;->mType:I
    ...
    :cond_3
    iget-object v1, v6, Lcom/motorola/camera/utility/WifiConnection;->mPassword:Ljava/lang/String;
    ...
    invoke-direct {v1, v3}, Lcom/motorola/camera/ui/uicomponents/ToastUIComponent$ToastFeatureBuilder;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Landroid/net/wifi/WifiManager;->removeNetworkSuggestions(Ljava/util/List;)I
    ...
    iget-object v0, v6, Lcom/motorola/camera/utility/WifiConnection;->mEventListener:Lcom/motorola/camera/EventListener;

    new-instance v1, Lcom/motorola/camera/Util$ActivityLaunchRequestInfo;

    const/16 v2, 0x11

    invoke-direct {v1, p0, v2, v3}, Lcom/motorola/camera/Util$ActivityLaunchRequestInfo;-><init>(Landroid/content/Intent;II)V
    ...
    iget-object v2, v1, Lcom/motorola/camera/JsonConfig$CameraMapping;->physicalRole:Ljava/lang/Object;
    ...
    :cond_a
    invoke-static {v3}, Landroidx/core/view/ViewKt;->checkState(Z)V
    ...
    iget-object v1, v0, Landroidx/room/SharedSQLiteStatement;->stmt$delegate:Ljava/lang/Object;
    ...
    :goto_5
    invoke-static {v4}, Landroidx/core/view/ViewKt;->checkState(Z)V

    if-nez v1, :cond_c

    invoke-virtual {v0}, Landroidx/room/SharedSQLiteStatement;->release()V
    ...
    invoke-virtual {p0, v5}, Lcom/google/android/gms/tasks/zzw;->zzb(Ljava/lang/Object;)V
    ...
    check-cast v1, Lkotlin/jvm/internal/SpreadBuilder;
    ...
    invoke-virtual {v1, p0}, Lkotlin/jvm/internal/SpreadBuilder;->then(Ljava/lang/Object;)Lcom/google/android/gms/tasks/zzw;
    ...
    sget-object v1, Lcom/google/android/gms/common/api/internal/zact;->zaa:Lcom/google/android/gms/signin/zaa;

    iget-object v1, p0, Lcom/google/android/gms/signin/internal/zak;->zab:Lcom/google/android/gms/common/ConnectionResult;

    iget v6, v1, Lcom/google/android/gms/common/ConnectionResult;->zzb:I
    ...
    iput-object p0, v1, Lcom/google/android/gms/common/api/internal/zabu;->zae:Ljava/lang/Object;
    ...
    iget-object v1, v1, Lcom/google/android/gms/common/api/internal/zabu;->zab:Ljava/lang/Object;

    check-cast v1, Lcom/google/android/gms/common/api/Api$Client;

    check-cast p0, Ljava/util/Set;

    invoke-interface {v1, v5, p0}, Lcom/google/android/gms/common/api/Api$Client;->getRemoteService(Lcom/google/android/gms/common/internal/IAccountAccessor;Ljava/util/Set;)V
    ...
    check-cast p0, Lkotlin/DeepRecursiveFunction;
    ...
    iget-object v2, v1, Lcom/google/android/gms/common/api/internal/zabu;->zaa:Ljava/lang/Object;

    check-cast v2, Lcom/google/android/gms/common/api/internal/GoogleApiManager;

    iget-object v2, v2, Lcom/google/android/gms/common/api/internal/GoogleApiManager;->zap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-interface {v0, v5, p0}, Lcom/google/android/gms/common/api/Api$Client;->getRemoteService(Lcom/google/android/gms/common/internal/IAccountAccessor;Ljava/util/Set;)V
    :try_end_6
    ...
    :goto_10
    invoke-virtual {v2, p0, v5}, Lcom/google/android/gms/common/api/internal/zabq;->zar(Lcom/google/android/gms/common/ConnectionResult;Ljava/lang/RuntimeException;)V
    ...
    iget-object v5, v3, Landroidx/work/impl/WorkerWrapper;->mWorkSpec:Landroidx/work/impl/model/WorkSpec;
    ...
    invoke-virtual {v1, v3, v4}, Landroidx/work/Logger$LogcatLogger;->error(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v1, v3, Landroidx/work/impl/WorkerWrapper;->mResult:Landroidx/work/ListenableWorker$Result;
    :try_end_11
    ...
    invoke-virtual {v0, v5}, Landroid/app/Application;->unregisterActivityLifecycleCallbacks(Landroid/app/Application$ActivityLifecycleCallbacks;)V
    ...
    :cond_28
    invoke-virtual {v1, v3, v3, v3, v3}, Landroidx/appcompat/view/menu/MenuPopupHelper;->showPopup(IIZZ)V
    ...
    :cond_29
    iput-object v5, v0, Landroidx/appcompat/widget/ActionMenuPresenter;->mPostedOpenRunnable:Landroidx/work/Worker$2;
