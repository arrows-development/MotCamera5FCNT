...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v1, v2}, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda9;-><init>(I)V

    invoke-direct {v0, v1}, Landroidx/core/view/MenuHostHelper;-><init>(Lcom/motorola/camera/Controller$$ExternalSyntheticLambda9;)V
...
# virtual methods
.method public final addExtractorsForFileType(Ljava/util/ArrayList;I)V
    .locals 3
    ...
    invoke-virtual {p0, p2}, Landroidx/core/view/MenuHostHelper;->getExtractor([Ljava/lang/Object;)Landroidx/media3/extractor/Extractor;
    ...
    :pswitch_5
    iget-object p2, p0, Landroidx/media3/extractor/DefaultExtractorsFactory;->tsSubtitleFormats:Lcom/google/common/collect/RegularImmutableList;
    ...
    iput-object p2, p0, Landroidx/media3/extractor/DefaultExtractorsFactory;->tsSubtitleFormats:Lcom/google/common/collect/RegularImmutableList;

    :cond_0
    new-instance p2, Landroidx/media3/extractor/ts/TsExtractor;
    ...
    invoke-direct {p2, v0, v1}, Landroidx/media3/extractor/ts/TsExtractor;-><init>(Landroidx/media3/common/util/TimestampAdjuster;Landroidx/media3/extractor/ts/DefaultTsPayloadReaderFactory;)V
...
.method public final declared-synchronized createExtractors(Landroid/net/Uri;Ljava/util/Map;)[Landroidx/media3/extractor/Extractor;
    ...
    invoke-static {p2}, Landroidx/core/view/ViewGroupKt;->inferFileTypeFromResponseHeaders(Ljava/util/Map;)I
    ...
    invoke-virtual {p0, v0, p2}, Landroidx/media3/extractor/DefaultExtractorsFactory;->addExtractorsForFileType(Ljava/util/ArrayList;I)V

    :cond_0
    invoke-static {p1}, Landroidx/core/view/ViewGroupKt;->inferFileTypeFromUri(Landroid/net/Uri;)I
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/media3/extractor/DefaultExtractorsFactory;->addExtractorsForFileType(Ljava/util/ArrayList;I)V
    ...
    invoke-virtual {p0, v0, v4}, Landroidx/media3/extractor/DefaultExtractorsFactory;->addExtractorsForFileType(Ljava/util/ArrayList;I)V
