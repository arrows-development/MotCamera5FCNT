...
.method public final consume(Landroidx/media3/common/util/ParsableByteArray;)V
    ...
    invoke-direct {v15, v6, v13}, Landroidx/media3/common/ColorInfo$Builder;-><init>([BI)V
    ...
    invoke-virtual {v15, v13}, Landroidx/media3/common/ColorInfo$Builder;->readBits(I)I
    ...
    sget-object v13, Landroidx/media3/extractor/ts/H263Reader;->PIXEL_WIDTH_HEIGHT_RATIO_BY_ASPECT_RATIO_INFO:[F
    ...
    :cond_16
    invoke-virtual {v15, v14}, Landroidx/media3/common/ColorInfo$Builder;->skipBits(I)V
    ...
    iput v14, v15, Landroidx/media3/common/Format$Builder;->width:I

    iput v13, v15, Landroidx/media3/common/Format$Builder;->height:I

    iput v11, v15, Landroidx/media3/common/Format$Builder;->pixelWidthHeightRatio:F

    invoke-static {v6}, Ljava/util/Collections;->singletonList(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v6

    iput-object v6, v15, Landroidx/media3/common/Format$Builder;->initializationData:Ljava/util/List;

    new-instance v6, Landroidx/media3/common/Format;

    invoke-direct {v6, v15}, Landroidx/media3/common/Format;-><init>(Landroidx/media3/common/Format$Builder;)V

    invoke-interface {v9, v6}, Landroidx/media3/extractor/TrackOutput;->format(Landroidx/media3/common/Format;)V

    const/4 v6, 0x1

    iput-boolean v6, v0, Landroidx/media3/extractor/ts/H263Reader;->hasOutputFormat:Z
    ...
    invoke-virtual {v6, v2, v5, v4}, Landroidx/media3/extractor/ts/H263Reader$SampleReader;->onData(II[B)V
    ...
    iget v6, v7, Landroidx/media3/extractor/ts/NalUnitTargetBuffer;->nalLength:I
    ...
    iget-object v6, v7, Landroidx/media3/extractor/ts/NalUnitTargetBuffer;->nalData:Ljava/lang/Object;

    check-cast v6, [B

    iget-object v9, v0, Landroidx/media3/extractor/ts/H263Reader;->userDataParsable:Landroidx/media3/common/util/ParsableByteArray;

    invoke-virtual {v9, v2, v6}, Landroidx/media3/common/util/ParsableByteArray;->reset(I[B)V

    iget-wide v10, v0, Landroidx/media3/extractor/ts/H263Reader;->pesTimeUs:J

    iget-object v2, v0, Landroidx/media3/extractor/ts/H263Reader;->userDataReader:Landroidx/media3/extractor/ts/UserDataReader;

    invoke-virtual {v2, v10, v11, v9}, Landroidx/media3/extractor/ts/UserDataReader;->consume(JLandroidx/media3/common/util/ParsableByteArray;)V
    ...
    iget-boolean v5, v0, Landroidx/media3/extractor/ts/H263Reader;->hasOutputFormat:Z
    ...
    iget-boolean v5, v2, Landroidx/media3/extractor/ts/H263Reader$SampleReader;->readingSample:Z
    ...
    iget-wide v6, v2, Landroidx/media3/extractor/ts/H263Reader$SampleReader;->samplePosition:J

    sub-long v5, v12, v6

    long-to-int v5, v5

    iget-boolean v6, v2, Landroidx/media3/extractor/ts/H263Reader$SampleReader;->sampleIsKeyframe:Z
    ...
    :goto_d
    iget v6, v2, Landroidx/media3/extractor/ts/H263Reader$SampleReader;->startCodeValue:I
    ...
    iput-wide v9, v2, Landroidx/media3/extractor/ts/H263Reader$SampleReader;->samplePosition:J
    ...
    iput-boolean v6, v2, Landroidx/media3/extractor/ts/H263Reader$SampleReader;->sampleIsKeyframe:Z
    ...
    :goto_f
    iput-boolean v6, v2, Landroidx/media3/extractor/ts/H263Reader$SampleReader;->readingSample:Z
    ...
    iput v5, v2, Landroidx/media3/extractor/ts/H263Reader$SampleReader;->vopBytesRead:I

    iput-wide v9, v2, Landroidx/media3/extractor/ts/H263Reader$SampleReader;->sampleTimeUs:J
