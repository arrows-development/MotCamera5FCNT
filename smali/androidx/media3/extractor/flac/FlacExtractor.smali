...
.method public final read(Landroidx/media3/extractor/ExtractorInput;Landroidx/media3/extractor/PositionHolder;)I
    ...
    invoke-static {v2, v8, v10, v9}, Landroidx/room/util/CursorUtil;->checkAndReadFrameHeader(Landroidx/media3/common/util/ParsableByteArray;Landroidx/media3/extractor/FlacStreamMetadata;ILandroidx/media3/extractor/PositionHolder;)Z
    ...
    invoke-static {v2, v4, v8, v9}, Landroidx/room/util/CursorUtil;->checkAndReadFrameHeader(Landroidx/media3/common/util/ParsableByteArray;Landroidx/media3/extractor/FlacStreamMetadata;ILandroidx/media3/extractor/PositionHolder;)Z
    ...
    iget-object v3, v1, Landroidx/media3/extractor/FlacStreamMetadata;->seekTable:Landroidx/cardview/widget/CardView$1;

    if-eqz v3, :cond_18

    new-instance v3, Landroidx/media3/extractor/SeekMap$Unseekable;

    invoke-direct {v3, v4, v9, v10, v1}, Landroidx/media3/extractor/SeekMap$Unseekable;-><init>(IJLjava/lang/Object;)V
    ...
    invoke-direct {v3, v6, v4}, Landroidx/media3/common/ColorInfo$Builder;-><init>([BI)V

    iget-object v6, v3, Landroidx/media3/common/ColorInfo$Builder;->hdrStaticInfo:[B

    invoke-interface {v1, v5, v9, v6}, Landroidx/media3/extractor/ExtractorInput;->peekFully(II[B)V

    invoke-virtual {v3}, Landroidx/media3/common/ColorInfo$Builder;->readBit()Z

    move-result v6

    invoke-virtual {v3, v10}, Landroidx/media3/common/ColorInfo$Builder;->readBits(I)I

    move-result v12

    const/16 v13, 0x18

    invoke-virtual {v3, v13}, Landroidx/media3/common/ColorInfo$Builder;->readBits(I)I
    ...
    invoke-interface {v1, v3, v5, v2}, Landroidx/media3/extractor/ExtractorInput;->readFully([BII)V

    new-instance v2, Landroidx/media3/extractor/FlacStreamMetadata;

    invoke-direct {v2, v9, v3}, Landroidx/media3/extractor/FlacStreamMetadata;-><init>(I[B)V
    ...
    invoke-interface {v1, v13, v5, v3}, Landroidx/media3/extractor/ExtractorInput;->readFully([BII)V

    invoke-static {v12}, Landroidx/room/util/DBUtil;->readSeekTableMetadataBlock(Landroidx/media3/common/util/ParsableByteArray;)Landroidx/cardview/widget/CardView$1;
    ...
    invoke-direct/range {v14 .. v25}, Landroidx/media3/extractor/FlacStreamMetadata;-><init>(IIIIIIIJLandroidx/cardview/widget/CardView$1;Landroidx/media3/common/Metadata;)V
    ...
    iget-object v4, v2, Landroidx/media3/extractor/FlacStreamMetadata;->metadata:Landroidx/media3/common/Metadata;
    ...
    invoke-interface {v1, v6, v8, v3}, Landroidx/media3/extractor/ExtractorInput;->readFully([BII)V

    invoke-virtual {v5, v9}, Landroidx/media3/common/util/ParsableByteArray;->skipBytes(I)V

    invoke-static {v5, v8, v8}, Landroidx/core/view/ViewGroupKt;->readVorbisCommentHeader(Landroidx/media3/common/util/ParsableByteArray;ZZ)Lcom/adobe/xmp/impl/ByteBuffer;
    ...
    invoke-static {v3}, Landroidx/core/view/ViewGroupKt;->parseVorbisComments(Ljava/util/List;)Landroidx/media3/common/Metadata;
    ...
    :cond_1f
    iget-object v3, v3, Landroidx/media3/common/Metadata;->entries:[Landroidx/media3/common/Metadata$Entry;

    invoke-virtual {v4, v3}, Landroidx/media3/common/Metadata;->copyWithAppendedEntries([Landroidx/media3/common/Metadata$Entry;)Landroidx/media3/common/Metadata;
    ...
    iget v4, v2, Landroidx/media3/extractor/FlacStreamMetadata;->maxFrameSize:I

    iget v5, v2, Landroidx/media3/extractor/FlacStreamMetadata;->sampleRate:I

    iget v6, v2, Landroidx/media3/extractor/FlacStreamMetadata;->channels:I

    iget v8, v2, Landroidx/media3/extractor/FlacStreamMetadata;->bitsPerSample:I

    iget-wide v9, v2, Landroidx/media3/extractor/FlacStreamMetadata;->totalSamples:J

    iget-object v2, v2, Landroidx/media3/extractor/FlacStreamMetadata;->seekTable:Landroidx/cardview/widget/CardView$1;
    ...
    invoke-direct/range {v12 .. v23}, Landroidx/media3/extractor/FlacStreamMetadata;-><init>(IIIIIIIJLandroidx/cardview/widget/CardView$1;Landroidx/media3/common/Metadata;)V
    ...
    :cond_21
    iget-object v3, v5, Landroidx/media3/common/Metadata;->entries:[Landroidx/media3/common/Metadata$Entry;
    ...
    invoke-interface {v1, v4, v2, v7}, Landroidx/media3/extractor/ExtractorInput;->peekFully(II[B)V
    ...
    :cond_29
    sget-object v2, Landroidx/media3/extractor/metadata/id3/Id3Decoder;->NO_FRAMES_PREDICATE:Lcom/motorola/camera/Controller$$ExternalSyntheticLambda9;
    ...
    invoke-virtual {v6, v1, v2}, Lcom/google/gson/FieldAttributes;->peekId3Data(Landroidx/media3/extractor/ExtractorInput;Lcom/motorola/camera/Controller$$ExternalSyntheticLambda9;)Landroidx/media3/common/Metadata;

    move-result-object v2

    if-eqz v2, :cond_2b

    iget-object v6, v2, Landroidx/media3/common/Metadata;->entries:[Landroidx/media3/common/Metadata$Entry;
...
.method public final sniff(Landroidx/media3/extractor/ExtractorInput;)Z
    ...
    sget-object p0, Landroidx/media3/extractor/metadata/id3/Id3Decoder;->NO_FRAMES_PREDICATE:Lcom/motorola/camera/Controller$$ExternalSyntheticLambda9;
    ...
    invoke-virtual {v0, p1, p0}, Lcom/google/gson/FieldAttributes;->peekId3Data(Landroidx/media3/extractor/ExtractorInput;Lcom/motorola/camera/Controller$$ExternalSyntheticLambda9;)Landroidx/media3/common/Metadata;
