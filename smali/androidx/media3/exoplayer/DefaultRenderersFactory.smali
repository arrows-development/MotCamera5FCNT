...
# instance fields
.field public final codecAdapterFactory:Lcom/motorola/camera/launch/LaunchManager$Companion;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    new-instance p1, Lcom/motorola/camera/launch/LaunchManager$Companion;

    invoke-direct {p1}, Lcom/motorola/camera/launch/LaunchManager$Companion;-><init>()V

    iput-object p1, p0, Landroidx/media3/exoplayer/DefaultRenderersFactory;->codecAdapterFactory:Lcom/motorola/camera/launch/LaunchManager$Companion;
...
.method public final createRenderers(Landroid/os/Handler;Landroidx/media3/exoplayer/ExoPlayerImpl$ComponentListener;Landroidx/media3/exoplayer/ExoPlayerImpl$ComponentListener;Landroidx/media3/exoplayer/ExoPlayerImpl$ComponentListener;Landroidx/media3/exoplayer/ExoPlayerImpl$ComponentListener;)[Landroidx/media3/exoplayer/Renderer;
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/DefaultRenderersFactory;->codecAdapterFactory:Lcom/motorola/camera/launch/LaunchManager$Companion;

    iget-object v2, p0, Landroidx/media3/exoplayer/DefaultRenderersFactory;->context:Landroid/content/Context;

    invoke-direct {v0, v2, v1, p1, p2}, Landroidx/media3/exoplayer/video/MediaCodecVideoRenderer;-><init>(Landroid/content/Context;Lcom/motorola/camera/launch/LaunchManager$Companion;Landroid/os/Handler;Landroidx/media3/exoplayer/ExoPlayerImpl$ComponentListener;)V
    ...
    invoke-static {v3}, Lkotlin/TuplesKt;->toArray(Ljava/util/Collection;)[I
    ...
    invoke-static {v3}, Lkotlin/TuplesKt;->asList([I)Ljava/util/List;
    ...
    invoke-static {v4}, Lkotlin/TuplesKt;->toArray(Ljava/util/Collection;)[I
    ...
    invoke-static {v1}, Lkotlin/TuplesKt;->toArray(Ljava/util/Collection;)[I
    ...
    sget-object v4, Landroidx/media3/common/util/Clock;->DEFAULT:Landroidx/media3/common/util/SystemClock;

    invoke-direct {v3, v4}, Lcom/motorola/camera/ui/DownUpDetector;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v3}, Lcom/motorola/camera/ui/DownUpDetector;->open()Z
    ...
    invoke-static {v1, p2}, Lkotlin/io/CloseableKt;->checkElementsNotNull(I[Ljava/lang/Object;)V
    ...
    invoke-static {v2, p2}, Lkotlin/io/ByteStreamsKt;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V
