...
.field public final formatHolder:Landroidx/cardview/widget/CardView$1;
...
.method public constructor <init>(Landroidx/media3/exoplayer/ExoPlayerImpl$ComponentListener;Landroid/os/Looper;)V
    ...
    sget-object v0, Landroidx/media3/exoplayer/text/SubtitleDecoderFactory;->DEFAULT:Landroidx/room/AutoCloser$Companion;
    ...
    invoke-direct {p1, v1}, Landroidx/cardview/widget/CardView$1;-><init>(I)V

    iput-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->formatHolder:Landroidx/cardview/widget/CardView$1;
...
.method public final invokeUpdateOutputInternal(Landroidx/media3/common/text/CueGroup;)V
    ...
    invoke-direct {v1, v2, p1}, Lcom/airbnb/lottie/L$$ExternalSyntheticLambda0;-><init>(ILjava/lang/Object;)V
...
.method public final onPositionReset(JZ)V
    ...
    check-cast p2, Landroidx/room/AutoCloser$Companion;

    invoke-virtual {p2, p1}, Landroidx/room/AutoCloser$Companion;->createDecoder(Landroidx/media3/common/Format;)Landroidx/media3/extractor/text/SubtitleDecoder;
...
.method public final render(JJ)V
    ...
    :cond_1
    iget-object v0, v1, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Landroidx/media3/extractor/text/SubtitleOutputBuffer;

    const-string v5, "TextRenderer"

    const-string v6, "Subtitle decoding failed. streamFormat="

    iget-object v7, v1, Landroidx/media3/exoplayer/text/TextRenderer;->decoderFactory:Landroidx/media3/exoplayer/text/SubtitleDecoderFactory;
    ...
    iput-object v0, v1, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Landroidx/media3/extractor/text/SubtitleOutputBuffer;
    :try_end_0
    ...
    invoke-static {v5, v2, v0}, Landroidx/media3/common/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iput-object v8, v1, Landroidx/media3/exoplayer/text/TextRenderer;->decoder:Landroidx/media3/extractor/text/SubtitleDecoder;

    iput v9, v1, Landroidx/media3/exoplayer/text/TextRenderer;->decoderReplacementState:I

    iput-boolean v4, v1, Landroidx/media3/exoplayer/text/TextRenderer;->waitingForKeyFrame:Z

    iget-object v0, v1, Landroidx/media3/exoplayer/text/TextRenderer;->streamFormat:Landroidx/media3/common/Format;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    check-cast v7, Landroidx/room/AutoCloser$Companion;

    invoke-virtual {v7, v0}, Landroidx/room/AutoCloser$Companion;->createDecoder(Landroidx/media3/common/Format;)Landroidx/media3/extractor/text/SubtitleDecoder;
    ...
    :cond_3
    iget-object v0, v1, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Landroidx/media3/extractor/text/SubtitleOutputBuffer;
    ...
    :cond_5
    iget-object v11, v1, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Landroidx/media3/extractor/text/SubtitleOutputBuffer;

    const/4 v12, 0x4

    if-eqz v11, :cond_9

    invoke-virtual {v11, v12}, Landroidx/media3/decoder/Buffer;->getFlag(I)Z
    ...
    iget v11, v1, Landroidx/media3/exoplayer/text/TextRenderer;->decoderReplacementState:I

    if-ne v11, v10, :cond_6

    invoke-virtual/range {p0 .. p0}, Landroidx/media3/exoplayer/text/TextRenderer;->releaseBuffers()V

    iget-object v11, v1, Landroidx/media3/exoplayer/text/TextRenderer;->decoder:Landroidx/media3/extractor/text/SubtitleDecoder;

    invoke-virtual {v11}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {v11}, Landroidx/media3/decoder/Decoder;->release()V
    ...
    iget-object v11, v1, Landroidx/media3/exoplayer/text/TextRenderer;->streamFormat:Landroidx/media3/common/Format;

    invoke-virtual {v11}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    move-object v13, v7

    check-cast v13, Landroidx/room/AutoCloser$Companion;

    invoke-virtual {v13, v11}, Landroidx/room/AutoCloser$Companion;->createDecoder(Landroidx/media3/common/Format;)Landroidx/media3/extractor/text/SubtitleDecoder;

    move-result-object v11

    iput-object v11, v1, Landroidx/media3/exoplayer/text/TextRenderer;->decoder:Landroidx/media3/extractor/text/SubtitleDecoder;
    ...
    :cond_7
    iget-wide v13, v11, Landroidx/media3/decoder/DecoderOutputBuffer;->timeUs:J
    ...
    :cond_8
    invoke-virtual {v11, v2, v3}, Landroidx/media3/extractor/text/SubtitleOutputBuffer;->getNextEventTimeIndex(J)I

    move-result v0

    iput v0, v1, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleEventIndex:I

    iput-object v11, v1, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Landroidx/media3/extractor/text/SubtitleOutputBuffer;

    iput-object v8, v1, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Landroidx/media3/extractor/text/SubtitleOutputBuffer;
    ...
    invoke-virtual {v0, v2, v3}, Landroidx/media3/extractor/text/SubtitleOutputBuffer;->getNextEventTimeIndex(J)I

    move-result v0

    if-eqz v0, :cond_c

    iget-object v11, v1, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Landroidx/media3/extractor/text/SubtitleOutputBuffer;

    invoke-virtual {v11}, Landroidx/media3/extractor/text/SubtitleOutputBuffer;->getEventTimeCount()I
    ...
    invoke-virtual {v11, v0}, Landroidx/media3/extractor/text/SubtitleOutputBuffer;->getEventTime(I)J
    ...
    :goto_4
    invoke-virtual {v1, v13, v14}, Landroidx/media3/exoplayer/text/TextRenderer;->getPresentationTimeUs(J)J
    ...
    invoke-virtual {v11, v2, v3}, Landroidx/media3/extractor/text/SubtitleOutputBuffer;->getCues(J)Ljava/util/List;

    move-result-object v2

    invoke-direct {v0, v13, v14, v2}, Landroidx/media3/common/text/CueGroup;-><init>(JLjava/util/List;)V
    ...
    iget-object v0, v1, Landroidx/media3/exoplayer/text/TextRenderer;->nextInputBuffer:Landroidx/media3/extractor/text/SubtitleInputBuffer;
    ...
    :cond_10
    iput-object v0, v1, Landroidx/media3/exoplayer/text/TextRenderer;->nextInputBuffer:Landroidx/media3/extractor/text/SubtitleInputBuffer;
    ...
    iput v12, v0, Landroidx/media3/decoder/Buffer;->flags:I
    ...
    iput-object v8, v1, Landroidx/media3/exoplayer/text/TextRenderer;->nextInputBuffer:Landroidx/media3/extractor/text/SubtitleInputBuffer;
    ...
    :cond_12
    iget-object v2, v1, Landroidx/media3/exoplayer/text/TextRenderer;->formatHolder:Landroidx/cardview/widget/CardView$1;

    :try_start_2
    invoke-virtual {v1, v2, v0, v9}, Landroidx/media3/exoplayer/BaseRenderer;->readSource(Landroidx/cardview/widget/CardView$1;Landroidx/media3/decoder/DecoderInputBuffer;I)I
    ...
    invoke-virtual {v0, v12}, Landroidx/media3/decoder/Buffer;->getFlag(I)Z
...
.method public final supportsFormat(Landroidx/media3/common/Format;)I
    ...
    check-cast p0, Landroidx/room/AutoCloser$Companion;

    invoke-virtual {p0, p1}, Landroidx/room/AutoCloser$Companion;->supportsFormat(Landroidx/media3/common/Format;)Z
