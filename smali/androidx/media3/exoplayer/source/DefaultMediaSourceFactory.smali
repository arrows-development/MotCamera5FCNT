...
.field public loadErrorHandlingPolicy:Landroidx/window/core/AndroidLogger;
...
.method public final createMediaSource(Landroidx/media3/common/MediaItem;)Landroidx/media3/exoplayer/source/BaseMediaSource;
    ...
    check-cast v5, Landroidx/window/core/AndroidLogger;

    if-eqz v5, :cond_5

    invoke-interface {v4, v5}, Landroidx/media3/exoplayer/source/MediaSource$Factory;->setLoadErrorHandlingPolicy(Landroidx/window/core/AndroidLogger;)Landroidx/media3/exoplayer/source/MediaSource$Factory;
    ...
    invoke-static {v4, v2}, Landroidx/core/view/ViewGroupKt;->checkStateNotNull(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    new-instance v2, Landroidx/window/core/AndroidLogger;

    invoke-direct {v2}, Landroidx/window/core/AndroidLogger;-><init>()V

    const/4 v11, 0x1

    iget-object v6, v0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory;->loadErrorHandlingPolicy:Landroidx/window/core/AndroidLogger;
    ...
    invoke-direct/range {v6 .. v12}, Landroidx/media3/exoplayer/source/SingleSampleMediaSource;-><init>(Ljava/lang/String;Landroidx/media3/common/MediaItem$SubtitleConfiguration;Landroidx/media3/datasource/DataSource$Factory;Landroidx/window/core/AndroidLogger;ZLjava/lang/Object;)V
...
.method public final setLoadErrorHandlingPolicy(Landroidx/window/core/AndroidLogger;)Landroidx/media3/exoplayer/source/MediaSource$Factory;
    .locals 2

    if-eqz p1, :cond_1

    iput-object p1, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory;->loadErrorHandlingPolicy:Landroidx/window/core/AndroidLogger;
    ...
    invoke-interface {v1, p1}, Landroidx/media3/exoplayer/source/MediaSource$Factory;->setLoadErrorHandlingPolicy(Landroidx/window/core/AndroidLogger;)Landroidx/media3/exoplayer/source/MediaSource$Factory;
