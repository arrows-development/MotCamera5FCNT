...
.field public final constructorFinished:Lcom/motorola/camera/ui/DownUpDetector;
...
.method public constructor <init>(Landroidx/media3/exoplayer/ExoPlayer$Builder;)V
    ...
    invoke-direct {v4, v5}, Lcom/motorola/camera/ui/DownUpDetector;-><init>(I)V

    iput-object v4, v1, Landroidx/media3/exoplayer/ExoPlayerImpl;->constructorFinished:Lcom/motorola/camera/ui/DownUpDetector;
    ...
    invoke-direct {v9, v1}, Landroidx/media3/exoplayer/ExoPlayerImpl$ComponentListener;-><init>(Landroidx/media3/exoplayer/ExoPlayerImpl;)V
    ...
    check-cast v4, Landroidx/media3/exoplayer/DefaultRenderersFactory;
    ...
    invoke-virtual/range {v4 .. v9}, Landroidx/media3/exoplayer/DefaultRenderersFactory;->createRenderers(Landroid/os/Handler;Landroidx/media3/exoplayer/ExoPlayerImpl$ComponentListener;Landroidx/media3/exoplayer/ExoPlayerImpl$ComponentListener;Landroidx/media3/exoplayer/ExoPlayerImpl$ComponentListener;Landroidx/media3/exoplayer/ExoPlayerImpl$ComponentListener;)[Landroidx/media3/exoplayer/Renderer;
    ...
    :goto_0
    invoke-static {v4}, Landroidx/core/view/ViewGroupKt;->checkState(Z)V
    ...
    new-instance v7, Landroidx/media3/exoplayer/ExoPlayerImpl$$ExternalSyntheticLambda4;

    invoke-direct {v7, v1}, Landroidx/media3/exoplayer/ExoPlayerImpl$$ExternalSyntheticLambda4;-><init>(Landroidx/media3/exoplayer/ExoPlayerImpl;)V

    invoke-direct {v6, v4, v5, v7}, Landroidx/media3/common/util/ListenerSet;-><init>(Landroid/os/Looper;Landroidx/media3/common/util/Clock;Landroidx/media3/common/util/ListenerSet$IterationFinishedEvent;)V
    ...
    new-instance v3, Lcom/motorola/camera/ui/DownUpDetector;

    const/4 v4, 0x2

    invoke-direct {v3, v4}, Lcom/motorola/camera/ui/DownUpDetector;-><init>(I)V
    ...
    invoke-virtual {v3, v9}, Lcom/motorola/camera/ui/DownUpDetector;->add(I)V
    ...
    :cond_1
    iget-object v5, v1, Landroidx/media3/exoplayer/ExoPlayerImpl;->trackSelector:Landroidx/media3/exoplayer/trackselection/MappingTrackSelector;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const/16 v5, 0x1d

    invoke-virtual {v3, v5}, Lcom/motorola/camera/ui/DownUpDetector;->add(I)V

    new-instance v5, Landroidx/media3/common/Player$Commands;

    invoke-virtual {v3}, Lcom/motorola/camera/ui/DownUpDetector;->build()Landroidx/media3/common/FlagSet;

    move-result-object v3

    invoke-direct {v5, v3}, Landroidx/media3/common/Player$Commands;-><init>(Landroidx/media3/common/FlagSet;)V
    ...
    invoke-direct {v5, v4}, Lcom/motorola/camera/ui/DownUpDetector;-><init>(I)V
    ...
    invoke-virtual {v3, v4}, Landroidx/media3/common/FlagSet;->get(I)I

    move-result v6

    invoke-virtual {v5, v6}, Lcom/motorola/camera/ui/DownUpDetector;->add(I)V
    ...
    invoke-virtual {v5, v3}, Lcom/motorola/camera/ui/DownUpDetector;->add(I)V
    ...
    invoke-virtual {v3, v4, v7}, Landroidx/media3/common/util/SystemClock;->createHandler(Landroid/os/Looper;Landroid/os/Handler$Callback;)Landroidx/media3/common/util/SystemHandlerWrapper;
    ...
    iget-object v2, v2, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->eventDispatcher:Landroidx/collection/internal/LruHashMap;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {v2, v4}, Landroidx/collection/internal/LruHashMap;->removeListener(Landroidx/media3/exoplayer/analytics/AnalyticsCollector;)V

    iget-object v2, v2, Landroidx/collection/internal/LruHashMap;->map:Ljava/lang/Object;
    ...
    invoke-static {}, Landroidx/media3/exoplayer/ExoPlayerImpl;->createDeviceInfo()Landroidx/media3/common/DeviceInfo;
    ...
    invoke-virtual {v1, v4, v3, v0}, Landroidx/media3/exoplayer/ExoPlayerImpl;->sendRendererMessage(IILjava/lang/Object;)V
    ...
    iget-object v0, v1, Landroidx/media3/exoplayer/ExoPlayerImpl;->constructorFinished:Lcom/motorola/camera/ui/DownUpDetector;

    invoke-virtual {v0}, Lcom/motorola/camera/ui/DownUpDetector;->open()Z
    ...
    iget-object v1, v1, Landroidx/media3/exoplayer/ExoPlayerImpl;->constructorFinished:Lcom/motorola/camera/ui/DownUpDetector;

    invoke-virtual {v1}, Lcom/motorola/camera/ui/DownUpDetector;->open()Z
...
.method public static createDeviceInfo()Landroidx/media3/common/DeviceInfo;
    .locals 2
    ...
    invoke-direct {v1, v0}, Landroidx/media3/common/DeviceInfo;-><init>(Landroidx/media3/common/DeviceInfo$Builder;)V
...
.method public final maskTimelineAndPosition(Landroidx/media3/exoplayer/PlaybackInfo;Landroidx/media3/common/Timeline;Landroid/util/Pair;)Landroidx/media3/exoplayer/PlaybackInfo;
    ...
    invoke-static {v2}, Landroidx/core/view/ViewGroupKt;->checkState(Z)V
...
.method public final removeListener(Landroidx/media3/common/Player$Listener;)V
    ...
    iget-object v4, v2, Landroidx/media3/common/util/ListenerSet$ListenerHolder;->flagsBuilder:Lcom/motorola/camera/ui/DownUpDetector;

    invoke-virtual {v4}, Lcom/motorola/camera/ui/DownUpDetector;->build()Landroidx/media3/common/FlagSet;
...
.method public final removeSurfaceCallbacks()V
    ...
    invoke-static {v3}, Landroidx/core/view/ViewGroupKt;->checkState(Z)V
...
.method public final seekTo(IJZ)V
    ...
    :goto_0
    invoke-static {v4}, Landroidx/core/view/ViewGroupKt;->checkArgument(Z)V
    ...
    new-instance v6, Landroidx/media3/exoplayer/analytics/DefaultAnalyticsCollector$$ExternalSyntheticLambda10;

    invoke-direct {v6, v5, v2}, Landroidx/media3/exoplayer/analytics/DefaultAnalyticsCollector$$ExternalSyntheticLambda10;-><init>(Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;I)V
    ...
    invoke-direct {v3, v4, v0, v1}, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda5;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v3, v2, v4}, Landroidx/media3/exoplayer/ExoPlayerImpl;->maskTimelineAndPosition(Landroidx/media3/exoplayer/PlaybackInfo;Landroidx/media3/common/Timeline;Landroid/util/Pair;)Landroidx/media3/exoplayer/PlaybackInfo;
    ...
    iget-object v4, p0, Landroidx/media3/exoplayer/ExoPlayerImpl;->internalPlayer:Landroidx/media3/exoplayer/ExoPlayerImplInternal;
    ...
    invoke-direct {v9, v2, p1, v6, v7}, Landroidx/media3/exoplayer/ExoPlayerImplInternal$SeekPosition;-><init>(Landroidx/media3/common/Timeline;IJ)V

    invoke-virtual {v4, v5, v9}, Landroidx/media3/common/util/SystemHandlerWrapper;->obtainMessage(ILjava/lang/Object;)Landroidx/media3/common/util/SystemHandlerWrapper$SystemMessage;
...
.method public final setTrackSelectionParameters(Landroidx/media3/common/TrackSelectionParameters;)V
    ...
    invoke-direct {v0, v1, p1}, Lcom/airbnb/lottie/L$$ExternalSyntheticLambda0;-><init>(ILjava/lang/Object;)V
...
.method public final setVideoOutputInternal(Ljava/lang/Object;)V
    ...
    invoke-static {v7}, Landroidx/core/view/ViewGroupKt;->checkState(Z)V
...
.method public final updateAvailableCommands()V
    ...
    iget-object v12, v10, Landroidx/media3/common/Player$Commands$Builder;->flagsBuilder:Lcom/motorola/camera/ui/DownUpDetector;
    ...
    invoke-virtual {v12, v14}, Lcom/motorola/camera/ui/DownUpDetector;->add(I)V
    ...
    invoke-virtual {v12}, Lcom/motorola/camera/ui/DownUpDetector;->build()Landroidx/media3/common/FlagSet;
...
.method public final updatePlaybackInfo(Landroidx/media3/exoplayer/PlaybackInfo;IIZIJIZ)V
    ...
    invoke-direct {v4, v6, v10}, Landroidx/media3/exoplayer/ExoPlayerImpl$$ExternalSyntheticLambda2;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v7, v9, v2}, Lcom/airbnb/lottie/L$$ExternalSyntheticLambda0;-><init>(ILjava/lang/Object;)V
...
.method public final verifyApplicationThread()V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/ExoPlayerImpl;->constructorFinished:Lcom/motorola/camera/ui/DownUpDetector;
