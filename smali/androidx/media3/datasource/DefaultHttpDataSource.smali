...
.field public final requestProperties:Landroidx/core/provider/CallbackWithHandler;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;IILandroidx/core/provider/CallbackWithHandler;)V
    .locals 1
    ...
    iput-object p4, p0, Landroidx/media3/datasource/DefaultHttpDataSource;->defaultRequestProperties:Landroidx/core/provider/CallbackWithHandler;
    ...
    new-instance p2, Landroidx/core/provider/CallbackWithHandler;

    const/4 p3, 0x3

    invoke-direct {p2, p3}, Landroidx/core/provider/CallbackWithHandler;-><init>(I)V

    iput-object p2, p0, Landroidx/media3/datasource/DefaultHttpDataSource;->requestProperties:Landroidx/core/provider/CallbackWithHandler;
...
.method public final handleRedirect(Ljava/net/URL;Ljava/lang/String;)Ljava/net/URL;
    ...
    invoke-static {p1, p2}, L_COROUTINE/_BOUNDARY$$ExternalSyntheticThrowCCEIfNotNull0;->m(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final makeConnection(Landroidx/media3/datasource/DataSpec;)Ljava/net/HttpURLConnection;
    ...
    .line 3
    invoke-static {v2, v3}, L_COROUTINE/_BOUNDARY$$ExternalSyntheticThrowCCEIfNotNull0;->m(Ljava/lang/String;I)Ljava/lang/String;
...
.method public final makeConnection(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Landroidx/media3/datasource/DefaultHttpDataSource;->defaultRequestProperties:Landroidx/core/provider/CallbackWithHandler;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Landroidx/core/provider/CallbackWithHandler;->getSnapshot()Ljava/util/Map;
    ...
    :cond_0
    iget-object v1, p0, Landroidx/media3/datasource/DefaultHttpDataSource;->requestProperties:Landroidx/core/provider/CallbackWithHandler;
