...
.method public final open(Landroidx/media3/datasource/DataSpec;)J
    ...
    const-string/jumbo v1, "uri has query and/or fragment, which are not supported. Did you call Uri.parse() on a string containing \'?\' or \'#\'? Use Uri.fromFile(new File(path)) to avoid this. path=%s,query=%s,fragment=%s"
