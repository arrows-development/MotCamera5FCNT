...
.method public final dispatchResume(I)V
    ...
    :try_start_0
    invoke-static {p0, v1, v3}, Lkotlinx/coroutines/TimeoutKt;->resume(Lkotlinx/coroutines/DispatchedTask;Lkotlin/coroutines/Continuation;Z)V
    ...
    :cond_c
    invoke-static {p0, v1, v0}, Lkotlinx/coroutines/TimeoutKt;->resume(Lkotlinx/coroutines/DispatchedTask;Lkotlin/coroutines/Continuation;Z)V
...
.method public final invokeOnCancellationImpl(Ljava/lang/Object;)V
    ...
    invoke-virtual {v5, v0, v4, v2}, Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;->compareAndSet(Ljava/lang/Object;II)Z
    ...
    iget-object v6, v1, Lkotlinx/coroutines/CompletedContinuation;->cancelHandler:Lkotlinx/coroutines/CancelHandler;

    if-nez v6, :cond_c

    instance-of v6, p1, Lkotlinx/coroutines/internal/Segment;
    ...
    :cond_9
    invoke-static {p1, v5}, Lkotlin/io/ByteStreamsKt;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V

    move-object v5, p1

    check-cast v5, Lkotlinx/coroutines/CancelHandler;

    iget-object v6, v1, Lkotlinx/coroutines/CompletedContinuation;->cancelCause:Ljava/lang/Throwable;
    ...
    invoke-virtual {p0, v5, v6}, Lkotlinx/coroutines/CancellableContinuationImpl;->callCancelHandler(Lkotlinx/coroutines/CancelHandler;Ljava/lang/Throwable;)V
    ...
    invoke-static {v1, v5, v3, v2}, Lkotlinx/coroutines/CompletedContinuation;->copy$default(Lkotlinx/coroutines/CompletedContinuation;Lkotlinx/coroutines/CancelHandler;Ljava/util/concurrent/CancellationException;I)Lkotlinx/coroutines/CompletedContinuation;
...
.method public final toString()Ljava/lang/String;
    ...
    invoke-static {v1}, Landroidx/core/app/NavUtils;->toDebugString(Lkotlin/coroutines/Continuation;)Ljava/lang/String;
