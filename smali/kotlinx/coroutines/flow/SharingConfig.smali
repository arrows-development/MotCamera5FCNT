...
# static fields
.field public static staticInstance:Lkotlinx/coroutines/flow/SharingConfig;
...
.field public final onBufferOverflow:Ljava/lang/Object;
...
.method public constructor <init>(ILjava/lang/String;Ljava/util/ArrayList;[B)V
    ...
    iput-object p2, p0, Lkotlinx/coroutines/flow/SharingConfig;->upstream:Ljava/lang/Object;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p0}, Lcom/motorola/camera/SecureCamera$1;-><init>(Lkotlinx/coroutines/flow/SharingConfig;)V
...
.method public constructor <init>(Ljava/util/HashMap;)V
    ...
    sget-object v4, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->COLOR_RESOURCE_COMPARATOR:Landroidx/viewpager/widget/ViewPager$1;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    :cond_0
    iget v1, p0, Lkotlinx/coroutines/flow/SharingConfig;->extraBufferCapacity:I

    new-array v1, v1, [I

    iput-object v1, p0, Lkotlinx/coroutines/flow/SharingConfig;->onBufferOverflow:Ljava/lang/Object;
    ...
    iget-object v2, p0, Lkotlinx/coroutines/flow/SharingConfig;->onBufferOverflow:Ljava/lang/Object;
    ...
    iput-object v1, p0, Lkotlinx/coroutines/flow/SharingConfig;->upstream:Ljava/lang/Object;
    ...
    iput-object v1, p0, Lkotlinx/coroutines/flow/SharingConfig;->context:Ljava/lang/Object;

    return-void
.end method

.method public static access$200(ILkotlinx/coroutines/flow/SharingConfig;)V
    .locals 3
    ...
    :try_start_0
    iget v1, p1, Lkotlinx/coroutines/flow/SharingConfig;->extraBufferCapacity:I
    ...
    :cond_0
    iput p0, p1, Lkotlinx/coroutines/flow/SharingConfig;->extraBufferCapacity:I

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, p1, Lkotlinx/coroutines/flow/SharingConfig;->onBufferOverflow:Ljava/lang/Object;
    ...
    :cond_1
    iget-object v2, p1, Lkotlinx/coroutines/flow/SharingConfig;->onBufferOverflow:Ljava/lang/Object;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lkotlinx/coroutines/flow/SharingConfig;
    .locals 2

    const-class v0, Lkotlinx/coroutines/flow/SharingConfig;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lkotlinx/coroutines/flow/SharingConfig;->staticInstance:Lkotlinx/coroutines/flow/SharingConfig;

    if-nez v1, :cond_0

    new-instance v1, Lkotlinx/coroutines/flow/SharingConfig;

    invoke-direct {v1, p0}, Lkotlinx/coroutines/flow/SharingConfig;-><init>(Landroid/content/Context;)V

    sput-object v1, Lkotlinx/coroutines/flow/SharingConfig;->staticInstance:Lkotlinx/coroutines/flow/SharingConfig;
    ...
    :cond_0
    :goto_0
    sget-object p0, Lkotlinx/coroutines/flow/SharingConfig;->staticInstance:Lkotlinx/coroutines/flow/SharingConfig;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final writeTo(Ljava/io/ByteArrayOutputStream;)V
    ...
    iget-object v3, p0, Lkotlinx/coroutines/flow/SharingConfig;->onBufferOverflow:Ljava/lang/Object;

    iget-object v4, p0, Lkotlinx/coroutines/flow/SharingConfig;->upstream:Ljava/lang/Object;
    ...
    invoke-static {p0}, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->access$500(I)[B
    ...
    invoke-static {v3}, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->access$500(I)[B
    ...
    invoke-static {v4}, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->charToByteArray(C)[B
    ...
    :cond_0
    invoke-static {v1}, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->charToByteArray(C)[B
    ...
    invoke-static {v2}, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->access$500(I)[B

    move-result-object v3

    invoke-virtual {p1, v3}, Ljava/io/OutputStream;->write([B)V

    invoke-static {v1}, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->access$500(I)[B
    ...
    invoke-static {v4}, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->access$500(I)[B
    ...
    iget-object v0, v0, Lcom/google/android/material/color/ColorResourcesTableCreator$PackageChunk;->typeSpecChunk:Lkotlinx/coroutines/flow/SharingConfig;

    invoke-virtual {v0, p1}, Lkotlinx/coroutines/flow/SharingConfig;->writeTo(Ljava/io/ByteArrayOutputStream;)V
    ...
    sget-byte v5, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->typeIdColor:B
    ...
    invoke-static {v8}, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->access$500(I)[B
    ...
    sget-byte v3, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->typeIdColor:B
    ...
    invoke-static {v3}, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->shortToByteArray(S)[B

    move-result-object v4

    invoke-virtual {p1, v4}, Ljava/io/OutputStream;->write([B)V

    invoke-static {v6}, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzou;->shortToByteArray(S)[B
